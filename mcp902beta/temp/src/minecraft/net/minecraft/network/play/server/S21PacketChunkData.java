...
public class S21PacketChunkData extends Packet {
   ...
   public void func_148840_b(PacketBuffer p_148840_1_) throws IOException {
      ...
      p_148840_1_.writeShort((short)(this.field_149283_c & '\uffff'));
      p_148840_1_.writeShort((short)(this.field_149280_d & '\uffff'));
   ...
   public static S21PacketChunkData.Extracted func_149269_a(Chunk p_149269_0_, boolean p_149269_1_, int p_149269_2_) {
      int var3 = 0;
      ExtendedBlockStorage[] var4 = p_149269_0_.func_76587_i();
      int var5 = 0;
      ...
      for(var8 = 0; var8 < var4.length; ++var8) {
         if(var4[var8] != null && (!p_149269_1_ || !var4[var8].func_76663_a()) && (p_149269_2_ & 1 << var8) != 0) {
      ...
      if(var5 > 0) {
         for(var8 = 0; var8 < var4.length; ++var8) {
            if(var4[var8] != null && (!p_149269_1_ || !var4[var8].func_76663_a()) && var4[var8].func_76660_i() != null && (p_149269_2_ & 1 << var8) != 0) {
      ...
      if(p_149269_1_) {
         byte[] var11 = p_149269_0_.func_76605_m();
