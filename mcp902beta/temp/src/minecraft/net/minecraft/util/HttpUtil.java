   ...
   public static void func_151223_a(final File p_151223_0_, final String p_151223_1_, final HttpUtil.DownloadListener p_151223_2_, final Map p_151223_3_, final int p_151223_4_, final IProgressUpdate p_151223_5_, final Proxy p_151223_6_) {
      Thread var7 = new Thread(new Runnable() {
         ...
         public void run() {
            ...
            if(p_151223_5_ != null) {
               p_151223_5_.func_73721_b("Downloading Texture Pack");
               p_151223_5_.func_73719_c("Making Request...");
            }
            ...
            try {
               try {
                  ...
                  while(var8.hasNext()) {
                     ...
                     if(p_151223_5_ != null) {
                        p_151223_5_.func_73718_a((int)(++var6 / var7 * 100.0F));
                     }
                  }
                  ...
                  if(p_151223_5_ != null) {
                     p_151223_5_.func_73719_c(String.format("Downloading file (%.2f MB)...", new Object[]{Float.valueOf(var7 / 1000.0F / 1000.0F)}));
                  }
                  ...
                  if(p_151223_0_.exists()) {
                     ...
                     HttpUtil.field_151227_b.warn("Deleting " + p_151223_0_ + " as it does not match what we currently have (" + var28 + " vs our " + var29 + ").");
                     p_151223_0_.delete();
