...
public class IntegratedPlayerList extends ServerConfigurationManager {
   ...
   public String func_148542_a(SocketAddress p_148542_1_, GameProfile p_148542_2_) {
      return p_148542_2_.getName().equalsIgnoreCase(this.func_72365_p().func_71214_G()) && this.func_72361_f(p_148542_2_.getName()) != null?"That name is already taken.":super.func_148542_a(p_148542_1_, p_148542_2_);
   }
