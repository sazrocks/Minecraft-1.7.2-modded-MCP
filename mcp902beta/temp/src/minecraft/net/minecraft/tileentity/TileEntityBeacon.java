...
public class TileEntityBeacon extends TileEntity implements IInventory {
   ...
   private void func_146000_x() {
      if(this.field_146015_k && this.field_146012_l > 0 && !this.field_145850_b.field_72995_K && this.field_146013_m > 0) {
         ...
         AxisAlignedBB var4 = AxisAlignedBB.func_72332_a().func_72299_a((double)this.field_145851_c, (double)this.field_145848_d, (double)this.field_145849_e, (double)(this.field_145851_c + 1), (double)(this.field_145848_d + 1), (double)(this.field_145849_e + 1)).func_72314_b(var1, var1, var1);
   ...
   private void func_146003_y() {
      ...
      if(!this.field_145850_b.field_72995_K && this.field_146012_l == 4 && var1 < this.field_146012_l) {
         Iterator var8 = this.field_145850_b.func_72872_a(EntityPlayer.class, AxisAlignedBB.func_72332_a().func_72299_a((double)this.field_145851_c, (double)this.field_145848_d, (double)this.field_145849_e, (double)this.field_145851_c, (double)(this.field_145848_d - 4), (double)this.field_145849_e).func_72314_b(10.0D, 5.0D, 10.0D)).iterator();
