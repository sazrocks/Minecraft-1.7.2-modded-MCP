...
public class TileEntityHopper extends TileEntity implements IHopper {
      ...
      if(var1 == null) {
         ...
         for(int var2 = 0; var2 < this.func_70302_i_(); ++var2) {
            if(this.func_70301_a(var2) != null) {
               ...
               ItemStack var4 = func_145889_a(var1, this.func_70298_a(var2, 1), Facing.field_71588_a[BlockHopper.func_149918_b(this.func_145832_p())]);
   ...
   public static EntityItem func_145897_a(World p_145897_0_, double p_145897_1_, double p_145897_3_, double p_145897_5_) {
      List var7 = p_145897_0_.func_82733_a(EntityItem.class, AxisAlignedBB.func_72332_a().func_72299_a(p_145897_1_, p_145897_3_, p_145897_5_, p_145897_1_ + 1.0D, p_145897_3_ + 1.0D, p_145897_5_ + 1.0D), IEntitySelector.field_94557_a);
   ...
   public static IInventory func_145893_b(World p_145893_0_, double p_145893_1_, double p_145893_3_, double p_145893_5_) {
      ...
      if(var7 == null) {
         List var13 = p_145893_0_.func_94576_a((Entity)null, AxisAlignedBB.func_72332_a().func_72299_a(p_145893_1_, p_145893_3_, p_145893_5_, p_145893_1_ + 1.0D, p_145893_3_ + 1.0D, p_145893_5_ + 1.0D), IEntitySelector.field_96566_b);
