   ...
   public void func_70071_h_() {
      ...
      if(this.field_70254_i) {
         ...
         if(var4 != null && var4.field_72308_g != null && var4.field_72308_g instanceof EntityPlayer) {
            EntityPlayer var19 = (EntityPlayer)var4.field_72308_g;
            if(var19.field_71075_bZ.field_75102_a || this.field_70250_c instanceof EntityPlayer && !((EntityPlayer)this.field_70250_c).func_96122_a(var19)) {
               var4 = null;
            }
         }
         ...
         if(var4 != null) {
            if(var4.field_72308_g != null) {
               ...
               int var21 = MathHelper.func_76143_f((double)var20 * this.field_70255_ao);
               if(this.func_70241_g()) {
                  var21 += this.field_70146_Z.nextInt(var21 / 2 + 2);
               }
               ...
               if(var4.field_72308_g.func_70097_a(var22, (float)var21)) {
