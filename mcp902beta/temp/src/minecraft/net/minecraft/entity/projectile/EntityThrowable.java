...
public abstract class EntityThrowable extends Entity implements IProjectile {
   ...
   public void func_70071_h_() {
      ...
      Vec3 var1 = this.field_70170_p.func_82732_R().func_72345_a(this.field_70165_t, this.field_70163_u, this.field_70161_v);
      ...
      var1 = this.field_70170_p.func_82732_R().func_72345_a(this.field_70165_t, this.field_70163_u, this.field_70161_v);
      ...
      if(var3 != null) {
         if(var3.field_72313_a == MovingObjectPosition.MovingObjectType.BLOCK && this.field_70170_p.func_147439_a(var3.field_72311_b, var3.field_72312_c, var3.field_72309_d) == Blocks.field_150427_aO) {
            this.func_70063_aa();
         } else {
