...
public class EntityWither extends EntityMob implements IBossDisplayData, IRangedAttackMob {
               ...
               for(int var18 = -1; var18 <= 1; ++var18) {
                  for(int var19 = -1; var19 <= 1; ++var19) {
                     for(int var7 = 0; var7 <= 3; ++var7) {
                        ...
                        Block var11 = this.field_70170_p.func_147439_a(var20, var9, var10);
                        if(var11.func_149688_o() != Material.field_151579_a && var11 != Blocks.field_150357_h && var11 != Blocks.field_150384_bq && var11 != Blocks.field_150378_br && var11 != Blocks.field_150483_bI) {
                           var17 = this.field_70170_p.func_147480_a(var20, var9, var10, true) || var17;
                        }
                     }
                  }
               }
   ...
   protected void func_70628_a(boolean p_70628_1_, int p_70628_2_) {
      ...
      if(!this.field_70170_p.field_72995_K) {
         Iterator var3 = this.field_70170_p.func_72872_a(EntityPlayer.class, this.field_70121_D.func_72314_b(50.0D, 100.0D, 50.0D)).iterator();
