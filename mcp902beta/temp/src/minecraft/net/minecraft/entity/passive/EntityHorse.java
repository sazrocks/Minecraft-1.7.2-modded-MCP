...
public class EntityHorse extends EntityAnimal implements IInvBasic {
   ...
   private static final IEntitySelector field_110276_bu = new IEntitySelector() {
   ...
   private static final IAttribute field_110271_bv = (new RangedAttribute("horse.jumpStrength", 0.7D, 0.0D, 2.0D)).func_111117_a("Jump Strength").func_111112_a(true);
   ...
   protected void func_70069_a(float p_70069_1_) {
      ...
      if(var2 > 0) {
         ...
         Block var3 = this.field_70170_p.func_147439_a(MathHelper.func_76128_c(this.field_70165_t), MathHelper.func_76128_c(this.field_70163_u - 0.2D - (double)this.field_70126_B), MathHelper.func_76128_c(this.field_70161_v));
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      if(p_70037_1_.func_150297_b("OwnerName", 8)) {
      ...
      if(this.func_110261_ca()) {
         NBTTagList var3 = p_70037_1_.func_150295_c("Items", 10);
         this.func_110226_cD();
      ...
      if(p_70037_1_.func_150297_b("SaddleItem", 10)) {
         ...
         if(var7 != null && var7.func_77973_b() == Items.field_151141_av) {
   ...
   public IEntityLivingData func_110161_a(IEntityLivingData p_110161_1_) {
      ...
      if(p_110161_1_1 instanceof EntityHorse.GroupData) {
         ...
         var3 = ((EntityHorse.GroupData)p_110161_1_1).field_111106_b & 255 | this.field_70146_Z.nextInt(5) << 8;
      } else {
