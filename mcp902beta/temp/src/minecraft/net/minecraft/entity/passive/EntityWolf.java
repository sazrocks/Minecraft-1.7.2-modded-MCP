...
public class EntityWolf extends EntityTameable {
   ...
   public boolean func_70652_k(Entity p_70652_1_) {
      ...
      return p_70652_1_.func_70097_a(DamageSource.func_76358_a(this), (float)var2);
   }
   ...
   public boolean func_70085_c(EntityPlayer p_70085_1_) {
      ...
      if(this.func_70909_n()) {
         ...
         if(p_70085_1_.func_70005_c_().equalsIgnoreCase(this.func_70905_p()) && !this.field_70170_p.field_72995_K && !this.func_70877_b(var2)) {
   ...
   public EntityWolf func_90011_a(EntityAgeable p_70879_1_) {
   ...
   public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_) {
      if(!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
         if(p_142018_1_ instanceof EntityWolf) {
            ...
            if(var3.func_70909_n() && var3.func_70902_q() == p_142018_2_) {
               return false;
            }
         }
