...
public abstract class EntityLivingBase extends Entity {
   ...
   public void func_70669_a(ItemStack p_70669_1_) {
      ...
      for(int var2 = 0; var2 < 5; ++var2) {
         ...
         this.field_70170_p.func_72869_a("iconcrack_" + Item.func_150891_b(p_70669_1_.func_77973_b()), var4.field_72450_a, var4.field_72448_b, var4.field_72449_c, var3.field_72450_a, var3.field_72448_b + 0.05D, var3.field_72449_c);
      }
   ...
   protected void func_70069_a(float p_70069_1_) {
      ...
      if(var4 > 0) {
         ...
         int var6 = MathHelper.func_76128_c(this.field_70163_u - 0.20000000298023224D - (double)this.field_70129_M);
      ...
      for(int var10 = -var9; var10 <= var9; ++var10) {
         for(int var11 = -var9; var11 < var9; ++var11) {
            if(var10 != 0 || var11 != 0) {
               ...
               AxisAlignedBB var2 = this.field_70121_D.func_72325_c((double)var10, 1.0D, (double)var11);
               if(this.field_70170_p.func_147461_a(var2).isEmpty()) {
                  ...
                  if(World.func_147466_a(this.field_70170_p, var12, (int)this.field_70163_u - 1, var13) || this.field_70170_p.func_147439_a(var12, (int)this.field_70163_u - 1, var13).func_149688_o() == Material.field_151586_h) {
   ...
   public void func_70612_e(float p_70612_1_, float p_70612_2_) {
      ...
      if(this.func_70090_H() && (!(this instanceof EntityPlayer) || !((EntityPlayer)this).field_71075_bZ.field_75100_b)) {
         ...
         if(this.field_70122_E) {
            var3 = this.field_70170_p.func_147439_a(MathHelper.func_76128_c(this.field_70165_t), MathHelper.func_76128_c(this.field_70121_D.field_72338_b) - 1, MathHelper.func_76128_c(this.field_70161_v)).field_149765_K * 0.91F;
         }
      ...
      float var10 = MathHelper.func_76133_a(var8 * var8 + var9 * var9) * 4.0F;
      if(var10 > 1.0F) {
         var10 = 1.0F;
      }
