...
public abstract class EntityPlayer extends EntityLivingBase implements ICommandSender {
   ...
   public EntityPlayer(World p_i45324_1_, GameProfile p_i45324_2_) {
      ...
      ChunkCoordinates var3 = p_i45324_1_.func_72861_E();
   ...
   protected void func_71010_c(ItemStack p_71010_1_, int p_71010_2_) {
      ...
      if(p_71010_1_.func_77975_n() == EnumAction.eat) {
         for(int var3 = 0; var3 < p_71010_2_; ++var3) {
            ...
            String var6 = "iconcrack_" + Item.func_150891_b(p_71010_1_.func_77973_b());
            if(p_71010_1_.func_77981_g()) {
               var6 = var6 + "_" + p_71010_1_.func_77960_j();
            }

            this.field_70170_p.func_72869_a(var6, var5.field_72450_a, var5.field_72448_b, var5.field_72449_c, var4.field_72450_a, var4.field_72448_b + 0.05D, var4.field_72449_c);
         }
   ...
   public void func_70636_d() {
      ...
      float var3 = (float)Math.atan(-this.field_70181_x * 0.20000000298023224D) * 15.0F;
      if(var2 > 0.1F) {
         var2 = 0.1F;
      }
      ...
      if(this.func_110143_aJ() > 0.0F) {
         ...
         if(this.field_70154_o != null && !this.field_70154_o.field_70128_L) {
            var4 = this.field_70121_D.func_111270_a(this.field_70154_o.field_70121_D).func_72314_b(1.0D, 0.0D, 1.0D);
         } else {
            var4 = this.field_70121_D.func_72314_b(1.0D, 0.5D, 1.0D);
         }
   ...
   public EntityItem func_146097_a(ItemStack p_146097_1_, boolean p_146097_2_, boolean p_146097_3_) {
      if(p_146097_1_ == null) {
         ...
         EntityItem var4 = new EntityItem(this.field_70170_p, this.field_70165_t, this.field_70163_u - 0.30000001192092896D + (double)this.func_70047_e(), this.field_70161_v, p_146097_1_);
         ...
         float var6;
         if(p_146097_2_) {
            var6 = this.field_70146_Z.nextFloat() * 0.5F;
            ...
            var4.field_70181_x = 0.20000000298023224D;
         } else {
            var5 = 0.3F;
            var4.field_70159_w = (double)(-MathHelper.func_76126_a(this.field_70177_z / 180.0F * 3.1415927F) * MathHelper.func_76134_b(this.field_70125_A / 180.0F * 3.1415927F) * var5);
            var4.field_70179_y = (double)(MathHelper.func_76134_b(this.field_70177_z / 180.0F * 3.1415927F) * MathHelper.func_76134_b(this.field_70125_A / 180.0F * 3.1415927F) * var5);
            var4.field_70181_x = (double)(-MathHelper.func_76126_a(this.field_70125_A / 180.0F * 3.1415927F) * var5 + 0.1F);
            var5 = 0.02F;
            var6 = this.field_70146_Z.nextFloat() * 3.1415927F * 2.0F;
            var5 *= this.field_70146_Z.nextFloat();
            var4.field_70159_w += Math.cos((double)var6) * (double)var5;
            var4.field_70181_x += (double)((this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.1F);
            var4.field_70179_y += Math.sin((double)var6) * (double)var5;
         }
   ...
   public float func_146096_a(Block p_146096_1_, boolean p_146096_2_) {
      float var3 = this.field_71071_by.func_146023_a(p_146096_1_);
      if(var3 > 1.0F) {
      ...
      if(p_71059_1_.func_70075_an()) {
         if(!p_71059_1_.func_85031_j(this)) {
            ...
            if(p_71059_1_ instanceof EntityLivingBase) {
               var4 = EnchantmentHelper.func_77512_a(this, (EntityLivingBase)p_71059_1_);
               var3 += EnchantmentHelper.func_77507_b(this, (EntityLivingBase)p_71059_1_);
            }
   ...
   public static ChunkCoordinates func_71056_a(World p_71056_0_, ChunkCoordinates p_71056_1_, boolean p_71056_2_) {
      ...
      if(p_71056_0_.func_147439_a(p_71056_1_.field_71574_a, p_71056_1_.field_71572_b, p_71056_1_.field_71573_c) == Blocks.field_150324_C) {
         ChunkCoordinates var8 = BlockBed.func_149977_a(p_71056_0_, p_71056_1_.field_71574_a, p_71056_1_.field_71572_b, p_71056_1_.field_71573_c, 0);
         return var8;
      } else {
         Material var4 = p_71056_0_.func_147439_a(p_71056_1_.field_71574_a, p_71056_1_.field_71572_b, p_71056_1_.field_71573_c).func_149688_o();
         Material var5 = p_71056_0_.func_147439_a(p_71056_1_.field_71574_a, p_71056_1_.field_71572_b + 1, p_71056_1_.field_71573_c).func_149688_o();
   ...
   public void func_70074_a(EntityLivingBase p_70074_1_) {
      ...
      int var2 = EntityList.func_75619_a(p_70074_1_);
      EntityList.EntityEggInfo var3 = (EntityList.EntityEggInfo)EntityList.field_75627_a.get(Integer.valueOf(var2));
      if(var3 != null) {
   ...
   public IIcon func_70620_b(ItemStack p_70620_1_, int p_70620_2_) {
      IIcon var3 = super.func_70620_b(p_70620_1_, p_70620_2_);
   ...
   public boolean func_82246_f(int p_82246_1_, int p_82246_2_, int p_82246_3_) {
      if(this.field_71075_bZ.field_75099_e) {
         ...
         Block var4 = this.field_70170_p.func_147439_a(p_82246_1_, p_82246_2_, p_82246_3_);
   ...
   public static UUID func_146094_a(GameProfile p_146094_0_) {
      UUID var1 = Util.func_147173_b(p_146094_0_.getId());
      if(var1 == null) {
