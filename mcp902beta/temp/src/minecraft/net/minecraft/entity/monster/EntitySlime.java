...
public class EntitySlime extends EntityLiving implements IMob {
   ...
   public void func_70100_b_(EntityPlayer p_70100_1_) {
      if(this.func_70800_m()) {
         ...
         if(this.func_70685_l(p_70100_1_) && this.func_70068_e(p_70100_1_) < 0.6D * (double)var2 * 0.6D * (double)var2 && p_70100_1_.func_70097_a(DamageSource.func_76358_a(this), (float)this.func_70805_n())) {
