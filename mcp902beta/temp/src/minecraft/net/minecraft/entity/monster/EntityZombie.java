...
public class EntityZombie extends EntityMob {
   ...
   public boolean func_70097_a(DamageSource p_70097_1_, float p_70097_2_) {
      if(!super.func_70097_a(p_70097_1_, p_70097_2_)) {
         ...
         if(var3 != null && this.field_70170_p.field_73013_u == EnumDifficulty.HARD && (double)this.field_70146_Z.nextFloat() < this.func_110148_a(field_110186_bp).func_111126_e()) {
            ...
            for(int var8 = 0; var8 < 50; ++var8) {
               ...
               if(World.func_147466_a(this.field_70170_p, var9, var10 - 1, var11) && this.field_70170_p.func_72957_l(var9, var10, var11) < 10) {
                  ...
                  if(this.field_70170_p.func_72855_b(var7.field_70121_D) && this.field_70170_p.func_72945_a(var7, var7.field_70121_D).isEmpty() && !this.field_70170_p.func_72953_d(var7.field_70121_D)) {
                     ...
                     var7.func_110161_a((IEntityLivingData)null);
   ...
   public IEntityLivingData func_110161_a(IEntityLivingData p_110161_1_) {
      ...
      if(this.func_71124_b(4) == null) {
         ...
         if(var6.get(2) + 1 == 10 && var6.get(5) == 31 && this.field_70146_Z.nextFloat() < 0.25F) {
      ...
      double var7 = this.field_70146_Z.nextDouble() * 1.5D * (double)this.field_70170_p.func_147462_b(this.field_70165_t, this.field_70163_u, this.field_70161_v);
      if(var7 > 1.0D) {
         this.func_110148_a(SharedMonsterAttributes.field_111265_b).func_111121_a(new AttributeModifier("Random zombie-spawn bonus", var7, 2));
      }
   ...
   protected void func_82232_p() {
      ...
      var1.func_110161_a((IEntityLivingData)null);
      var1.func_82187_q();
      if(this.func_70631_g_()) {
