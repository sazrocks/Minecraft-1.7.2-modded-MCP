...
public abstract class EntityAITarget extends EntityAIBase {
   ...
   protected boolean func_75296_a(EntityLivingBase p_75296_1_, boolean p_75296_2_) {
      if(p_75296_1_ == null) {
         ...
         if(this.field_75299_d instanceof IEntityOwnable && StringUtils.isNotEmpty(((IEntityOwnable)this.field_75299_d).func_70905_p())) {
            if(p_75296_1_ instanceof IEntityOwnable && ((IEntityOwnable)this.field_75299_d).func_70905_p().equals(((IEntityOwnable)p_75296_1_).func_70905_p())) {
               return false;
            }
