   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) {
      if(p_71515_2_.length < 2) {
         ...
         if(p_71515_2_[1].equals("clear")) {
            ...
            var3.func_70674_bp();
            func_71522_a(p_71515_1_, "commands.effect.success.removed.all", new Object[]{var3.func_70005_c_()});
         } else {
            ...
            if(var6 == 0) {
               if(!var3.func_82165_m(var4)) {
                  throw new CommandException("commands.effect.failure.notActive", new Object[]{new ChatComponentTranslation(Potion.field_76425_a[var4].func_76393_a(), new Object[0]), var3.func_70005_c_()});
               }

               var3.func_82170_o(var4);
               func_71522_a(p_71515_1_, "commands.effect.success.removed", new Object[]{new ChatComponentTranslation(Potion.field_76425_a[var4].func_76393_a(), new Object[0]), var3.func_70005_c_()});
            } else {
               PotionEffect var8 = new PotionEffect(var4, var5, var7);
               var3.func_70690_d(var8);
               func_71522_a(p_71515_1_, "commands.effect.success", new Object[]{new ChatComponentTranslation(var8.func_76453_d(), new Object[0]), Integer.valueOf(var4), Integer.valueOf(var7), var3.func_70005_c_(), Integer.valueOf(var6)});
            }
         }
