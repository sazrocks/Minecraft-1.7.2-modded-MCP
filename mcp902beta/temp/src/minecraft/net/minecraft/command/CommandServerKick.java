   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) {
      if(p_71515_2_.length > 0 && p_71515_2_[0].length() > 1) {
         ...
         if(var3 == null) {
            ...
            if(var5) {
               func_71522_a(p_71515_1_, "commands.kick.success.reason", new Object[]{var3.func_70005_c_(), var4});
            } else {
               func_71522_a(p_71515_1_, "commands.kick.success", new Object[]{var3.func_70005_c_()});
            }
