   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) {
      if(p_71515_2_.length >= 1) {
         ...
         if(!var10.func_72899_e((int)var4, (int)var6, (int)var8)) {
            func_71522_a(p_71515_1_, "commands.summon.outOfWorld", new Object[0]);
         } else {
            ...
            if(p_71515_2_.length >= 5) {
               ...
               try {
                  ...
                  if(!(var14 instanceof NBTTagCompound)) {
                     func_71522_a(p_71515_1_, "commands.summon.tagError", new Object[]{"Not a valid tag"});
                     return;
                  }
                  ...
                  func_71522_a(p_71515_1_, "commands.summon.tagError", new Object[]{var17.getMessage()});
                  return;
               }
            }
            ...
            if(var18 != null) {
               ...
               for(NBTTagCompound var15 = var11; var15.func_150297_b("Riding", 10); var15 = var15.func_74775_l("Riding")) {
               ...
               func_71522_a(p_71515_1_, "commands.summon.success", new Object[0]);
            } else {
               func_71522_a(p_71515_1_, "commands.summon.failed", new Object[0]);
            }
         }
      } else {
