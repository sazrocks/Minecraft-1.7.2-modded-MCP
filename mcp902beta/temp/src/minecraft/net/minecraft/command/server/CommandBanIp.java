...
public class CommandBanIp extends CommandBase {
   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) {
      if(p_71515_2_.length >= 1 && p_71515_2_[0].length() > 1) {
         ...
         if(var3.matches()) {
            ...
            this.func_147210_a(p_71515_1_, var5.func_71114_r(), var4 == null?null:var4.func_150260_c());
         }
   ...
   protected void func_147210_a(ICommandSender p_147210_1_, String p_147210_2_, String p_147210_3_) {
      ...
      if(var5.isEmpty()) {
         ...
         func_71522_a(p_147210_1_, "commands.banip.success.players", new Object[]{p_147210_2_, func_71527_a(var6)});
      }
