   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) {
      if(p_71515_2_.length >= 1) {
         ...
         if(p_71515_2_[0].equals("list")) {
            p_71515_1_.func_145747_a(new ChatComponentTranslation("commands.whitelist.list", new Object[]{Integer.valueOf(MinecraftServer.func_71276_C().func_71203_ab().func_72388_h().size()), Integer.valueOf(MinecraftServer.func_71276_C().func_71203_ab().func_72373_m().length)}));
            Set var3 = MinecraftServer.func_71276_C().func_71203_ab().func_72388_h();
            p_71515_1_.func_145747_a(new ChatComponentText(func_71527_a(var3.toArray(new String[var3.size()]))));
            return;
         }
