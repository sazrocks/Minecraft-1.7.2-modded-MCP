...
public class ServerCommandManager extends CommandHandler implements IAdminCommand {
   ...
   public void func_71563_a(ICommandSender p_71563_1_, int p_71563_2_, String p_71563_3_, Object ... p_71563_4_) {
      boolean var5 = true;
      if(p_71563_1_ instanceof CommandBlockLogic && !MinecraftServer.func_71276_C().field_71305_c[0].func_82736_K().func_82766_b("commandBlockOutput")) {
         var5 = false;
      }

      ChatComponentTranslation var6 = new ChatComponentTranslation("chat.type.admin", new Object[]{p_71563_1_.func_70005_c_(), new ChatComponentTranslation(p_71563_3_, p_71563_4_)});
      var6.func_150256_b().func_150238_a(EnumChatFormatting.GRAY);
      var6.func_150256_b().func_150217_b(Boolean.valueOf(true));
      if(var5) {
      ...
      if(p_71563_1_ != MinecraftServer.func_71276_C()) {
         MinecraftServer.func_71276_C().func_145747_a(var6);
      }

      if((p_71563_2_ & 1) != 1) {
         p_71563_1_.func_145747_a(new ChatComponentTranslation(p_71563_3_, p_71563_4_));
      }
