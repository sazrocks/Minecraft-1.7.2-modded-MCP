   ...
   public int func_71556_a(ICommandSender p_71556_1_, String p_71556_2_) {
      ...
      try {
         ...
         if(var5.func_71519_b(p_71556_1_)) {
            if(var6 > -1) {
               ...
               for(int var12 = 0; var12 < var11; ++var12) {
                  ...
                  try {
                     ...
                     ChatComponentTranslation var15 = new ChatComponentTranslation(var16.getMessage(), var16.func_74844_a());
            ...
            var20.func_150256_b().func_150238_a(EnumChatFormatting.RED);
            p_71556_1_.func_145747_a(var20);
         }
      } catch (WrongUsageException var17) {
         var9 = new ChatComponentTranslation("commands.generic.usage", new Object[]{new ChatComponentTranslation(var17.getMessage(), var17.func_74844_a())});
         var9.func_150256_b().func_150238_a(EnumChatFormatting.RED);
         p_71556_1_.func_145747_a(var9);
      } catch (CommandException var18) {
         var9 = new ChatComponentTranslation(var18.getMessage(), var18.func_74844_a());
         var9.func_150256_b().func_150238_a(EnumChatFormatting.RED);
         p_71556_1_.func_145747_a(var9);
         ...
         var9.func_150256_b().func_150238_a(EnumChatFormatting.RED);
         p_71556_1_.func_145747_a(var9);
         field_147175_a.error("Couldn\'t process command", var19);
      }
