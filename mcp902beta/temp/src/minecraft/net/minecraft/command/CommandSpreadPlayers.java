   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) {
      if(p_71515_2_.length < 6) {
         ...
         while(true) {
            ...
            p_71515_1_.func_145747_a(new ChatComponentTranslation("commands.spreadplayers.spreading." + (var12?"teams":"players"), new Object[]{Integer.valueOf(var13.size()), Double.valueOf(var10), Double.valueOf(var4), Double.valueOf(var6), Double.valueOf(var8)}));
            this.func_110669_a(p_71515_1_, var13, new CommandSpreadPlayers.Position(var4, var6), var8, var10, ((EntityLivingBase)var13.get(0)).field_70170_p, var12);
            return;
         }
      }
   }
   ...
   static class Position {
      ...
      public int func_111092_a(World p_111092_1_) {
         ...
         for(int var4 = 256; var4 > 0; --var4) {
            if(p_111092_1_.func_147439_a(var2, var4, var3).func_149688_o() != Material.field_151579_a) {
               return var4 + 1;
            }
         }
      ...
      public boolean func_111098_b(World p_111098_1_) {
         ...
         if(var4 <= 0) {
            ...
            Material var5 = p_111098_1_.func_147439_a(var2, var4, var3).func_149688_o();
