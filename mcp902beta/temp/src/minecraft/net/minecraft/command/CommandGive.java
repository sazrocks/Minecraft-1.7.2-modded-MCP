...
public class CommandGive extends CommandBase {
   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) {
      if(p_71515_2_.length < 2) {
         ...
         if(p_71515_2_.length >= 5) {
            ...
            try {
               ...
               if(!(var9 instanceof NBTTagCompound)) {
                  func_71522_a(p_71515_1_, "commands.give.tagError", new Object[]{"Not a valid tag"});
                  return;
               }

               var7.func_77982_d((NBTTagCompound)var9);
            } catch (NBTException var10) {
               func_71522_a(p_71515_1_, "commands.give.tagError", new Object[]{var10.getMessage()});
               return;
            }
         }
         ...
         func_71522_a(p_71515_1_, "commands.give.success", new Object[]{var7.func_151000_E(), Integer.valueOf(var5), var3.func_70005_c_()});
      }
   }
