...
public final class ItemStack {
   ...
   public List func_82840_a(EntityPlayer p_82840_1_, boolean p_82840_2_) {
      ...
      if(p_82840_2_) {
         ...
         var6 = Item.func_150891_b(this.field_151002_e);
      ...
      if(this.func_77942_o()) {
         ...
         if(var13 != null) {
            for(var6 = 0; var6 < var13.func_74745_c(); ++var6) {
               short var7 = var13.func_150305_b(var6).func_74765_d("id");
               short var8 = var13.func_150305_b(var6).func_74765_d("lvl");
         ...
         if(this.field_77990_d.func_150297_b("display", 10)) {
            NBTTagCompound var15 = this.field_77990_d.func_74775_l("display");
            if(var15.func_150297_b("color", 3)) {
               if(p_82840_2_) {
                  var3.add("Color: #" + Integer.toHexString(var15.func_74762_e("color")).toUpperCase());
               } else {
            ...
            if(var15.func_150299_b("Lore") == 9) {
               NBTTagList var17 = var15.func_150295_c("Lore", 8);
               if(var17.func_74745_c() > 0) {
                  for(int var19 = 0; var19 < var17.func_74745_c(); ++var19) {
                     var3.add(EnumChatFormatting.DARK_PURPLE + "" + EnumChatFormatting.ITALIC + var17.func_150307_f(var19));
                  }
               }
            }
         }
      ...
      if(!var14.isEmpty()) {
         ...
         while(var16.hasNext()) {
            ...
            double var9 = var20.func_111164_d();
            double var11;
            if(var20.func_111169_c() != 1 && var20.func_111169_c() != 2) {
               var11 = var20.func_111164_d();
            } else {
               var11 = var20.func_111164_d() * 100.0D;
            }

            if(var9 > 0.0D) {
               var3.add(EnumChatFormatting.BLUE + StatCollector.func_74837_a("attribute.modifier.plus." + var20.func_111169_c(), new Object[]{field_111284_a.format(var11), StatCollector.func_74838_a("attribute.name." + (String)var18.getKey())}));
            } else if(var9 < 0.0D) {
               var11 *= -1.0D;
               var3.add(EnumChatFormatting.RED + StatCollector.func_74837_a("attribute.modifier.take." + var20.func_111169_c(), new Object[]{field_111284_a.format(var11), StatCollector.func_74838_a("attribute.name." + (String)var18.getKey())}));
            }
         }
      }
