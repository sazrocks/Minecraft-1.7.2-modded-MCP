...
public class ItemFireworkCharge extends Item {
   ...
   public static void func_150902_a(NBTTagCompound p_150902_0_, List p_150902_1_) {
         ...
         for(var9 = 0; var9 < var8; ++var9) {
            ...
            for(int var12 = 0; var12 < 16; ++var12) {
               if(var18 == ItemDye.field_150922_c[var12]) {
                  var19 = true;
                  var14 = var14 + StatCollector.func_74838_a("item.fireworksCharge." + ItemDye.field_150923_a[var12]);
                  break;
               }
            }
      ...
      var15 = p_150902_0_.func_74767_n("Trail");
      if(var15) {
         p_150902_1_.add(StatCollector.func_74838_a("item.fireworksCharge.trail"));
      }

      boolean var17 = p_150902_0_.func_74767_n("Flicker");
      if(var17) {
