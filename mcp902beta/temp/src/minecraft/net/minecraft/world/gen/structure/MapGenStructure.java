...
public abstract class MapGenStructure extends MapGenBase {
      ...
      if(!this.field_75053_d.containsKey(Long.valueOf(ChunkCoordIntPair.func_77272_a(p_151538_2_, p_151538_3_)))) {
         ...
         try {
            if(this.func_75047_a(p_151538_2_, p_151538_3_)) {
               StructureStart var7 = this.func_75049_b(p_151538_2_, p_151538_3_);
               this.field_75053_d.put(Long.valueOf(ChunkCoordIntPair.func_77272_a(p_151538_2_, p_151538_3_)), var7);
            ...
            var9.func_71507_a("Chunk location", String.format("%d,%d", new Object[]{Integer.valueOf(p_151538_2_), Integer.valueOf(p_151538_3_)}));
   ...
   public ChunkPosition func_151545_a(World p_151545_1_, int p_151545_2_, int p_151545_3_, int p_151545_4_) {
      ...
      this.field_75038_b.setSeed(var9 ^ var11 ^ p_151545_1_.func_72905_C());
