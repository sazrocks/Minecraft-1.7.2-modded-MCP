            ...
            for(var32 = 0; var32 < 16; ++var32) {
               for(var10 = 4; var10 < 8; ++var10) {
                  if(var6[(var8 * 16 + var32) * 8 + var10] && p_76484_1_.func_147439_a(p_76484_3_ + var8, p_76484_4_ + var10 - 1, p_76484_5_ + var32) == Blocks.field_150346_d && p_76484_1_.func_72972_b(EnumSkyBlock.Sky, p_76484_3_ + var8, p_76484_4_ + var10, p_76484_5_ + var32) > 0) {
                     ...
                     if(var34.field_76752_A == Blocks.field_150391_bh) {
         ...
         if(this.field_150556_a.func_149688_o() == Material.field_151587_i) {
            for(var8 = 0; var8 < 16; ++var8) {
               for(var32 = 0; var32 < 16; ++var32) {
                  for(var10 = 0; var10 < 8; ++var10) {
                     var33 = !var6[(var8 * 16 + var32) * 8 + var10] && (var8 < 15 && var6[((var8 + 1) * 16 + var32) * 8 + var10] || var8 > 0 && var6[((var8 - 1) * 16 + var32) * 8 + var10] || var32 < 15 && var6[(var8 * 16 + var32 + 1) * 8 + var10] || var32 > 0 && var6[(var8 * 16 + (var32 - 1)) * 8 + var10] || var10 < 7 && var6[(var8 * 16 + var32) * 8 + var10 + 1] || var10 > 0 && var6[(var8 * 16 + var32) * 8 + (var10 - 1)]);
                     if(var33 && (var10 < 4 || p_76484_2_.nextInt(2) != 0) && p_76484_1_.func_147439_a(p_76484_3_ + var8, p_76484_4_ + var10, p_76484_5_ + var32).func_149688_o().func_76220_a()) {
            ...
            for(var8 = 0; var8 < 16; ++var8) {
               for(var32 = 0; var32 < 16; ++var32) {
                  ...
                  if(p_76484_1_.func_72884_u(p_76484_3_ + var8, p_76484_4_ + var35, p_76484_5_ + var32)) {
                     p_76484_1_.func_147465_d(p_76484_3_ + var8, p_76484_4_ + var35, p_76484_5_ + var32, Blocks.field_150432_aD, 0, 2);
                  }
               }
            }
         }
