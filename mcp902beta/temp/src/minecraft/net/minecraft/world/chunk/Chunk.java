...
public class Chunk {
   ...
   public Chunk(World p_i45446_1_, Block[] p_i45446_2_, int p_i45446_3_, int p_i45446_4_) {
      ...
      boolean var6 = !p_i45446_1_.field_73011_w.field_76576_e;
   ...
   public Chunk(World p_i45447_1_, Block[] p_i45447_2_, byte[] p_i45447_3_, int p_i45447_4_, int p_i45447_5_) {
      ...
      boolean var7 = !p_i45447_1_.field_73011_w.field_76576_e;
         ...
         for(int var9 = 0; var9 < 16; ++var9) {
            for(int var10 = 0; var10 < var6; ++var10) {
               ...
               if(var12 != null && var12 != Blocks.field_150350_a) {
                  ...
                  this.field_76652_q[var13].func_76654_b(var8, var10 & 15, var9, p_i45447_3_[var11]);
               }
            }
         }
      }
   ...
   private void func_76609_d(int p_76609_1_, int p_76609_2_, int p_76609_3_, int p_76609_4_) {
      if(p_76609_4_ > p_76609_3_ && this.field_76637_e.func_72873_a(p_76609_1_, 0, p_76609_2_, 16)) {
         for(int var5 = p_76609_3_; var5 < p_76609_4_; ++var5) {
            this.field_76637_e.func_147463_c(EnumSkyBlock.Sky, p_76609_1_, var5, p_76609_2_);
         }
            ...
            if(var5 < var4) {
               for(var8 = var5; var8 < var4; ++var8) {
                  ...
                  if(var9 != null) {
                     ...
                     this.field_76637_e.func_147479_m((this.field_76635_g << 4) + p_76615_1_, var8, (this.field_76647_h << 4) + p_76615_3_);
                  }
               }
            } else {
      ...
      if(p_150810_2_ >> 4 < this.field_76652_q.length) {
         ...
         if(var5 != null) {
            try {
               ...
               var8.func_71500_a("Location", new Callable() {
   ...
   public boolean func_150807_a(int p_150807_1_, int p_150807_2_, int p_150807_3_, Block p_150807_4_, int p_150807_5_) {
      ...
      if(p_150807_2_ >= this.field_76638_b[var6] - 1) {
      ...
      int var9 = this.func_76628_c(p_150807_1_, p_150807_2_, p_150807_3_);
      if(var8 == p_150807_4_ && var9 == p_150807_5_) {
         return false;
      } else {
         ExtendedBlockStorage var10 = this.field_76652_q[p_150807_2_ >> 4];
         boolean var11 = false;
         if(var10 == null) {
            ...
            var10 = this.field_76652_q[p_150807_2_ >> 4] = new ExtendedBlockStorage(p_150807_2_ >> 4 << 4, !this.field_76637_e.field_73011_w.field_76576_e);
            var11 = p_150807_2_ >= var7;
         }

         int var12 = this.field_76635_g * 16 + p_150807_1_;
         int var13 = this.field_76647_h * 16 + p_150807_3_;
         if(!this.field_76637_e.field_72995_K) {
            var8.func_149725_f(this.field_76637_e, var12, p_150807_2_, var13, var9);
         }

         var10.func_150818_a(p_150807_1_, p_150807_2_ & 15, p_150807_3_, p_150807_4_);
         if(!this.field_76637_e.field_72995_K) {
            var8.func_149749_a(this.field_76637_e, var12, p_150807_2_, var13, var8, var9);
         } else if(var8 instanceof ITileEntityProvider && var8 != p_150807_4_) {
            this.field_76637_e.func_147475_p(var12, p_150807_2_, var13);
         }

         if(var10.func_150819_a(p_150807_1_, p_150807_2_ & 15, p_150807_3_) != p_150807_4_) {
            return false;
         } else {
            var10.func_76654_b(p_150807_1_, p_150807_2_ & 15, p_150807_3_, p_150807_5_);
            if(var11) {
               this.func_76603_b();
            } else {
               int var14 = p_150807_4_.func_149717_k();
               ...
               if(var14 != var15 && (var14 < var15 || this.func_76614_a(EnumSkyBlock.Sky, p_150807_1_, p_150807_2_, p_150807_3_) > 0 || this.func_76614_a(EnumSkyBlock.Block, p_150807_1_, p_150807_2_, p_150807_3_) > 0)) {
            ...
            if(!this.field_76637_e.field_72995_K) {
               p_150807_4_.func_149726_b(this.field_76637_e, var12, p_150807_2_, var13);
            }

            if(p_150807_4_ instanceof ITileEntityProvider) {
               var16 = this.func_150806_e(p_150807_1_, p_150807_2_, p_150807_3_);
               if(var16 == null) {
                  var16 = ((ITileEntityProvider)p_150807_4_).func_149915_a(this.field_76637_e, p_150807_5_);
                  this.field_76637_e.func_147455_a(var12, p_150807_2_, var13, var16);
               }
      ...
      if(var5 == null) {
         ...
         if(var6 == p_76589_4_) {
            ...
            if(var5.func_150819_a(p_76589_1_, p_76589_2_ & 15, p_76589_3_) instanceof ITileEntityProvider) {
               ...
               if(var7 != null) {
                  var7.func_145836_u();
                  var7.field_145847_g = p_76589_4_;
               }
            }
   ...
   public void func_76612_a(Entity p_76612_1_) {
      ...
      if(var2 != this.field_76635_g || var3 != this.field_76647_h) {
         field_150817_t.error("Wrong location! " + p_76612_1_);
         Thread.dumpStack();
      }
   ...
   public TileEntity func_150806_e(int p_150806_1_, int p_150806_2_, int p_150806_3_) {
      ...
      if(var5 == null) {
         ...
         var5 = ((ITileEntityProvider)var6).func_149915_a(this.field_76637_e, this.func_76628_c(p_150806_1_, p_150806_2_, p_150806_3_));
         this.field_76637_e.func_147455_a(this.field_76635_g * 16 + p_150806_1_, p_150806_2_, this.field_76647_h * 16 + p_150806_3_, var5);
      }
   ...
   public void func_150813_a(TileEntity p_150813_1_) {
      int var2 = p_150813_1_.field_145851_c - this.field_76635_g * 16;
      int var3 = p_150813_1_.field_145848_d;
      int var4 = p_150813_1_.field_145849_e - this.field_76647_h * 16;
   ...
   public void func_150812_a(int p_150812_1_, int p_150812_2_, int p_150812_3_, TileEntity p_150812_4_) {
      ...
      if(this.func_150810_a(p_150812_1_, p_150812_2_, p_150812_3_) instanceof ITileEntityProvider) {
         ...
         this.field_150816_i.put(var5, p_150812_4_);
      }
   }
   ...
   public void func_76594_o() {
      for(int var1 = 0; var1 < 8; ++var1) {
         ...
         for(int var7 = 0; var7 < 16; ++var7) {
            ...
            if(this.field_76652_q[var2] == null && (var7 == 0 || var7 == 15 || var3 == 0 || var3 == 15 || var4 == 0 || var4 == 15) || this.field_76652_q[var2] != null && this.field_76652_q[var2].func_150819_a(var3, var7, var4).func_149688_o() == Material.field_151579_a) {
   ...
   private boolean func_150811_f(int p_150811_1_, int p_150811_2_) {
      ...
      for(var6 = var3 + 16 - 1; var6 > 63 || var6 > 0 && !var5; --var6) {
         ...
         if(!var4 && var7 > 0) {
            var4 = true;
         } else if(var4 && var7 == 0 && !this.field_76637_e.func_147451_t(this.field_76635_g * 16 + p_150811_1_, var6, this.field_76647_h * 16 + p_150811_2_)) {
            return false;
         }
      }

      for(; var6 > 0; --var6) {
         if(this.func_150810_a(p_150811_1_, var6, p_150811_2_).func_149750_m() > 0) {
            this.field_76637_e.func_147451_t(this.field_76635_g * 16 + p_150811_1_, var6, this.field_76647_h * 16 + p_150811_2_);
         }
      }
