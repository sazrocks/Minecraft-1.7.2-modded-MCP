...
public class MapData extends WorldSavedData {
   ...
   private void func_82567_a(int p_82567_1_, World p_82567_2_, String p_82567_3_, double p_82567_4_, double p_82567_6_, double p_82567_8_) {
      ...
      this.field_76203_h.put(p_82567_3_, new MapData.MapCoord((byte)p_82567_1_, var13, var14, var15));
   }

   public byte[] func_76193_a(ItemStack p_76193_1_, World p_76193_2_, EntityPlayer p_76193_3_) {
      MapData.MapInfo var4 = (MapData.MapInfo)this.field_76202_j.get(p_76193_3_);
   ...
   public void func_76192_a(byte[] p_76192_1_) {
      ...
      if(p_76192_1_[0] == 0) {
         ...
         for(var2 = 0; var2 < (p_76192_1_.length - 1) / 3; ++var2) {
            ...
            this.field_76203_h.put("icon-" + var2, new MapData.MapCoord(var7, var8, var5, var6));
         }
   ...
   public class MapInfo {
      ...
      public byte[] func_76204_a(ItemStack p_76204_1_) {
         ...
         if(!this.field_82570_i) {
            var2 = new byte[]{(byte)2, MapData.this.field_76197_d};
            ...
            if(--this.field_76205_f < 0) {
               ...
               var2 = new byte[MapData.this.field_76203_h.size() * 3 + 1];
               var2[0] = 1;
               var3 = 0;

               for(Iterator var4 = MapData.this.field_76203_h.values().iterator(); var4.hasNext(); ++var3) {
            ...
            for(int var8 = 0; var8 < 1; ++var8) {
               ...
               if(this.field_76209_b[var3] >= 0) {
                  ...
                  for(int var7 = 0; var7 < var6.length - 3; ++var7) {
                     var6[var7 + 3] = MapData.this.field_76198_e[(var7 + var10) * 128 + var3];
                  }
