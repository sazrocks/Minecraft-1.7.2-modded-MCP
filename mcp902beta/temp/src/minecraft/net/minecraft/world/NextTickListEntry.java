...
public class NextTickListEntry implements Comparable {
   ...
   public NextTickListEntry(int p_i45370_1_, int p_i45370_2_, int p_i45370_3_, Block p_i45370_4_) {
      ...
      this.field_77183_a = p_i45370_1_;
      this.field_77181_b = p_i45370_2_;
      this.field_77182_c = p_i45370_3_;
   ...
   public boolean equals(Object p_equals_1_) {
      if(!(p_equals_1_ instanceof NextTickListEntry)) {
         ...
         return this.field_77183_a == var2.field_77183_a && this.field_77181_b == var2.field_77181_b && this.field_77182_c == var2.field_77182_c && Block.func_149680_a(this.field_151352_g, var2.field_151352_g);
      }
   }
   ...
   public int compareTo(NextTickListEntry p_77175_1_) {
   ...
   public String toString() {
      return Block.func_149682_b(this.field_151352_g) + ": (" + this.field_77183_a + ", " + this.field_77181_b + ", " + this.field_77182_c + "), " + this.field_77180_e + ", " + this.field_82754_f + ", " + this.field_77178_g;
   }
