...
public class GuiStats extends GuiScreen implements IProgressMeter {
   ...
   private void func_146527_c(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
      ...
      var9.func_78382_b();
      var9.func_78374_a((double)(p_146527_1_ + 0), (double)(p_146527_2_ + 18), (double)this.field_73735_i, (double)((float)(p_146527_3_ + 0) * 0.0078125F), (double)((float)(p_146527_4_ + 18) * 0.0078125F));
      var9.func_78374_a((double)(p_146527_1_ + 18), (double)(p_146527_2_ + 18), (double)this.field_73735_i, (double)((float)(p_146527_3_ + 18) * 0.0078125F), (double)((float)(p_146527_4_ + 18) * 0.0078125F));
      var9.func_78374_a((double)(p_146527_1_ + 18), (double)(p_146527_2_ + 0), (double)this.field_73735_i, (double)((float)(p_146527_3_ + 18) * 0.0078125F), (double)((float)(p_146527_4_ + 0) * 0.0078125F));
      var9.func_78374_a((double)(p_146527_1_ + 0), (double)(p_146527_2_ + 0), (double)this.field_73735_i, (double)((float)(p_146527_3_ + 0) * 0.0078125F), (double)((float)(p_146527_4_ + 0) * 0.0078125F));
      var9.func_78381_a();
   }
   ...
   class StatsBlock extends GuiStats.Stats {
      ...
      public StatsBlock() {
         ...
         while(var2.hasNext()) {
            ...
            if(GuiStats.this.field_146546_t.func_77444_a(var3) > 0) {
               var4 = true;
            } else if(StatList.field_75929_E[var5] != null && GuiStats.this.field_146546_t.func_77444_a(StatList.field_75929_E[var5]) > 0) {
               var4 = true;
            } else if(StatList.field_75928_D[var5] != null && GuiStats.this.field_146546_t.func_77444_a(StatList.field_75928_D[var5]) > 0) {
               var4 = true;
            }
         ...
         this.field_148216_n = new Comparator() {
            ...
            public int compare(StatCrafting p_148339_1_, StatCrafting p_148339_2_) {
               int var3 = Item.func_150891_b(p_148339_1_.func_150959_a());
               int var4 = Item.func_150891_b(p_148339_2_.func_150959_a());
               StatBase var5 = null;
               StatBase var6 = null;
      ...
      protected void func_148126_a(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_, Tessellator p_148126_5_, int p_148126_6_, int p_148126_7_) {
         ...
         this.func_148209_a(StatList.field_75928_D[var10], p_148126_2_ + 115, p_148126_3_, p_148126_1_ % 2 == 0);
         this.func_148209_a(StatList.field_75929_E[var10], p_148126_2_ + 165, p_148126_3_, p_148126_1_ % 2 == 0);
   ...
   abstract class Stats extends GuiSlot {
         ...
         if(p_148142_2_ >= this.field_148153_b && p_148142_2_ <= this.field_148154_c) {
            ...
            if(var3 >= 0) {
               ...
               if(var9.length() > 0) {
                  ...
                  GuiStats.this.field_146289_q.func_78261_a(var9, var6, var7, -1);
               }
            }
      ...
      protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_) {
         if(p_148213_1_ != null) {
            ...
            String var5 = ("" + I18n.func_135052_a(var4.func_77658_a() + ".name", new Object[0])).trim();
            if(var5.length() > 0) {
               int var6 = p_148213_2_ + 12;
               int var7 = p_148213_3_ - 12;
               int var8 = GuiStats.this.field_146289_q.func_78256_a(var5);
               GuiStats.this.func_73733_a(var6 - 3, var7 - 3, var6 + var8 + 3, var7 + 8 + 3, -1073741824, -1073741824);
               GuiStats.this.field_146289_q.func_78261_a(var5, var6, var7, -1);
            }
   ...
   class StatsMobsList extends GuiSlot {
      ...
      public StatsMobsList() {
         ...
         this.func_148130_a(false);
         Iterator var2 = EntityList.field_75627_a.values().iterator();

         while(var2.hasNext()) {
            EntityList.EntityEggInfo var3 = (EntityList.EntityEggInfo)var2.next();
            if(GuiStats.this.field_146546_t.func_77444_a(var3.field_151512_d) > 0 || GuiStats.this.field_146546_t.func_77444_a(var3.field_151513_e) > 0) {
      ...
      protected void func_148126_a(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_, Tessellator p_148126_5_, int p_148126_6_, int p_148126_7_) {
         ...
         String var9 = I18n.func_135052_a("entity." + EntityList.func_75617_a(var8.field_75613_a) + ".name", new Object[0]);
         int var10 = GuiStats.this.field_146546_t.func_77444_a(var8.field_151512_d);
         int var11 = GuiStats.this.field_146546_t.func_77444_a(var8.field_151513_e);
         String var12 = I18n.func_135052_a("stat.entityKills", new Object[]{Integer.valueOf(var10), var9});
         String var13 = I18n.func_135052_a("stat.entityKilledBy", new Object[]{var9, Integer.valueOf(var11)});
         if(var10 == 0) {
            var12 = I18n.func_135052_a("stat.entityKills.none", new Object[]{var9});
         }

         if(var11 == 0) {
            var13 = I18n.func_135052_a("stat.entityKilledBy.none", new Object[]{var9});
         }

         GuiStats.this.func_73731_b(GuiStats.this.field_146289_q, var9, p_148126_2_ + 2 - 10, p_148126_3_ + 1, 16777215);
         GuiStats.this.func_73731_b(GuiStats.this.field_146289_q, var12, p_148126_2_ + 2, p_148126_3_ + 1 + GuiStats.this.field_146289_q.field_78288_b, var10 == 0?6316128:9474192);
         GuiStats.this.func_73731_b(GuiStats.this.field_146289_q, var13, p_148126_2_ + 2, p_148126_3_ + 1 + GuiStats.this.field_146289_q.field_78288_b * 2, var11 == 0?6316128:9474192);
      }
   }
   ...
   class StatsItem extends GuiStats.Stats {
      ...
      public StatsItem() {
         ...
         while(var2.hasNext()) {
            ...
            if(GuiStats.this.field_146546_t.func_77444_a(var3) > 0) {
               var4 = true;
            } else if(StatList.field_75930_F[var5] != null && GuiStats.this.field_146546_t.func_77444_a(StatList.field_75930_F[var5]) > 0) {
               var4 = true;
            } else if(StatList.field_75928_D[var5] != null && GuiStats.this.field_146546_t.func_77444_a(StatList.field_75928_D[var5]) > 0) {
               var4 = true;
            }
         ...
         this.field_148216_n = new Comparator() {
            ...
            public int compare(StatCrafting p_148342_1_, StatCrafting p_148342_2_) {
               int var3 = Item.func_150891_b(p_148342_1_.func_150959_a());
               int var4 = Item.func_150891_b(p_148342_2_.func_150959_a());
               StatBase var5 = null;
               StatBase var6 = null;
      ...
      protected void func_148126_a(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_, Tessellator p_148126_5_, int p_148126_6_, int p_148126_7_) {
         ...
         GuiStats.this.func_146521_a(p_148126_2_ + 40, p_148126_3_, var9);
         int var10 = Item.func_150891_b(var9);
         this.func_148209_a(StatList.field_75930_F[var10], p_148126_2_ + 115, p_148126_3_, p_148126_1_ % 2 == 0);
         this.func_148209_a(StatList.field_75928_D[var10], p_148126_2_ + 165, p_148126_3_, p_148126_1_ % 2 == 0);
         this.func_148209_a(var8, p_148126_2_ + 215, p_148126_3_, p_148126_1_ % 2 == 0);
      }
   ...
   class StatsGeneral extends GuiSlot {
      ...
      protected void func_148126_a(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_, Tessellator p_148126_5_, int p_148126_6_, int p_148126_7_) {
         StatBase var8 = (StatBase)StatList.field_75941_c.get(p_148126_1_);
         GuiStats.this.func_73731_b(GuiStats.this.field_146289_q, var8.func_150951_e().func_150260_c(), p_148126_2_ + 2, p_148126_3_ + 1, p_148126_1_ % 2 == 0?16777215:9474192);
         String var9 = var8.func_75968_a(GuiStats.this.field_146546_t.func_77444_a(var8));
         GuiStats.this.func_73731_b(GuiStats.this.field_146289_q, var9, p_148126_2_ + 2 + 213 - GuiStats.this.field_146289_q.func_78256_a(var9), p_148126_3_ + 1, p_148126_1_ % 2 == 0?16777215:9474192);
      }
   }
}
