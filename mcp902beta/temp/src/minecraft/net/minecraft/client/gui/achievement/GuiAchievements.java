...
public class GuiAchievements extends GuiScreen implements IProgressMeter {
   ...
   protected void func_146553_h() {
      ...
      this.field_146289_q.func_78276_b("Achievements", var1 + 15, var2 + 5, 4210752);
   }
   ...
   protected void func_146552_b(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
      ...
      for(var22 = 0; var22 < AchievementList.field_76007_e.size(); ++var22) {
         ...
         if(var35.field_75992_c != null) {
            ...
            var42 = var35.field_75992_c.field_75993_a * 24 - var4 + 11;
            ...
            if(var30 <= 4) {
               ...
               this.func_73730_a(var24, var42, var25, var31);
               this.func_73728_b(var42, var25, var27, var31);
               if(var24 > var42) {
      ...
      int var41;
      int var43;
      for(var42 = 0; var42 < AchievementList.field_76007_e.size(); ++var42) {
         Achievement var39 = (Achievement)AchievementList.field_76007_e.get(var42);
         var41 = var39.field_75993_a * 24 - var4;
         var43 = var39.field_75991_b * 24 - var5;
         if(var41 >= -24 && var43 >= -24 && (float)var41 <= 224.0F * this.field_146570_r && (float)var43 <= 155.0F * this.field_146570_r) {
            ...
            float var45;
            if(this.field_146556_E.func_77443_a(var39)) {
               var45 = 0.75F;
               GL11.glColor4f(var45, var45, var45, 1.0F);
            } else if(this.field_146556_E.func_77442_b(var39)) {
               var45 = 1.0F;
               GL11.glColor4f(var45, var45, var45, 1.0F);
            } else if(var30 < 3) {
               var45 = 0.3F;
            ...
            this.field_146297_k.func_110434_K().func_110577_a(field_146561_C);
            if(var39.func_75984_f()) {
               this.func_73729_b(var41 - 2, var43 - 2, 26, 202, 26, 26);
            } else {
               this.func_73729_b(var41 - 2, var43 - 2, 0, 202, 26, 26);
            }

            if(!this.field_146556_E.func_77442_b(var39)) {
               var45 = 0.1F;
               GL11.glColor4f(var45, var45, var45, 1.0F);
            ...
            GL11.glEnable(2896);
            GL11.glEnable(2884);
            var36.func_82406_b(this.field_146297_k.field_71466_p, this.field_146297_k.func_110434_K(), var39.field_75990_d, var41 + 3, var43 + 3);
      ...
      if(var34 != null) {
         String var44 = var34.func_150951_e().func_150260_c();
         String var40 = var34.func_75989_e();
         ...
         if(!this.field_146556_E.func_77442_b(var34)) {
            ...
            int var33;
            if(var30 == 3) {
               var44 = I18n.func_135052_a("achievement.unknown", new Object[0]);
               var31 = Math.max(this.field_146289_q.func_78256_a(var44), 120);
               ...
               this.func_73733_a(var41 - 3, var43 - 3, var41 + var31 + 3, var43 + var33 + 12 + 3, -1073741824, -1073741824);
               this.field_146289_q.func_78279_b(var32, var41, var43 + 12, var31, -9416624);
            } else if(var30 < 3) {
               var31 = Math.max(this.field_146289_q.func_78256_a(var44), 120);
               var32 = (new ChatComponentTranslation("achievement.requires", new Object[]{var34.field_75992_c.func_150951_e()})).func_150260_c();
               var33 = this.field_146289_q.func_78267_b(var32, var31);
            ...
            var31 = Math.max(this.field_146289_q.func_78256_a(var44), 120);
            int var46 = this.field_146289_q.func_78267_b(var40, var31);
            if(this.field_146556_E.func_77443_a(var34)) {
               var46 += 12;
            }

            this.func_73733_a(var41 - 3, var43 - 3, var41 + var31 + 3, var43 + var46 + 3 + 12, -1073741824, -1073741824);
            this.field_146289_q.func_78279_b(var40, var41, var43 + 12, var31, -6250336);
            if(this.field_146556_E.func_77443_a(var34)) {
               this.field_146289_q.func_78261_a(I18n.func_135052_a("achievement.taken", new Object[0]), var41, var43 + var46 + 4, -7302913);
            }
         }

         if(var44 != null) {
            this.field_146289_q.func_78261_a(var44, var41, var43, this.field_146556_E.func_77442_b(var34)?(var34.func_75984_f()?-128:-1):(var34.func_75984_f()?-8355776:-8355712));
         }
      }
