...
public class GuiLanguage extends GuiScreen {
   ...
   class List extends GuiSlot {
      ...
      public List() {
         ...
         Iterator var2 = GuiLanguage.this.field_146454_h.func_135040_d().iterator();
      ...
      protected void func_148126_a(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_, Tessellator p_148126_5_, int p_148126_6_, int p_148126_7_) {
         ...
         GuiLanguage.this.func_73732_a(GuiLanguage.this.field_146289_q, ((Language)this.field_148177_m.get(this.field_148176_l.get(p_148126_1_))).toString(), this.field_148155_a / 2, p_148126_3_ + 1, 16777215);
