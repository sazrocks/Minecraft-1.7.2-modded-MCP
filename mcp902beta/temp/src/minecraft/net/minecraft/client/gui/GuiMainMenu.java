...
public class GuiMainMenu extends GuiScreen {
      ...
      if(this.field_96141_q) {
         if(!field_96140_r) {
            ...
            (new Thread("MCO Availability Checker #" + field_146973_f.incrementAndGet()) {
               ...
               public void run() {
                  Session var1 = GuiMainMenu.this.field_146297_k.func_110432_I();
   ...
   protected void func_146284_a(GuiButton p_146284_1_) {
      ...
      if(p_146284_1_.field_146127_k == 14 && this.field_130023_H.field_146125_m) {
         this.func_140005_i();
      }
      ...
      if(p_146284_1_.field_146127_k == 12) {
         ...
         if(var3 != null) {
            GuiYesNo var4 = GuiSelectWorld.func_146623_a(this, var3.func_76065_j(), 12);
