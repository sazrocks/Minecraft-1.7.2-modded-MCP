...
public class GuiScreenDisconnectedOnline extends GuiScreen {
   ...
   public GuiScreenDisconnectedOnline(GuiScreen p_i45037_1_, String p_i45037_2_, IChatComponent p_i45037_3_) {
      ...
      this.field_146867_a = I18n.func_135052_a(p_i45037_2_, new Object[0]);
   ...
   public void func_73866_w_() {
      ...
      this.field_146292_n.add(new GuiButton(0, this.field_146294_l / 2 - 100, this.field_146295_m / 4 + 120 + 12, I18n.func_135052_a("gui.back", new Object[0])));
      this.field_146866_g = this.field_146289_q.func_78271_c(this.field_146865_f.func_150254_d(), this.field_146294_l - 50);
   }
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      this.func_146276_q_();
      this.func_73732_a(this.field_146289_q, this.field_146867_a, this.field_146294_l / 2, this.field_146295_m / 2 - 50, 11184810);
      int var4 = this.field_146295_m / 2 - 30;
      if(this.field_146866_g != null) {
         for(Iterator var5 = this.field_146866_g.iterator(); var5.hasNext(); var4 += this.field_146289_q.field_78288_b) {
