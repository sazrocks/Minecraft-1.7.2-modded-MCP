   ...
   public void func_73830_a(float p_73830_1_, boolean p_73830_2_, int p_73830_3_, int p_73830_4_) {
      ...
      if(this.field_73839_d.func_71355_q()) {
         ...
         if(this.field_73839_d.field_71441_e.func_82737_E() >= 120500L) {
            var36 = I18n.func_135052_a("demo.demoExpired", new Object[0]);
         } else {
      ...
      if(this.field_73839_d.field_71474_y.field_74330_P) {
         ...
         GL11.glPushMatrix();
         var8.func_78261_a("Minecraft 1.7.2 (" + this.field_73839_d.field_71426_K + ")", 2, 2, 16777215);
         ...
         if(this.field_73839_d.field_71460_t != null && this.field_73839_d.field_71460_t.func_147702_a()) {
            this.func_73731_b(var8, String.format("shader: %s", new Object[]{this.field_73839_d.field_71460_t.func_147706_e().func_148022_b()}), 2, 112, 14737632);
         }
      ...
      if(this.field_73839_d.field_71474_y.field_74321_H.func_151470_d() && (!this.field_73839_d.func_71387_A() || this.field_73839_d.field_71439_g.field_71174_a.field_147303_b.size() > 1 || var40 != null)) {
         this.field_73839_d.field_71424_I.func_76320_a("playerList");
         NetHandlerPlayClient var42 = this.field_73839_d.field_71439_g.field_71174_a;
         List var44 = var42.field_147303_b;
         var15 = var42.field_147304_c;
         var16 = var15;
