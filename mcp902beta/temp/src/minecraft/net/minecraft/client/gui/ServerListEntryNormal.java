...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
   ...
   public void func_148279_a(int p_148279_1_, int p_148279_2_, int p_148279_3_, int p_148279_4_, int p_148279_5_, Tessellator p_148279_6_, int p_148279_7_, int p_148279_8_, boolean p_148279_9_) {
      ...
      List var13 = this.field_148300_d.field_71466_p.func_78271_c(this.field_148301_e.field_78843_d, p_148279_4_ - 32 - 2);

      for(int var14 = 0; var14 < Math.min(var13.size(), 2); ++var14) {
         this.field_148300_d.field_71466_p.func_78276_b((String)var13.get(var14), p_148279_2_ + 32 + 3, p_148279_3_ + 12 + this.field_148300_d.field_71466_p.field_78288_b * var14, 8421504);
      }
      ...
      this.field_148300_d.field_71466_p.func_78276_b(var22, p_148279_2_ + p_148279_4_ - var15 - 15 - 2, p_148279_3_ + 1, 8421504);
      byte var16 = 0;
      String var18 = null;
      int var17;
      String var19;
      if(var12) {
         ...
         var16 = 1;
         var17 = (int)(Minecraft.func_71386_F() / 100L + (long)(p_148279_1_ * 2) & 7L);
         if(var17 > 4) {
            var17 = 8 - var17;
         }
