...
public class GuiNewChat extends Gui {
   ...
   public IChatComponent func_146236_a(int p_146236_1_, int p_146236_2_) {
      if(!this.func_146241_e()) {
         ...
         ScaledResolution var3 = new ScaledResolution(this.field_146247_f.field_71474_y, this.field_146247_f.field_71443_c, this.field_146247_f.field_71440_d);
   ...
   public void func_146242_c(int p_146242_1_) {
      ...
      do {
         if(!var2.hasNext()) {
            ...
            } while(var3.func_74539_c() != p_146242_1_);
