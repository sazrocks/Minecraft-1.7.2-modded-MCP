...
public class GuiScreenPendingInvitation extends GuiScreen {
   ...
   public GuiScreenPendingInvitation(GuiScreen p_i1129_1_) {
      this.field_146730_g = p_i1129_1_;
   }
   ...
   public void func_73866_w_() {
      ...
      (new Thread("MCO List Invites #" + field_146732_a.incrementAndGet()) {
         ...
         public void run() {
            Session var1 = GuiScreenPendingInvitation.this.field_146297_k.func_110432_I();
   ...
   private void func_146728_h() {
      this.field_146292_n.add(new GuiButton(1, this.field_146294_l / 2 - 154, this.field_146295_m - 52, 153, 20, I18n.func_135052_a("mco.invites.button.accept", new Object[0])));
      this.field_146292_n.add(new GuiButton(2, this.field_146294_l / 2 + 6, this.field_146295_m - 52, 153, 20, I18n.func_135052_a("mco.invites.button.reject", new Object[0])));
      this.field_146292_n.add(new GuiButton(0, this.field_146294_l / 2 - 75, this.field_146295_m - 28, 153, 20, I18n.func_135052_a("gui.back", new Object[0])));
   }
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      this.func_146276_q_();
      this.field_146733_h.func_148350_a(p_73863_1_, p_73863_2_, p_73863_3_);
      this.func_73732_a(this.field_146289_q, I18n.func_135052_a("mco.invites.title", new Object[0]), this.field_146294_l / 2, 20, 16777215);
   ...
   class List extends GuiScreenSelectLocation {
      ...
      private void func_148382_b(int p_148382_1_, int p_148382_2_, int p_148382_3_, int p_148382_4_, Tessellator p_148382_5_) {
         ...
         GuiScreenPendingInvitation.this.func_73731_b(GuiScreenPendingInvitation.this.field_146289_q, var6.field_148774_b, p_148382_2_ + 2, p_148382_3_ + 1, 16777215);
         GuiScreenPendingInvitation.this.func_73731_b(GuiScreenPendingInvitation.this.field_146289_q, var6.field_148775_c, p_148382_2_ + 2, p_148382_3_ + 12, 7105644);
      }
   }
}
