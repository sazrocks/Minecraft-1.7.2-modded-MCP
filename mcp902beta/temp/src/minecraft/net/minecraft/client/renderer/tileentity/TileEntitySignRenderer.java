...
public class TileEntitySignRenderer extends TileEntitySpecialRenderer {
   ...
   public void func_147500_a(TileEntitySign p_147512_1_, double p_147512_2_, double p_147512_4_, double p_147512_6_, float p_147512_8_) {
      Block var9 = p_147512_1_.func_145838_q();
      GL11.glPushMatrix();
      ...
      if(var9 == Blocks.field_150472_an) {
         ...
         float var11 = (float)(p_147512_1_.func_145832_p() * 360) / 16.0F;
         GL11.glRotatef(-var11, 0.0F, 1.0F, 0.0F);
         this.field_147514_c.field_78165_b.field_78806_j = true;
      } else {
         int var16 = p_147512_1_.func_145832_p();
         var12 = 0.0F;
         if(var16 == 2) {
            var12 = 180.0F;
         }
      ...
      for(int var14 = 0; var14 < p_147512_1_.field_145915_a.length; ++var14) {
         ...
         if(var14 == p_147512_1_.field_145918_i) {
            var15 = "> " + var15 + " <";
            var17.func_78276_b(var15, -var17.func_78256_a(var15) / 2, var14 * 10 - p_147512_1_.field_145915_a.length * 5, var13);
         } else {
            var17.func_78276_b(var15, -var17.func_78256_a(var15) / 2, var14 * 10 - p_147512_1_.field_145915_a.length * 5, var13);
         }
      }
