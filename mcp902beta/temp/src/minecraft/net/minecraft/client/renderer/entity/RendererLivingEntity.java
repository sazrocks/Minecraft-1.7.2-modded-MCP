...
public abstract class RendererLivingEntity extends Render {
   ...
   protected void func_85093_e(EntityLivingBase p_85093_1_, float p_85093_2_) {
      ...
      if(var3 > 0) {
         ...
         Random var5 = new Random((long)p_85093_1_.func_145782_y());
         ...
         for(int var6 = 0; var6 < var3; ++var6) {
            ...
            double var20 = 0.0D;
            float var22 = 0.0F;
            this.field_76990_c.func_147940_a(var4, var16, var18, var20, var22, p_85093_2_);
            GL11.glPopMatrix();
         }
   ...
   protected void func_77033_b(EntityLivingBase p_77033_1_, double p_77033_2_, double p_77033_4_, double p_77033_6_) {
      ...
      if(this.func_110813_b(p_77033_1_)) {
         ...
         if(var10 < (double)(var12 * var12)) {
            String var13 = p_77033_1_.func_145748_c_().func_150254_d();
