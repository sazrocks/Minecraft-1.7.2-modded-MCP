...
public class RenderBiped extends RenderLiving {
   ...
   public void func_76986_a(EntityLiving p_77031_1_, double p_77031_2_, double p_77031_4_, double p_77031_6_, float p_77031_8_, float p_77031_9_) {
      GL11.glColor3f(1.0F, 1.0F, 1.0F);
      ItemStack var10 = p_77031_1_.func_70694_bm();
      this.func_82420_a(p_77031_1_, var10);
      double var11 = p_77031_4_ - (double)p_77031_1_.field_70129_M;
      if(p_77031_1_.func_70093_af()) {
         var11 -= 0.125D;
      }

      super.func_76986_a(p_77031_1_, p_77031_2_, var11, p_77031_6_, p_77031_8_, p_77031_9_);
   ...
   protected void func_77029_c(EntityLiving p_130005_1_, float p_130005_2_) {
      ...
      ItemStack var3 = p_130005_1_.func_70694_bm();
      ItemStack var4 = p_130005_1_.func_130225_q(3);
      Item var5;
      float var6;
      if(var4 != null) {
         GL11.glPushMatrix();
         ...
         if(var5 instanceof ItemBlock) {
            ...
            GL11.glScalef(var6, -var6, -var6);
            String var7 = "";
            if(var4.func_77942_o() && var4.func_77978_p().func_150297_b("SkullOwner", 8)) {
               var7 = var4.func_77978_p().func_74779_i("SkullOwner");
            }

            TileEntitySkullRenderer.field_147536_b.func_147530_a(-0.5F, 0.0F, -0.5F, 1, 180.0F, var4.func_77960_j(), var7);
         }
      ...
      if(var3 != null && var3.func_77973_b() != null) {
         ...
         if(var3.func_77973_b().func_77623_v()) {
            for(var13 = 0; var13 <= 1; ++var13) {
               int var11 = var3.func_77973_b().func_82790_a(var3, var13);
               ...
               this.field_76990_c.field_78721_f.func_78443_a(p_130005_1_, var3, var13);
            }
         } else {
            var13 = var3.func_77973_b().func_82790_a(var3, 0);
            ...
            this.field_76990_c.field_78721_f.func_78443_a(p_130005_1_, var3, 0);
         }
