...
public class RenderPlayer extends RendererLivingEntity {
   ...
   protected int func_77032_a(AbstractClientPlayer p_77107_1_, int p_77107_2_, float p_77107_3_) {
   ...
   protected void func_82408_c(AbstractClientPlayer p_130220_1_, int p_130220_2_, float p_130220_3_) {
   ...
   public void func_76986_a(AbstractClientPlayer p_130009_1_, double p_130009_2_, double p_130009_4_, double p_130009_6_, float p_130009_8_, float p_130009_9_) {
      ...
      double var13 = p_130009_4_ - (double)p_130009_1_.field_70129_M;
      if(p_130009_1_.func_70093_af() && !(p_130009_1_ instanceof EntityPlayerSP)) {
         var13 -= 0.125D;
      }

      super.func_76986_a((EntityLivingBase)p_130009_1_, p_130009_2_, var13, p_130009_6_, p_130009_8_, p_130009_9_);
   ...
   protected void func_77029_c(AbstractClientPlayer p_77100_1_, float p_77100_2_) {
      ...
      if(var3 != null) {
         ...
         if(var3.func_77973_b() instanceof ItemBlock) {
            ...
            GL11.glScalef(var4, -var4, -var4);
            String var5 = "";
            if(var3.func_77942_o() && var3.func_77978_p().func_150297_b("SkullOwner", 8)) {
               var5 = var3.func_77978_p().func_74779_i("SkullOwner");
            }

            TileEntitySkullRenderer.field_147536_b.func_147530_a(-0.5F, 0.0F, -0.5F, 1, 180.0F, var3.func_77960_j(), var5);
         }
      ...
      if(p_77100_1_.func_70005_c_().equals("deadmau5") && p_77100_1_.func_110309_l().func_110557_a()) {
         ...
         for(int var20 = 0; var20 < 2; ++var20) {
            float var22 = p_77100_1_.field_70126_B + (p_77100_1_.field_70177_z - p_77100_1_.field_70126_B) * p_77100_2_ - (p_77100_1_.field_70760_ar + (p_77100_1_.field_70761_aq - p_77100_1_.field_70760_ar) * p_77100_2_);
            float var6 = p_77100_1_.field_70127_C + (p_77100_1_.field_70125_A - p_77100_1_.field_70127_C) * p_77100_2_;
            GL11.glPushMatrix();
      ...
      boolean var21 = p_77100_1_.func_110310_o().func_110557_a();
      float var11;
      if(var21 && !p_77100_1_.func_82150_aj() && !p_77100_1_.func_82238_cc()) {
         this.func_110776_a(p_77100_1_.func_110303_q());
         GL11.glPushMatrix();
         GL11.glTranslatef(0.0F, 0.0F, 0.125F);
         double var23 = p_77100_1_.field_71091_bM + (p_77100_1_.field_71094_bP - p_77100_1_.field_71091_bM) * (double)p_77100_2_ - (p_77100_1_.field_70169_q + (p_77100_1_.field_70165_t - p_77100_1_.field_70169_q) * (double)p_77100_2_);
         double var26 = p_77100_1_.field_71096_bN + (p_77100_1_.field_71095_bQ - p_77100_1_.field_71096_bN) * (double)p_77100_2_ - (p_77100_1_.field_70167_r + (p_77100_1_.field_70163_u - p_77100_1_.field_70167_r) * (double)p_77100_2_);
      ...
      ItemStack var25 = p_77100_1_.field_71071_by.func_70448_g();
      if(var25 != null) {
         GL11.glPushMatrix();
         ...
         if(var25.func_77973_b() instanceof ItemBlock && RenderBlocks.func_147739_a(Block.func_149634_a(var25.func_77973_b()).func_149645_b())) {
            ...
            if(p_77100_1_.func_71052_bv() > 0 && var24 == EnumAction.block) {
         ...
         if(var25.func_77973_b().func_77623_v()) {
            for(var28 = 0; var28 <= 1; ++var28) {
               int var8 = var25.func_77973_b().func_82790_a(var25, var28);
               ...
               this.field_76990_c.field_78721_f.func_78443_a(p_77100_1_, var25, var28);
            }
         } else {
            var28 = var25.func_77973_b().func_82790_a(var25, 0);
            ...
            this.field_76990_c.field_78721_f.func_78443_a(p_77100_1_, var25, 0);
         }
   ...
   protected void func_96449_a(AbstractClientPlayer p_96450_1_, double p_96450_2_, double p_96450_4_, double p_96450_6_, String p_96450_8_, float p_96450_9_, double p_96450_10_) {
      if(p_96450_10_ < 100.0D) {
         Scoreboard var12 = p_96450_1_.func_96123_co();
         ScoreObjective var13 = var12.func_96539_a(2);
         if(var13 != null) {
            Score var14 = var12.func_96529_a(p_96450_1_.func_70005_c_(), var13);
            if(p_96450_1_.func_70608_bn()) {
               this.func_147906_a(p_96450_1_, var14.func_96652_c() + " " + var13.func_96678_d(), p_96450_2_, p_96450_4_ - 1.5D, p_96450_6_, 64);
            } else {
               this.func_147906_a(p_96450_1_, var14.func_96652_c() + " " + var13.func_96678_d(), p_96450_2_, p_96450_4_, p_96450_6_, 64);
            }
   ...
   protected void func_77039_a(AbstractClientPlayer p_77105_1_, double p_77105_2_, double p_77105_4_, double p_77105_6_) {
   ...
   protected void func_77043_a(AbstractClientPlayer p_77102_1_, float p_77102_2_, float p_77102_3_, float p_77102_4_) {
   ...
   public void func_76986_a(EntityLivingBase p_130000_1_, double p_130000_2_, double p_130000_4_, double p_130000_6_, float p_130000_8_, float p_130000_9_) {
      this.func_76986_a((AbstractClientPlayer)p_130000_1_, p_130000_2_, p_130000_4_, p_130000_6_, p_130000_8_, p_130000_9_);
   }
