...
public class RenderEnderman extends RenderLiving {
   ...
   public void func_76986_a(EntityEnderman p_77075_1_, double p_77075_2_, double p_77075_4_, double p_77075_6_, float p_77075_8_, float p_77075_9_) {
      this.field_77078_a.field_78126_a = p_77075_1_.func_146080_bZ().func_149688_o() != Material.field_151579_a;
      ...
      super.func_76986_a((EntityLiving)p_77075_1_, p_77075_2_, p_77075_4_, p_77075_6_, p_77075_8_, p_77075_9_);
   }

   protected ResourceLocation func_110775_a(EntityEnderman p_110838_1_) {
      return field_110839_f;
   }

   protected void func_77029_c(EntityEnderman p_77076_1_, float p_77076_2_) {
      super.func_77029_c(p_77076_1_, p_77076_2_);
      if(p_77076_1_.func_146080_bZ().func_149688_o() != Material.field_151579_a) {
         GL11.glEnable('\u803a');
         GL11.glPushMatrix();
         float var3 = 0.5F;
         ...
         this.field_147909_c.func_147800_a(p_77076_1_.func_146080_bZ(), p_77076_1_.func_70824_q(), 1.0F);
         GL11.glPopMatrix();
         GL11.glDisable('\u803a');
      }
   ...
   protected int func_77032_a(EntityEnderman p_77074_1_, int p_77074_2_, float p_77074_3_) {
      if(p_77074_2_ != 0) {
         return -1;
      } else {
   ...
   public void func_76986_a(EntityLiving p_77031_1_, double p_77031_2_, double p_77031_4_, double p_77031_6_, float p_77031_8_, float p_77031_9_) {
      this.func_76986_a((EntityEnderman)p_77031_1_, p_77031_2_, p_77031_4_, p_77031_6_, p_77031_8_, p_77031_9_);
   }
