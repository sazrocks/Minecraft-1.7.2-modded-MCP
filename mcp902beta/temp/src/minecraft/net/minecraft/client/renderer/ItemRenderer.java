   ...
   public void func_78440_a(float p_78440_1_) {
      ...
      if(var8 != null && var8.func_77973_b() == Items.field_151098_aY) {
         ...
         for(int var24 = 0; var24 < 2; ++var24) {
            ...
            var29.func_82441_a(this.field_78455_a.field_71439_g);
            GL11.glPopMatrix();
         }
         ...
         var30.func_78382_b();
         byte var31 = 7;
         var30.func_78374_a((double)(0 - var31), (double)(128 + var31), 0.0D, 0.0D, 1.0D);
         var30.func_78374_a((double)(128 + var31), (double)(128 + var31), 0.0D, 1.0D, 1.0D);
         var30.func_78374_a((double)(128 + var31), (double)(0 - var31), 0.0D, 1.0D, 0.0D);
         var30.func_78374_a((double)(0 - var31), (double)(0 - var31), 0.0D, 0.0D, 0.0D);
         var30.func_78381_a();
         ...
         if(var8.func_77973_b().func_77623_v()) {
            ...
            int var28 = var8.func_77973_b().func_82790_a(var8, 1);
