...
public class RenderZombie extends RenderBiped {
   ...
   protected int func_77032_a(EntityZombie p_82429_1_, int p_82429_2_, float p_82429_3_) {
      this.func_82427_a(p_82429_1_);
      return super.func_77032_a((EntityLiving)p_82429_1_, p_82429_2_, p_82429_3_);
   }

   public void func_76986_a(EntityZombie p_82426_1_, double p_82426_2_, double p_82426_4_, double p_82426_6_, float p_82426_8_, float p_82426_9_) {
      this.func_82427_a(p_82426_1_);
      super.func_76986_a((EntityLiving)p_82426_1_, p_82426_2_, p_82426_4_, p_82426_6_, p_82426_8_, p_82426_9_);
   }

   protected ResourceLocation func_110775_a(EntityZombie p_110863_1_) {
      return p_110863_1_ instanceof EntityPigZombie?field_110866_o:(p_110863_1_.func_82231_m()?field_110864_q:field_110865_p);
   }

   protected void func_77029_c(EntityZombie p_82428_1_, float p_82428_2_) {
      this.func_82427_a(p_82428_1_);
      super.func_77029_c((EntityLiving)p_82428_1_, p_82428_2_);
   }
   ...
   protected void func_77043_a(EntityZombie p_82430_1_, float p_82430_2_, float p_82430_3_, float p_82430_4_) {
   ...
   // $FF: synthetic method
   // $FF: bridge method
   protected void func_77029_c(EntityLiving p_130005_1_, float p_130005_2_) {
      this.func_77029_c((EntityZombie)p_130005_1_, p_130005_2_);
   }

   // $FF: synthetic method
   // $FF: bridge method
   protected ResourceLocation func_110775_a(EntityLiving p_110856_1_) {
      return this.func_110775_a((EntityZombie)p_110856_1_);
   }

   // $FF: synthetic method
   // $FF: bridge method
   public void func_76986_a(EntityLiving p_77031_1_, double p_77031_2_, double p_77031_4_, double p_77031_6_, float p_77031_8_, float p_77031_9_) {
      this.func_76986_a((EntityZombie)p_77031_1_, p_77031_2_, p_77031_4_, p_77031_6_, p_77031_8_, p_77031_9_);
   }

   // $FF: synthetic method
   // $FF: bridge method
   protected int func_77032_a(EntityLiving p_130006_1_, int p_130006_2_, float p_130006_3_) {
      return this.func_77032_a((EntityZombie)p_130006_1_, p_130006_2_, p_130006_3_);
   }
