...
public class EntityRenderer implements IResourceManagerReloadListener {
      ...
      if(OpenGlHelper.field_148824_g) {
         ...
         if(this.field_147713_ae != field_147708_e) {
            try {
               ...
               this.field_147707_d = new ShaderGroup(this.field_147711_ac, this.field_78531_r.func_147110_a(), field_147712_ad[this.field_147713_ae]);
   ...
   public void func_110549_a(IResourceManager p_110549_1_) {
      ...
      if(this.field_147713_ae != field_147708_e) {
         try {
            this.field_147707_d = new ShaderGroup(p_110549_1_, this.field_78531_r.func_147110_a(), field_147712_ad[this.field_147713_ae]);
            this.field_147707_d.func_148026_a(this.field_78531_r.field_71443_c, this.field_78531_r.field_71440_d);
   ...
   public void func_78464_a() {
      ...
      var2 = (float)(this.field_78531_r.field_71474_y.field_151451_c / 16);
   ...
   public void func_78473_a(float p_78473_1_) {
      if(this.field_78531_r.field_71451_h != null) {
         if(this.field_78531_r.field_71441_e != null) {
            ...
            Vec3 var9 = null;
            float var10 = 1.0F;
            List var11 = this.field_78531_r.field_71441_e.func_72839_b(this.field_78531_r.field_71451_h, this.field_78531_r.field_71451_h.field_70121_D.func_72321_a(var7.field_72450_a * var2, var7.field_72448_b * var2, var7.field_72449_c * var2).func_72314_b((double)var10, (double)var10, (double)var10));
            double var12 = var4;
   ...
   private float func_78481_a(float p_78481_1_, boolean p_78481_2_) {
      if(this.field_78532_q > 0) {
         ...
         Block var6 = ActiveRenderInfo.func_151460_a(this.field_78531_r.field_71441_e, var3, p_78481_1_);
   ...
   private void func_78467_g(float p_78467_1_) {
      ...
      if(var2.func_70608_bn()) {
         ...
         if(!this.field_78531_r.field_71474_y.field_74325_U) {
            Block var10 = this.field_78531_r.field_71441_e.func_147439_a(MathHelper.func_76128_c(var2.field_70165_t), MathHelper.func_76128_c(var2.field_70163_u), MathHelper.func_76128_c(var2.field_70161_v));
   ...
   public void func_78480_b(float p_78480_1_) {
      ...
      if(!this.field_78531_r.field_71454_w) {
         ...
         final ScaledResolution var13 = new ScaledResolution(this.field_78531_r.field_71474_y, this.field_78531_r.field_71443_c, this.field_78531_r.field_71440_d);
   ...
   public void func_78471_a(float p_78471_1_, long p_78471_2_) {
      ...
      for(int var13 = 0; var13 < 2; ++var13) {
         ...
         if(this.field_78532_q == 0) {
            ...
            var5.func_147589_a(var4, var14, p_78471_1_);
            ...
            GL11.glPopMatrix();
            GL11.glPushMatrix();
            if(this.field_78531_r.field_71476_x != null && var4.func_70055_a(Material.field_151586_h) && var4 instanceof EntityPlayer && !this.field_78531_r.field_71474_y.field_74319_N) {
         ...
         GL11.glMatrixMode(5888);
         GL11.glPopMatrix();
         if(this.field_78503_V == 1.0D && var4 instanceof EntityPlayer && !this.field_78531_r.field_71474_y.field_74319_N && this.field_78531_r.field_71476_x != null && !var4.func_70055_a(Material.field_151586_h)) {
            var17 = (EntityPlayer)var4;
            GL11.glDisable(3008);
            this.field_78531_r.field_71424_I.func_76318_c("outline");
            var5.func_72731_b(var17, this.field_78531_r.field_71476_x, 0, p_78471_1_);
         ...
         for(int var16 = 0; var16 < var15; ++var16) {
            ...
            if(var19 <= var5 + var7 && var19 >= var5 - var7 && var21.func_76738_d() && var21.func_150564_a(var17, var19, var18) >= 0.15F) {
               ...
               if(var20.func_149688_o() == Material.field_151587_i) {
                  this.field_78531_r.field_71452_i.func_78873_a(new EntitySmokeFX(var3, (double)((float)var17 + var22), (double)((float)var19 + 0.1F) - var20.func_149665_z(), (double)((float)var18 + var23), 0.0D, 0.0D, 0.0D));
                  ...
                  this.field_78531_r.field_71452_i.func_78873_a(new EntityRainFX(var3, (double)((float)var17 + var22), (double)((float)var19 + 0.1F) - var20.func_149665_z(), (double)((float)var18 + var23)));
               }
            }
         }
   ...
   private void func_78466_h(float p_78466_1_) {
      ...
      Block var21 = ActiveRenderInfo.func_151460_a(this.field_78531_r.field_71441_e, var3, p_78466_1_);
      float var22;
   ...
   private void func_78468_a(int p_78468_1_, float p_78468_2_) {
      ...
      if(p_78468_1_ == 999) {
         ...
         GL11.glNormal3f(0.0F, -1.0F, 0.0F);
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         Block var5 = ActiveRenderInfo.func_151460_a(this.field_78531_r.field_71441_e, var3, p_78468_2_);
         float var6;
         if(var3.func_70644_a(Potion.field_76440_q)) {
            var6 = 5.0F;
