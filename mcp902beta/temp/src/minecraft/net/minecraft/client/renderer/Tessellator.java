...
public class Tessellator {
   ...
   public TesselatorVertexState func_147564_a(float p_147564_1_, float p_147564_2_, float p_147564_3_) {
      ...
      PriorityQueue var5 = new PriorityQueue(this.field_147569_p, new QuadComparator(this.field_78405_h, p_147564_1_ + (float)this.field_78408_v, p_147564_2_ + (float)this.field_78407_w, p_147564_3_ + (float)this.field_78417_x));
      byte var6 = 32;

      int var7;
      for(var7 = 0; var7 < this.field_147569_p; var7 += var6) {
      ...
      for(var7 = 0; !var5.isEmpty(); var7 += var6) {
         ...
         for(int var9 = 0; var9 < var6; ++var9) {
            var4[var7 + var9] = this.field_78405_h[var8 + var9];
         }
      }

      System.arraycopy(var4, 0, this.field_78405_h, 0, var4.length);
      return new TesselatorVertexState(var4, this.field_147569_p, this.field_78406_i, this.field_78400_o, this.field_78414_p, this.field_78413_q, this.field_78399_n);
   }
