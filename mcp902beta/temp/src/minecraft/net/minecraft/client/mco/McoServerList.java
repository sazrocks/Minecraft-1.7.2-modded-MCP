...
public class McoServerList {
   ...
   public McoServerList() {
      ...
      this.field_148493_i = Minecraft.func_71410_x().func_110432_I();
   }
   ...
   private synchronized void func_148474_a(List p_148474_1_) {
      int var2 = 0;
      Iterator var3 = this.field_148487_e.iterator();
   ...
   class UpdateTask extends TimerTask {
      ...
      private void func_148494_a() {
         try {
            if(McoServerList.this.field_148493_i != null) {
               this.field_148498_b = new McoClient(McoServerList.this.field_148493_i.func_111286_b(), McoServerList.this.field_148493_i.func_111285_a(), "1.7.2", Minecraft.func_71410_x().func_110437_J());
            ...
            McoServerList.field_148490_a.error("Couldn\'t get server list", var2);
      ...
      private void func_148495_b() {
         try {
            ...
            McoServerList.field_148490_a.error("Couldn\'t get pending invite count", var2);
         }
      ...
      private void func_148496_c() {
         try {
            if(McoServerList.this.field_148493_i != null) {
               McoClient var1 = new McoClient(McoServerList.this.field_148493_i.func_111286_b(), McoServerList.this.field_148493_i.func_111285_a(), "1.7.2", Minecraft.func_71410_x().func_110437_J());
               McoServerList.this.field_148491_j = var1.func_148702_d();
            }
         } catch (ExceptionMcoService var2) {
            McoServerList.field_148490_a.error("Couldn\'t get token count", var2);
      ...
      private void func_148497_a(List p_148497_1_) {
         Collections.sort(p_148497_1_, new McoServerList.UpdateTask.Comparator(McoServerList.this.field_148493_i.func_111285_a(), null));
      }

      // $FF: synthetic method
      UpdateTask(Object p_i2329_2_) {
         this();
      }
      ...
      class Comparator implements java.util.Comparator {
         ...
         private Comparator(String p_i2326_2_) {
            this.field_148504_b = p_i2326_2_;
         }
         ...
         public int compare(Object p_compare_1_, Object p_compare_2_) {
            return this.compare((McoServer)p_compare_1_, (McoServer)p_compare_2_);
         }

         // $FF: synthetic method
         Comparator(String p_i2327_2_, Object p_i2327_3_) {
            this(p_i2327_2_);
         }
      }
   }
