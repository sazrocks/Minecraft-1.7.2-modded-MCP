...
public class Framebuffer {
   ...
   public void func_147605_b(int p_147605_1_, int p_147605_2_) {
      ...
      if(!OpenGlHelper.func_148822_b()) {
         ...
         EXTFramebufferObject.glBindFramebufferEXT('\u8d40', this.field_147616_f);
         EXTFramebufferObject.glFramebufferTexture2DEXT('\u8d40', '\u8ce0', 3553, this.field_147617_g, 0);
         if(this.field_147619_e) {
            EXTFramebufferObject.glBindRenderbufferEXT('\u8d41', this.field_147624_h);
            EXTFramebufferObject.glRenderbufferStorageEXT('\u8d41', '\u81a6', this.field_147622_a, this.field_147620_b);
            EXTFramebufferObject.glFramebufferRenderbufferEXT('\u8d40', '\u8d00', '\u8d41', this.field_147624_h);
         }
