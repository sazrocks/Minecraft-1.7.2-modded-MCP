...
public class ShaderLoader {
   ...
   public static ShaderLoader func_148057_a(IResourceManager p_148057_0_, ShaderLoader.ShaderType p_148057_1_, String p_148057_2_) throws IOException {
      ...
      if(var3 == null) {
         ...
         BufferedInputStream var5 = new BufferedInputStream(p_148057_0_.func_110536_a(var4).func_110527_b());
         ...
         if(GL20.glGetShaderi(var8, '\u8b81') == 0) {
            String var9 = StringUtils.trim(GL20.glGetShaderInfoLog(var8, '\u8000'));
   ...
   public static enum ShaderType {
      ...
      VERTEX("VERTEX", 0, "vertex", ".vsh", '\u8b31'),
      FRAGMENT("FRAGMENT", 1, "fragment", ".fsh", '\u8b30');
