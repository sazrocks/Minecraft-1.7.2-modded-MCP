...
public class SoundHandler implements IResourceManagerReloadListener, IUpdatePlayerListBox {
   ...
   private void func_147693_a(ResourceLocation p_147693_1_, SoundList p_147693_2_) {
      ...
      while(var4.hasNext()) {
         ...
         final String var8 = var6.contains(":")?var7.func_110624_b():p_147693_1_.func_110624_b();
         Object var9;
         ...
         case 1:
            ...
            try {
               ...
               field_147698_b.warn("File {} does not exist, cannot add it to event {}", new Object[]{var10, p_147693_1_});
               continue;
            } catch (IOException var13) {
               field_147698_b.warn("Could not load sound file " + var10 + ", cannot add it to event " + p_147693_1_, var13);
               continue;
            }
