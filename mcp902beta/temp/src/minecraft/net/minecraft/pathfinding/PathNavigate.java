...
public class PathNavigate {
   ...
   private int func_75503_j() {
      if(this.field_75515_a.func_70090_H() && this.field_75517_m) {
         ...
         Block var2 = this.field_75513_b.func_147439_a(MathHelper.func_76128_c(this.field_75515_a.field_70165_t), var1, MathHelper.func_76128_c(this.field_75515_a.field_70161_v));
         int var3 = 0;
         ...
         do {
            ...
            ++var1;
            var2 = this.field_75513_b.func_147439_a(MathHelper.func_76128_c(this.field_75515_a.field_70165_t), var1, MathHelper.func_76128_c(this.field_75515_a.field_70161_v));
            ++var3;
         } while(var3 <= 16);
         ...
         for(int var14 = var12; var14 < var12 + p_75483_4_; ++var14) {
            for(int var15 = var13; var15 < var13 + p_75483_6_; ++var15) {
               ...
               if(var16 * p_75483_8_ + var18 * p_75483_10_ >= 0.0D) {
                  Block var20 = this.field_75513_b.func_147439_a(var14, p_75483_2_ - 1, var15);
