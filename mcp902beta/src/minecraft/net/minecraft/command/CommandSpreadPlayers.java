...
public class CommandSpreadPlayers extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        ...
        else
        {
            ...
            while (true)
            {
                ...
                par1ICommandSender.func_145747_a(new ChatComponentTranslation("commands.spreadplayers.spreading." + (var12 ? "teams" : "players"), new Object[] {Integer.valueOf(var13.size()), Double.valueOf(var10), Double.valueOf(var4), Double.valueOf(var6), Double.valueOf(var8)}));
    ...
    private void func_110669_a(ICommandSender par1ICommandSender, List par2List, CommandSpreadPlayers.Position par3CommandSpreadPlayersPosition, double par4, double par6, World par8World, boolean par9)
    {
        ...
        if (var19.length > 1)
        {
            par1ICommandSender.func_145747_a(new ChatComponentTranslation("commands.spreadplayers.info." + (par9 ? "teams" : "players"), new Object[] {String.format("%.2f", new Object[]{Double.valueOf(var21)}), Integer.valueOf(var20)}));
        }
    }
    ...
    static class Position
    {
        ...
        public int func_111092_a(World par1World)
        {
            ...
            {
                if (par1World.func_147439_a(var2, var4, var3).func_149688_o() != Material.field_151579_a)
                {
                    return var4 + 1;
                }
            }
        ...
        public boolean func_111098_b(World par1World)
        {
            ...
            {
                Material var5 = par1World.func_147439_a(var2, var4, var3).func_149688_o();
                return !var5.isLiquid() && var5 != Material.field_151581_o;
            }
        }
