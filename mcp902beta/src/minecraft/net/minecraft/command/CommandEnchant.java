                ...
                else
                {
                    ...
                    if (var6.hasTagCompound())
                    {
                        ...
                        if (var8 != null)
                        {
                            ...
                            {
                                short var10 = var8.func_150305_b(var9).getShort("id");
                                ...
                                if (Enchantment.enchantmentsList[var10] != null)
                                {
                                    ...
                                    {
                                        throw new CommandException("commands.enchant.cantCombine", new Object[] {var7.getTranslatedName(var5), var11.getTranslatedName(var8.func_150305_b(var9).getShort("lvl"))});
                                    }
                                }
                            }
                        }
