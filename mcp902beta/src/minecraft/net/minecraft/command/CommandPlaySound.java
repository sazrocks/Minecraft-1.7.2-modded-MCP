    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        ...
        else
        {
            ...
            if (var20 > var18)
            {
                ...
                var5.playerNetServerHandler.func_147359_a(new S29PacketSoundEffect(var4, var30, var32, var34, (float)var16, (float)var14));
            }
            else
            {
                var5.playerNetServerHandler.func_147359_a(new S29PacketSoundEffect(var4, var6, var8, var10, (float)var12, (float)var14));
            }
