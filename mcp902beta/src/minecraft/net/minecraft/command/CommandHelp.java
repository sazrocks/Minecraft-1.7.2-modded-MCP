...
public class CommandHelp extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        ...
        par1ICommandSender.func_145747_a(var14);
        ...
        for (int var15 = var13 * var4; var15 < var7; ++var15)
        {
            ...
            var11.func_150256_b().func_150241_a(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/" + var10.getCommandName() + " "));
            par1ICommandSender.func_145747_a(var11);
        }
        ...
        if (var13 == 0 && par1ICommandSender instanceof EntityPlayer)
        {
            ...
            par1ICommandSender.func_145747_a(var16);
        }
    }
