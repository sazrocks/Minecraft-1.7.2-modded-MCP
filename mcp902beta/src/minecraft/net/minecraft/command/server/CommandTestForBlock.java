...
public class CommandTestForBlock extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        if (par2ArrayOfStr.length >= 4)
        {
            ...
            Block var6 = Block.func_149684_b(par2ArrayOfStr[3]);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (par2ArrayOfStr.length >= 6 && var6.func_149716_u())
                    {
                        String var11 = func_147178_a(par1ICommandSender, par2ArrayOfStr, 5).func_150260_c();
                    ...
                    Block var15 = var8.func_147439_a(var3, var4, var5);

                    if (var15 != var6)
                    {
                        throw new CommandException("commands.testforblock.failed.tile", new Object[] {Integer.valueOf(var3), Integer.valueOf(var4), Integer.valueOf(var5), var15.func_149732_F(), var6.func_149732_F()});
                    }
                    else
                    {
                        if (var7 > -1)
                        ...
                        par1ICommandSender.func_145747_a(new ChatComponentTranslation("commands.testforblock.success", new Object[] {Integer.valueOf(var3), Integer.valueOf(var4), Integer.valueOf(var5)}));
                    }
                }
            }
        }
