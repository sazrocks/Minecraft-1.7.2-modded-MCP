...
public class CommandSetBlock extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        if (par2ArrayOfStr.length >= 4)
        {
            ...
            Block var6 = CommandBase.func_147180_g(par1ICommandSender, par2ArrayOfStr[3]);
            int var7 = 0;
            ...
            else
            {
                ...
                if (par2ArrayOfStr.length >= 7 && var6.func_149716_u())
                {
                    String var11 = func_147178_a(par1ICommandSender, par2ArrayOfStr, 6).func_150260_c();
                ...
                if (par2ArrayOfStr.length >= 6)
                {
                    ...
                    else if (par2ArrayOfStr[5].equals("keep") && !var8.func_147437_c(var3, var4, var5))
                    {
