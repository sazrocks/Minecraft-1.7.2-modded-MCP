...
public class CommandBanIp extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        if (par2ArrayOfStr.length >= 1 && par2ArrayOfStr[0].length() > 1)
        {
            ...
            if (var3.matches())
            {
                this.func_147210_a(par1ICommandSender, par2ArrayOfStr[0], var4 == null ? null : var4.func_150260_c());
            }
            else
            {
                ...
                this.func_147210_a(par1ICommandSender, var5.getPlayerIP(), var4 == null ? null : var4.func_150260_c());
            }
        }
        else
        {
    ...
    protected void func_147210_a(ICommandSender p_147210_1_, String p_147210_2_, String p_147210_3_)
    {
        ...
        for (Iterator var8 = var5.iterator(); var8.hasNext(); var6[var7++] = var9.getCommandSenderName())
        {
            ...
            var9.playerNetServerHandler.func_147360_c("You have been IP banned.");
        }
