    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                ChatComponentTranslation var5 = new ChatComponentTranslation("commands.message.display.incoming", new Object[] {par1ICommandSender.func_145748_c_(), var4.func_150259_f()});
                ...
                par1ICommandSender.func_145747_a(var6);
            }
        }
    }
