    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        ...
        else if (par2ArrayOfStr.length == 1)
        {
            ...
            if (var4.hasRule(var6))
            {
                ...
                par1ICommandSender.func_145747_a((new ChatComponentText(var6)).func_150258_a(" = ").func_150258_a(var5));
            }
            else
            {
                notifyAdmins(par1ICommandSender, "commands.gamerule.norule", new Object[] {var6});
        ...
        else if (par2ArrayOfStr.length == 0)
        {
            ...
            par1ICommandSender.func_145747_a(new ChatComponentText(joinNiceString(var3.getRules())));
        }
        else
        {
