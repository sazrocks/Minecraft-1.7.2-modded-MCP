...
public class StatisticsFile extends StatFileWriter
{
    ...
    public static String func_150880_a(Map p_150880_0_)
    {
        ...
        while (var2.hasNext())
        {
            ...
            if (((TupleIntJsonSerializable)var3.getValue()).func_151187_b() != null)
            {
                ...
                var4.addProperty("value", Integer.valueOf(((TupleIntJsonSerializable)var3.getValue()).func_151189_a()));
            ...
            {
                var1.addProperty(((StatBase)var3.getKey()).statId, Integer.valueOf(((TupleIntJsonSerializable)var3.getValue()).func_151189_a()));
            }
        }
    ...
    public void func_150876_a(EntityPlayerMP p_150876_1_)
    {
        ...
        p_150876_1_.playerNetServerHandler.func_147359_a(new S37PacketStatistics(var3));
    }
    ...
    public void func_150884_b(EntityPlayerMP p_150884_1_)
    {
        ...
        p_150884_1_.playerNetServerHandler.func_147359_a(new S37PacketStatistics(var2));
    }
