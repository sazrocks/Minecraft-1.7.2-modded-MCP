...
public class StatBase
{
    ...
    {
        IChatComponent var1 = this.statName.func_150259_f();
        var1.func_150256_b().func_150238_a(EnumChatFormatting.GRAY);
        var1.func_150256_b().func_150209_a(new HoverEvent(HoverEvent.Action.SHOW_ACHIEVEMENT, new ChatComponentText(this.statId)));
        return var1;
    }
