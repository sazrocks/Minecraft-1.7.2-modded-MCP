...
public class StatList
{
    ...
    private static void initCraftableStats()
    {
        ...
        while (var1.hasNext())
        {
            ...
            if (var5 != null)
            {
                int var3 = Item.func_150891_b(var5);
    ...
    private static void func_151181_c()
    {
        ...
        while (var0.hasNext())
        {
            ...
            if (Item.func_150898_a(var1) != null)
            {
                ...
                {
                    mineBlockStatArray[var2] = (new StatCrafting("stat.mineBlock." + var2, new ChatComponentTranslation("stat.mineBlock", new Object[] {(new ItemStack(var1)).func_151000_E()}), Item.func_150898_a(var1))).registerStat();
    ...
    {
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150355_j, Blocks.field_150358_i);
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150353_l, Blocks.field_150356_k);
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150428_aP, Blocks.field_150423_aK);
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150470_am, Blocks.field_150460_al);
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150439_ay, Blocks.field_150450_ax);
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150416_aS, Blocks.field_150413_aR);
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150455_bV, Blocks.field_150441_bU);
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150429_aA, Blocks.field_150437_az);
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150374_bv, Blocks.field_150379_bu);
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150337_Q, Blocks.field_150338_P);
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150334_T, Blocks.field_150333_U);
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150373_bw, Blocks.field_150376_bx);
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150349_c, Blocks.field_150346_d);
        func_151180_a(par0ArrayOfStatBase, Blocks.field_150458_ak, Blocks.field_150346_d);
    }
