...
public class PathFinder
{
    ...
    private PathEntity createEntityPathTo(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        if (this.canEntityDrown && par1Entity.isInWater())
        {
            ...
            for (Block var11 = this.worldMap.func_147439_a(MathHelper.floor_double(par1Entity.posX), var10, MathHelper.floor_double(par1Entity.posZ)); var11 == Blocks.field_150358_i || var11 == Blocks.field_150355_j; var11 = this.worldMap.func_147439_a(MathHelper.floor_double(par1Entity.posX), var10, MathHelper.floor_double(par1Entity.posZ)))
            {
                ++var10;
            }
    ...
    public static int func_82565_a(Entity par0Entity, int par1, int par2, int par3, PathPoint par4PathPoint, boolean par5, boolean par6, boolean par7)
    {
        ...
        for (int var9 = par1; var9 < par1 + par4PathPoint.xCoord; ++var9)
        {
            for (int var10 = par2; var10 < par2 + par4PathPoint.yCoord; ++var10)
            {
                ...
                {
                    Block var12 = par0Entity.worldObj.func_147439_a(var9, var10, var11);
                    ...
                    if (var12.func_149688_o() != Material.field_151579_a)
                    {
                        ...
                        {
                            if (!par7 && var12 == Blocks.field_150466_ao)
                            {
                                return 0;
                            }
                        }
                        ...
                        if (par0Entity.worldObj.func_147439_a(var9, var10, var11).func_149645_b() == 9)
                        {
                            ...
                            if (par0Entity.worldObj.func_147439_a(var17, var15, var16).func_149645_b() != 9 && par0Entity.worldObj.func_147439_a(var17, var15 - 1, var16).func_149645_b() != 9)
                            {
                                return -3;
                            }
                        }
                        else if (!var12.func_149655_b(par0Entity.worldObj, var9, var10, var11) && (!par6 || var12 != Blocks.field_150466_ao))
                        {
                            ...
                            Material var14 = var12.func_149688_o();

                            if (var14 != Material.field_151587_i)
                            {
                                return 0;
                            }
