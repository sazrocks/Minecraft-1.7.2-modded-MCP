...
public class PathNavigate
{
    ...
    private int getPathableYPos()
    {
        if (this.theEntity.isInWater() && this.canSwim)
        {
            ...
            Block var2 = this.worldObj.func_147439_a(MathHelper.floor_double(this.theEntity.posX), var1, MathHelper.floor_double(this.theEntity.posZ));
            int var3 = 0;
            ...
            do
            {
                ...
                ++var1;
                var2 = this.worldObj.func_147439_a(MathHelper.floor_double(this.theEntity.posX), var1, MathHelper.floor_double(this.theEntity.posZ));
                ++var3;
            }
            while (var3 <= 16);
        ...
        else
        {
            for (int var14 = var12; var14 < var12 + par4; ++var14)
            {
                for (int var15 = var13; var15 < var13 + par6; ++var15)
                {
                    ...
                    {
                        Block var20 = this.worldObj.func_147439_a(var14, par2 - 1, var15);
        ...
        for (int var12 = par1; var12 < par1 + par4; ++var12)
        {
            for (int var13 = par2; var13 < par2 + par5; ++var13)
            {
                for (int var14 = par3; var14 < par3 + par6; ++var14)
                {
                    ...
                    {
                        Block var19 = this.worldObj.func_147439_a(var12, var13, var14);

                        if (!var19.func_149655_b(this.worldObj, var12, var13, var14))
                        {
                            return false;
                        }
                    }
