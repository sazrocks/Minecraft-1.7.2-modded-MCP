    ...
    public ContainerPlayer(final InventoryPlayer par1InventoryPlayer, boolean par2, EntityPlayer par3EntityPlayer)
    {
        ...
        for (var4 = 0; var4 < 4; ++var4)
        {
            ...
            this.addSlotToContainer(new Slot(par1InventoryPlayer, par1InventoryPlayer.getSizeInventory() - 1 - var4, 8, 8 + var4 * 18)
            {
                ...
                {
                    return par1ItemStack == null ? false : (par1ItemStack.getItem() instanceof ItemArmor ? ((ItemArmor)par1ItemStack.getItem()).armorType == var44 : (par1ItemStack.getItem() != Item.func_150898_a(Blocks.field_150423_aK) && par1ItemStack.getItem() != Items.field_151144_bL ? false : var44 == 0));
                }
