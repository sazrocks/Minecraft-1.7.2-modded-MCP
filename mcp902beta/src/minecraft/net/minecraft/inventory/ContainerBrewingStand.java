...
public class ContainerBrewingStand extends Container
{
    ...
    static class Potion extends Slot
    {
        ...
        {
            if (par2ItemStack.getItem() == Items.field_151068_bn && par2ItemStack.getItemDamage() > 0)
            {
        ...
        {
            return par0ItemStack != null && (par0ItemStack.getItem() == Items.field_151068_bn || par0ItemStack.getItem() == Items.field_151069_bo);
        }
    }
