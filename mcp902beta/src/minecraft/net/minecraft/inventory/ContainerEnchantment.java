...
public class ContainerEnchantment extends Container
{
            ...
            if (var2 != null && var2.isItemEnchantable())
            {
                ...
                if (!this.worldPointer.isRemote)
                {
                    ...
                    for (var4 = -1; var4 <= 1; ++var4)
                    {
                        ...
                        {
                            if ((var4 != 0 || var5 != 0) && this.worldPointer.func_147437_c(this.posX + var5, this.posY, this.posZ + var4) && this.worldPointer.func_147437_c(this.posX + var5, this.posY + 1, this.posZ + var4))
                            {
                                if (this.worldPointer.func_147439_a(this.posX + var5 * 2, this.posY, this.posZ + var4 * 2) == Blocks.field_150342_X)
                                {
                                    ++var3;
                                }

                                if (this.worldPointer.func_147439_a(this.posX + var5 * 2, this.posY + 1, this.posZ + var4 * 2) == Blocks.field_150342_X)
                                {
                                    ++var3;
                                }
                                ...
                                if (var5 != 0 && var4 != 0)
                                {
                                    if (this.worldPointer.func_147439_a(this.posX + var5 * 2, this.posY, this.posZ + var4) == Blocks.field_150342_X)
                                    {
                                        ++var3;
                                    }

                                    if (this.worldPointer.func_147439_a(this.posX + var5 * 2, this.posY + 1, this.posZ + var4) == Blocks.field_150342_X)
                                    {
                                        ++var3;
                                    }

                                    if (this.worldPointer.func_147439_a(this.posX + var5, this.posY, this.posZ + var4 * 2) == Blocks.field_150342_X)
                                    {
                                        ++var3;
                                    }

                                    if (this.worldPointer.func_147439_a(this.posX + var5, this.posY + 1, this.posZ + var4 * 2) == Blocks.field_150342_X)
                                    {
                                        ++var3;
                                    }
                                }
    ...
    public boolean enchantItem(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (this.enchantLevels[par2] > 0 && var3 != null && (par1EntityPlayer.experienceLevel >= this.enchantLevels[par2] || par1EntityPlayer.capabilities.isCreativeMode))
        {
            if (!this.worldPointer.isRemote)
            {
                ...
                boolean var5 = var3.getItem() == Items.field_151122_aG;
                ...
                if (var4 != null)
                {
                    ...
                    for (int var7 = 0; var7 < var4.size(); ++var7)
                    {
                        ...
                        if (!var5 || var7 != var6)
                        {
                            if (var5)
                            {
                                Items.field_151134_bR.addEnchantment(var3, var8);
                            }
                            else
                            {
    ...
    {
        return this.worldPointer.func_147439_a(this.posX, this.posY, this.posZ) != Blocks.field_150381_bn ? false : par1EntityPlayer.getDistanceSq((double)this.posX + 0.5D, (double)this.posY + 0.5D, (double)this.posZ + 0.5D) <= 64.0D;
    }
