...
public class SlotCrafting extends Slot
{
    ...
    protected void onCrafting(ItemStack par1ItemStack)
    {
        ...
        if (par1ItemStack.getItem() == Item.func_150898_a(Blocks.field_150462_ai))
        {
        ...
        if (par1ItemStack.getItem() == Item.func_150898_a(Blocks.field_150460_al))
        {
        ...
        if (par1ItemStack.getItem() == Items.field_151025_P)
        {
            this.thePlayer.addStat(AchievementList.makeBread, 1);
        }

        if (par1ItemStack.getItem() == Items.field_151105_aU)
        {
        ...
        if (par1ItemStack.getItem() == Item.func_150898_a(Blocks.field_150381_bn))
        {
            this.thePlayer.addStat(AchievementList.enchantments, 1);
        }

        if (par1ItemStack.getItem() == Item.func_150898_a(Blocks.field_150342_X))
        {
