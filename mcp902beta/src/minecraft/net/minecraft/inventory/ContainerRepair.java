...
public class ContainerRepair extends Container
{
    ...
    public ContainerRepair(InventoryPlayer par1InventoryPlayer, final World par2World, final int par3, final int par4, final int par5, EntityPlayer par6EntityPlayer)
    {
        ...
        this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47)
        {
            ...
            public void onPickupFromSlot(EntityPlayer par1EntityPlayer, ItemStack par2ItemStack)
            {
                ...
                if (!par1EntityPlayer.capabilities.isCreativeMode && !par2World.isRemote && par2World.func_147439_a(par3, par4, par5) == Blocks.field_150467_bQ && par1EntityPlayer.getRNG().nextFloat() < 0.12F)
                {
    ...
    public void updateRepairOutput()
    {
        ...
        else
        {
            ...
            if (var6 != null)
            {
                var8 = var6.getItem() == Items.field_151134_bR && Items.field_151134_bR.func_92110_g(var6).tagCount() > 0;
                ...
                else
                {
                    ...
                    while (var21.hasNext())
                    {
                        ...
                        if (this.thePlayer.capabilities.isCreativeMode || var1.getItem() == Items.field_151134_bR)
                        {
                            var16 = true;
                        }
            ...
            else if (!this.repairedItemName.equals(var1.getDisplayName()))
            {
                ...
                var5.func_151001_c(this.repairedItemName);
            }
    ...
    {
        return this.theWorld.func_147439_a(this.field_82861_i, this.field_82858_j, this.field_82859_k) != Blocks.field_150467_bQ ? false : par1EntityPlayer.getDistanceSq((double)this.field_82861_i + 0.5D, (double)this.field_82858_j + 0.5D, (double)this.field_82859_k + 0.5D) <= 64.0D;
    }
    ...
    public void updateItemName(String par1Str)
    {
        ...
        if (this.getSlot(2).getHasStack())
        {
            ...
            {
                var2.func_151001_c(this.repairedItemName);
            }
        }
