...
public class BlockTripWire extends Block
{
    ...
    public void func_149681_a(World p_149681_1_, int p_149681_2_, int p_149681_3_, int p_149681_4_, int p_149681_5_, EntityPlayer p_149681_6_)
    {
        ...
        {
            if (p_149681_6_.getCurrentEquippedItem() != null && p_149681_6_.getCurrentEquippedItem().getItem() == Items.field_151097_aZ)
            {
            ...
            while (true)
            {
                if (var7 < 42)
                {
                    ...
                    if (var10 == Blocks.field_150479_bC)
                    {
                        ...
                        {
                            Blocks.field_150479_bC.func_150136_a(p_150138_1_, var8, p_150138_3_, var9, false, p_150138_1_.getBlockMetadata(var8, p_150138_3_, var9), true, var7, p_150138_5_);
                        }
                    }
