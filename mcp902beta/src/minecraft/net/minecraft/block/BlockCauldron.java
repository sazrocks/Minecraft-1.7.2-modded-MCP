...
public class BlockCauldron extends Block
{
    ...
    public void func_149670_a(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity p_149670_5_)
    {
        ...
        if (!p_149670_1_.isRemote && p_149670_5_.isBurning() && var6 > 0 && p_149670_5_.boundingBox.minY <= (double)var7)
        {
    ...
    public boolean func_149727_a(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (var10.getItem() == Items.field_151131_as)
                {
                    if (var12 < 3)
                    {
                        if (!p_149727_5_.capabilities.isCreativeMode)
                        {
                            p_149727_5_.inventory.setInventorySlotContents(p_149727_5_.inventory.currentItem, new ItemStack(Items.field_151133_ar));
                        }
                ...
                {
                    if (var10.getItem() == Items.field_151069_bo)
                    {
                        if (var12 > 0)
                        {
                            if (!p_149727_5_.capabilities.isCreativeMode)
