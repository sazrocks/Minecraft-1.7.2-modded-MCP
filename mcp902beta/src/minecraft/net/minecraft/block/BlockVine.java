    ...
    private boolean func_150094_e(World p_150094_1_, int p_150094_2_, int p_150094_3_, int p_150094_4_)
    {
        ...
        if (var5 > 0)
        {
            for (int var7 = 0; var7 <= 3; ++var7)
            {
                ...
                if ((var5 & var8) != 0 && !this.func_150093_a(p_150094_1_.func_147439_a(p_150094_2_ + Direction.offsetX[var7], p_150094_3_, p_150094_4_ + Direction.offsetZ[var7])) && (p_150094_1_.func_147439_a(p_150094_2_, p_150094_3_ + 1, p_150094_4_) != this || (p_150094_1_.getBlockMetadata(p_150094_2_, p_150094_3_ + 1, p_150094_4_) & var8) == 0))
                {
                    var6 &= ~var8;
                }
            }
        ...
        if (!p_149674_1_.isRemote && p_149674_1_.rand.nextInt(4) == 0)
        {
            ...
            if (var10 == 1 && p_149674_3_ < 255 && p_149674_1_.func_147437_c(p_149674_2_, p_149674_3_ + 1, p_149674_4_))
            {
                ...
                if (var15 > 0)
                {
                    ...
                    {
                        if (!this.func_150093_a(p_149674_1_.func_147439_a(p_149674_2_ + Direction.offsetX[var13], p_149674_3_ + 1, p_149674_4_ + Direction.offsetZ[var13])))
                        {
                            var15 &= ~(1 << var13);
                        }
                    }
            ...
            else
            {
                ...
                if (var10 >= 2 && var10 <= 5 && (var9 & 1 << var11) == 0)
                {
                    ...
                    var12 = p_149674_1_.func_147439_a(p_149674_2_ + Direction.offsetX[var11], p_149674_3_, p_149674_4_ + Direction.offsetZ[var11]);
                    ...
                    if (var12.field_149764_J == Material.field_151579_a)
                    {
                        ...
                        if ((var9 & 1 << var13) != 0 && this.func_150093_a(p_149674_1_.func_147439_a(p_149674_2_ + Direction.offsetX[var11] + Direction.offsetX[var13], p_149674_3_, p_149674_4_ + Direction.offsetZ[var11] + Direction.offsetZ[var13])))
                        {
                            p_149674_1_.func_147465_d(p_149674_2_ + Direction.offsetX[var11], p_149674_3_, p_149674_4_ + Direction.offsetZ[var11], this, 1 << var13, 2);
                        }
                        else if ((var9 & 1 << var14) != 0 && this.func_150093_a(p_149674_1_.func_147439_a(p_149674_2_ + Direction.offsetX[var11] + Direction.offsetX[var14], p_149674_3_, p_149674_4_ + Direction.offsetZ[var11] + Direction.offsetZ[var14])))
                        {
                            p_149674_1_.func_147465_d(p_149674_2_ + Direction.offsetX[var11], p_149674_3_, p_149674_4_ + Direction.offsetZ[var11], this, 1 << var14, 2);
                        }
                        else if ((var9 & 1 << var13) != 0 && p_149674_1_.func_147437_c(p_149674_2_ + Direction.offsetX[var11] + Direction.offsetX[var13], p_149674_3_, p_149674_4_ + Direction.offsetZ[var11] + Direction.offsetZ[var13]) && this.func_150093_a(p_149674_1_.func_147439_a(p_149674_2_ + Direction.offsetX[var13], p_149674_3_, p_149674_4_ + Direction.offsetZ[var13])))
                        {
                            p_149674_1_.func_147465_d(p_149674_2_ + Direction.offsetX[var11] + Direction.offsetX[var13], p_149674_3_, p_149674_4_ + Direction.offsetZ[var11] + Direction.offsetZ[var13], this, 1 << (var11 + 2 & 3), 2);
                        }
                        else if ((var9 & 1 << var14) != 0 && p_149674_1_.func_147437_c(p_149674_2_ + Direction.offsetX[var11] + Direction.offsetX[var14], p_149674_3_, p_149674_4_ + Direction.offsetZ[var11] + Direction.offsetZ[var14]) && this.func_150093_a(p_149674_1_.func_147439_a(p_149674_2_ + Direction.offsetX[var14], p_149674_3_, p_149674_4_ + Direction.offsetZ[var14])))
                        {
                            p_149674_1_.func_147465_d(p_149674_2_ + Direction.offsetX[var11] + Direction.offsetX[var14], p_149674_3_, p_149674_4_ + Direction.offsetZ[var11] + Direction.offsetZ[var14], this, 1 << (var11 + 2 & 3), 2);
                        }
                        else if (this.func_150093_a(p_149674_1_.func_147439_a(p_149674_2_ + Direction.offsetX[var11], p_149674_3_ + 1, p_149674_4_ + Direction.offsetZ[var11])))
                        {
                            p_149674_1_.func_147465_d(p_149674_2_ + Direction.offsetX[var11], p_149674_3_, p_149674_4_ + Direction.offsetZ[var11], this, 0, 2);
                        }
                    }
                    else if (var12.field_149764_J.isOpaque() && var12.func_149686_d())
                    {
