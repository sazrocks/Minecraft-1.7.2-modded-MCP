...
public class BlockGrass extends Block implements IGrowable
{
    ...
    public int func_149720_d(IBlockAccess p_149720_1_, int p_149720_2_, int p_149720_3_, int p_149720_4_)
    {
        ...
        for (int var8 = -1; var8 <= 1; ++var8)
        {
            ...
            {
                int var10 = p_149720_1_.getBiomeGenForCoords(p_149720_2_ + var9, p_149720_4_ + var8).func_150558_b(p_149720_2_ + var9, p_149720_3_, p_149720_4_ + var8);
        ...
        if (!p_149674_1_.isRemote)
        {
            ...
            else if (p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1, p_149674_4_) >= 9)
            {
                for (int var6 = 0; var6 < 4; ++var6)
                {
                    ...
                    if (p_149674_1_.func_147439_a(var7, var8, var9) == Blocks.field_150346_d && p_149674_1_.getBlockMetadata(var7, var8, var9) == 0 && p_149674_1_.getBlockLightValue(var7, var8 + 1, var9) >= 4 && var10.func_149717_k() <= 2)
                    {
            ...
            while (true)
            {
                ...
                else if (p_149853_1_.func_147439_a(var7, var8, var9).field_149764_J == Material.field_151579_a)
                {
                    ...
                    else
                    {
                        ...
                        field_149992_a.debug("Flower in " + p_149853_1_.getBiomeGenForCoords(var7, var9).biomeName + ": " + var13);
