...
public class BlockFire extends Block
{
    ...
    public void func_149674_a(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        ...
        {
            boolean var6 = p_149674_1_.func_147439_a(p_149674_2_, p_149674_3_ - 1, p_149674_4_) == Blocks.field_150424_aL;

            if (p_149674_1_.provider instanceof WorldProviderEnd && p_149674_1_.func_147439_a(p_149674_2_, p_149674_3_ - 1, p_149674_4_) == Blocks.field_150357_h)
            {
                var6 = true;
            }
            ...
            else
            {
                ...
                {
                    if (!World.func_147466_a(p_149674_1_, p_149674_2_, p_149674_3_ - 1, p_149674_4_) || var7 > 3)
                    {
                        p_149674_1_.func_147468_f(p_149674_2_, p_149674_3_, p_149674_4_);
                    }
                }
                        ...
                        for (int var11 = p_149674_4_ - 1; var11 <= p_149674_4_ + 1; ++var11)
                        {
                            for (int var12 = p_149674_3_ - 1; var12 <= p_149674_3_ + 4; ++var12)
                            {
                                if (var10 != p_149674_2_ || var12 != p_149674_3_ || var11 != p_149674_4_)
                                {
                                    ...
                                    if (var14 > 0)
                                    {
                                        int var15 = (var14 + 40 + p_149674_1_.difficultySetting.func_151525_a() * 7) / (var7 + 30);
    ...
    {
        int var8 = this.field_149848_b[Block.func_149682_b(p_149841_1_.func_147439_a(p_149841_2_, p_149841_3_, p_149841_4_))];

        if (p_149841_6_.nextInt(p_149841_5_) < var8)
        {
            boolean var9 = p_149841_1_.func_147439_a(p_149841_2_, p_149841_3_, p_149841_4_) == Blocks.field_150335_W;
    ...
    {
        int var6 = this.field_149849_a[Block.func_149682_b(p_149846_1_.func_147439_a(p_149846_2_, p_149846_3_, p_149846_4_))];
    ...
    {
        if (p_149726_1_.provider.dimensionId > 0 || !Blocks.field_150427_aO.func_150000_e(p_149726_1_, p_149726_2_, p_149726_3_, p_149726_4_))
        {
