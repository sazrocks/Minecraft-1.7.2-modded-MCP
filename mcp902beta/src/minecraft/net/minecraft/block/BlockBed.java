    ...
    public static ChunkCoordinates func_149977_a(World p_149977_0_, int p_149977_1_, int p_149977_2_, int p_149977_3_, int p_149977_4_)
    {
        ...
        for (int var7 = 0; var7 <= 1; ++var7)
        {
            ...
            for (int var12 = var8; var12 <= var10; ++var12)
            {
                ...
                {
                    if (World.func_147466_a(p_149977_0_, var12, p_149977_2_ - 1, var13) && !p_149977_0_.func_147439_a(var12, p_149977_2_, var13).func_149688_o().isOpaque() && !p_149977_0_.func_147439_a(var12, p_149977_2_ + 1, var13).func_149688_o().isOpaque())
                    {
                        if (p_149977_4_ <= 0)
                        {
