...
public class Block
{
    ...
    public static void func_149671_p()
    {
        ...
        Block var0 = (new Block(Material.field_151576_e)).func_149711_c(2.0F).func_149752_b(10.0F).func_149672_a(field_149780_i).func_149663_c("stonebrick").func_149647_a(CreativeTabs.tabBlock).func_149658_d("cobblestone");
        ...
        Block var3 = (new Block(Material.field_151576_e)).func_149711_c(2.0F).func_149752_b(10.0F).func_149672_a(field_149780_i).func_149663_c("brick").func_149647_a(CreativeTabs.tabBlock).func_149658_d("brick");
        ...
        Block var8 = (new Block(Material.field_151576_e)).func_149711_c(2.0F).func_149752_b(10.0F).func_149672_a(field_149780_i).func_149663_c("netherBrick").func_149647_a(CreativeTabs.tabBlock).func_149658_d("nether_brick");
    ...
    public int func_149677_c(IBlockAccess p_149677_1_, int p_149677_2_, int p_149677_3_, int p_149677_4_)
    {
        ...
        int var6 = p_149677_1_.getLightBrightnessForSkyBlocks(p_149677_2_, p_149677_3_, p_149677_4_, var5.func_149750_m());

        if (var6 == 0 && var5 instanceof BlockSlab)
        {
            --p_149677_3_;
            var5 = p_149677_1_.func_147439_a(p_149677_2_, p_149677_3_, p_149677_4_);
            return p_149677_1_.getLightBrightnessForSkyBlocks(p_149677_2_, p_149677_3_, p_149677_4_, var5.func_149750_m());
        }
        else
        {
            return var6;
    ...
    public void func_149690_a(World p_149690_1_, int p_149690_2_, int p_149690_3_, int p_149690_4_, int p_149690_5_, float p_149690_6_, int p_149690_7_)
    {
        ...
        {
            int var8 = this.func_149679_a(p_149690_7_, p_149690_1_.rand);

            for (int var9 = 0; var9 < var8; ++var9)
            {
                if (p_149690_1_.rand.nextFloat() <= p_149690_6_)
                {
                    Item var10 = this.func_149650_a(p_149690_5_, p_149690_1_.rand, p_149690_7_);
