...
public abstract class BlockLiquid extends Block
{
    ...
    private Vec3 func_149800_f(IBlockAccess p_149800_1_, int p_149800_2_, int p_149800_3_, int p_149800_4_)
    {
        ...
        for (int var7 = 0; var7 < 4; ++var7)
        {
            ...
            if (var11 < 0)
            {
                if (!p_149800_1_.func_147439_a(var8, p_149800_3_, var10).func_149688_o().blocksMovement())
                {
    ...
    public void func_149734_b(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        if (this.field_149764_J == Material.field_151586_h)
        {
            ...
            for (var6 = 0; var6 < 0; ++var6)
            {
                ...
                if (p_149734_1_.func_147439_a(var8, p_149734_3_, var9).func_149688_o() == Material.field_151579_a && (p_149734_1_.func_147439_a(var8, p_149734_3_ - 1, var9).func_149688_o().blocksMovement() || p_149734_1_.func_147439_a(var8, p_149734_3_ - 1, var9).func_149688_o().isLiquid()))
                {
                    float var10 = 0.0625F;
