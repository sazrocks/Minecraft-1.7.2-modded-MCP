...
public abstract class BlockRailBase extends Block
{
    ...
    public void func_149695_a(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        if (!p_149695_1_.isRemote)
        {
            ...
            if (var7 == 2 && !World.func_147466_a(p_149695_1_, p_149695_2_ + 1, p_149695_3_, p_149695_4_))
            {
                var8 = true;
            }

            if (var7 == 3 && !World.func_147466_a(p_149695_1_, p_149695_2_ - 1, p_149695_3_, p_149695_4_))
            {
                var8 = true;
            }

            if (var7 == 4 && !World.func_147466_a(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_ - 1))
            {
                var8 = true;
            }

            if (var7 == 5 && !World.func_147466_a(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_ + 1))
            {
                var8 = true;
            }
    ...
    public class Rail
    {
        ...
        public Rail(World p_i45388_2_, int p_i45388_3_, int p_i45388_4_, int p_i45388_5_)
        {
            ...
            Block var6 = p_i45388_2_.func_147439_a(p_i45388_3_, p_i45388_4_, p_i45388_5_);
