...
public class BlockPistonBase extends Block
{
    ...
    public IIcon func_149691_a(int p_149691_1_, int p_149691_2_)
    {
        ...
        return var3 > 5 ? this.field_150084_N : (p_149691_1_ == var3 ? (!func_150075_c(p_149691_2_) && this.field_149759_B <= 0.0D && this.field_149760_C <= 0.0D && this.field_149754_D <= 0.0D && this.field_149755_E >= 1.0D && this.field_149756_F >= 1.0D && this.field_149757_G >= 1.0D ? this.field_150084_N : this.field_150081_b) : (p_149691_1_ == Facing.oppositeSide[var3] ? this.field_150083_M : this.field_149761_L));
    }
    ...
    public boolean func_149696_a(World p_149696_1_, int p_149696_2_, int p_149696_3_, int p_149696_4_, int p_149696_5_, int p_149696_6_)
    {
        ...
        {
            TileEntity var16 = p_149696_1_.func_147438_o(p_149696_2_ + Facing.offsetsXForSide[p_149696_6_], p_149696_3_ + Facing.offsetsYForSide[p_149696_6_], p_149696_4_ + Facing.offsetsZForSide[p_149696_6_]);
        ...
        while (true)
        {
            if (var9 < 13)
            {
                ...
                if (var10.func_149688_o() != Material.field_151579_a)
                {
                    ...
                    var10.func_149697_b(p_150079_1_, var6, var7, var8, p_150079_1_.getBlockMetadata(var6, var7, var8), 0);
