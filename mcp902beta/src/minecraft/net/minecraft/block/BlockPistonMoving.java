...
public class BlockPistonMoving extends BlockContainer
{
    ...
    public void func_149719_a(IBlockAccess p_149719_1_, int p_149719_2_, int p_149719_3_, int p_149719_4_)
    {
        ...
        if (var5 != null)
        {
            ...
            this.field_149759_B = var6.func_149704_x() - (double)((float)Facing.offsetsXForSide[var8] * var7);
            this.field_149760_C = var6.func_149665_z() - (double)((float)Facing.offsetsYForSide[var8] * var7);
            this.field_149754_D = var6.func_149706_B() - (double)((float)Facing.offsetsZForSide[var8] * var7);
            this.field_149755_E = var6.func_149753_y() - (double)((float)Facing.offsetsXForSide[var8] * var7);
            this.field_149756_F = var6.func_149669_A() - (double)((float)Facing.offsetsYForSide[var8] * var7);
            this.field_149757_G = var6.func_149693_C() - (double)((float)Facing.offsetsZForSide[var8] * var7);
        }
    }
