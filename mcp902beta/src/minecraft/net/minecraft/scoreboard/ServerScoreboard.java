...
public class ServerScoreboard extends Scoreboard
{
    ...
    public boolean func_151392_a(String p_151392_1_, String p_151392_2_)
    {
        if (super.func_151392_a(p_151392_1_, p_151392_2_))
        {
            ...
            this.field_96555_a.getConfigurationManager().func_148540_a(new S3EPacketTeams(var3, Arrays.asList(new String[] {p_151392_1_}), 3));
            this.func_96551_b();
            return true;
        }
        else
    ...
    public void func_96549_e(ScoreObjective par1ScoreObjective)
    {
        ...
        while (var3.hasNext())
        {
            ...
            while (var5.hasNext())
            {
                ...
                var4.playerNetServerHandler.func_147359_a(var6);
            }
        }
