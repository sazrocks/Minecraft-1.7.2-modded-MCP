...
public abstract class MinecraftServer implements ICommandSender, Runnable, IPlayerUsage
{
        ...
        if (!this.worldIsBeingDeleted)
        {
            ...
            for (int var4 = 0; var4 < var3; ++var4)
            {
                ...
                if (var5 != null)
                {
                    if (!par1)
                    {
                        field_147145_h.info("Saving chunks for level \'" + var5.getWorldInfo().getWorldName() + "\'/" + var5.provider.getDimensionName());
                    }
    ...
    private void func_147138_a(ServerStatusResponse p_147138_1_)
    {
        ...
        if (var2.isFile())
        {
            ...
            {
                field_147145_h.error("Couldn\'t load server icon", var6);
            }
        }
    }
    ...
    public void tick()
    {
        ...
        if (var1 - this.field_147142_T >= 5000000000L)
        {
            ...
            {
                var3[var5] = ((EntityPlayerMP)this.serverConfigManager.playerEntityList.get(var4 + var5)).func_146103_bH();
            }
        ...
        if (this.worldServers != null && this.worldServers.length > 0 && this.worldServers[0] != null)
        {
            par1CrashReport.getCategory().addCrashSectionCallable("Vec3 Pool Size", new Callable()
            {
                ...
                public String call()
                {
                    ...
                    int var4 = MinecraftServer.this.worldServers[0].getWorldVec3Pool().func_82590_d();
                    int var5 = 56 * var4;
