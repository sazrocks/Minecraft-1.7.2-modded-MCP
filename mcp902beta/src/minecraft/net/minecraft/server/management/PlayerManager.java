...
public class PlayerManager
{
    ...
    public boolean isPlayerWatchingChunk(EntityPlayerMP par1EntityPlayerMP, int par2, int par3)
    {
        ...
        return var4 == null ? false : var4.playersInChunk.contains(par1EntityPlayerMP) && !par1EntityPlayerMP.loadedChunks.contains(var4.chunkLocation);
    }
    ...
    class PlayerInstance
    {
        ...
        public void removePlayer(EntityPlayerMP par1EntityPlayerMP)
        {
            if (this.playersInChunk.contains(par1EntityPlayerMP))
            {
                ...
                {
                    par1EntityPlayerMP.playerNetServerHandler.func_147359_a(new S21PacketChunkData(var2, true, 0));
                }
        ...
        public void func_151251_a(Packet p_151251_1_)
        {
            for (int var2 = 0; var2 < this.playersInChunk.size(); ++var2)
            {
                ...
                {
                    var3.playerNetServerHandler.func_147359_a(p_151251_1_);
                }
            }
        }
        ...
        public void sendChunkUpdate()
        {
            if (this.numberOfTilesToUpdate != 0)
            {
                ...
                if (this.numberOfTilesToUpdate == 1)
                {
                    ...
                    if (PlayerManager.this.theWorldServer.func_147439_a(var1, var2, var3).func_149716_u())
                    {
                        this.func_151252_a(PlayerManager.this.theWorldServer.func_147438_o(var1, var2, var3));
                    }
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        for (var1 = 0; var1 < this.numberOfTilesToUpdate; ++var1)
                        {
                            ...
                            if (PlayerManager.this.theWorldServer.func_147439_a(var2, var3, var4).func_149716_u())
                            {
                                this.func_151252_a(PlayerManager.this.theWorldServer.func_147438_o(var2, var3, var4));
                            }
                        }
                    }
                }
