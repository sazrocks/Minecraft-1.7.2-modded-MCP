...
public class ItemInWorldManager
{
    ...
    public void updateBlockRemoving()
    {
        ...
        {
            int var1 = this.curblockDamage - this.field_73093_n;
            Block var2 = this.theWorld.func_147439_a(this.posX, this.posY, this.posZ);
            ...
            {
                var3 = var2.func_149737_a(this.thisPlayerMP, this.thisPlayerMP.worldObj, this.posX, this.posY, this.posZ) * (float)(var1 + 1);
                var4 = (int)(var3 * 10.0F);

                if (var4 != this.durabilityRemainingOnBlock)
                {
                    this.theWorld.func_147443_d(this.thisPlayerMP.func_145782_y(), this.posX, this.posY, this.posZ, var4);
        ...
        {
            Block var5 = this.theWorld.func_147439_a(this.partiallyDestroyedBlockX, this.partiallyDestroyedBlockY, this.partiallyDestroyedBlockZ);
            ...
            else
            {
                ...
                var3 = var5.func_149737_a(this.thisPlayerMP, this.thisPlayerMP.worldObj, this.partiallyDestroyedBlockX, this.partiallyDestroyedBlockY, this.partiallyDestroyedBlockZ) * (float)(var6 + 1);
                var4 = (int)(var3 * 10.0F);

                if (var4 != this.durabilityRemainingOnBlock)
                {
                    this.theWorld.func_147443_d(this.thisPlayerMP.func_145782_y(), this.partiallyDestroyedBlockX, this.partiallyDestroyedBlockY, this.partiallyDestroyedBlockZ, var4);
                    this.durabilityRemainingOnBlock = var4;
                }
            }
        }
    ...
    public void onBlockClicked(int par1, int par2, int par3, int par4)
    {
        if (!this.gameType.isAdventure() || this.thisPlayerMP.isCurrentToolAdventureModeExempt(par1, par2, par3))
        {
            ...
            else
            {
                ...
                float var5 = 1.0F;
                Block var6 = this.theWorld.func_147439_a(par1, par2, par3);

                if (var6.func_149688_o() != Material.field_151579_a)
                {
                    var6.func_149699_a(this.theWorld, par1, par2, par3, this.thisPlayerMP);
                    var5 = var6.func_149737_a(this.thisPlayerMP, this.thisPlayerMP.worldObj, par1, par2, par3);
                }
                ...
                else
                {
                    ...
                    this.theWorld.func_147443_d(this.thisPlayerMP.func_145782_y(), par1, par2, par3, var7);
    ...
    public void uncheckedTryHarvestBlock(int par1, int par2, int par3)
    {
        if (par1 == this.partiallyDestroyedBlockX && par2 == this.partiallyDestroyedBlockY && par3 == this.partiallyDestroyedBlockZ)
        {
            ...
            Block var5 = this.theWorld.func_147439_a(par1, par2, par3);

            if (var5.func_149688_o() != Material.field_151579_a)
            {
                float var6 = var5.func_149737_a(this.thisPlayerMP, this.thisPlayerMP.worldObj, par1, par2, par3) * (float)(var4 + 1);
    ...
    {
        Block var4 = this.theWorld.func_147439_a(par1, par2, par3);
        int var5 = this.theWorld.getBlockMetadata(par1, par2, par3);
        var4.func_149681_a(this.theWorld, par1, par2, par3, var5, this.thisPlayerMP);
        boolean var6 = this.theWorld.func_147468_f(par1, par2, par3);

        if (var6)
        {
            var4.func_149664_b(this.theWorld, par1, par2, par3, var5);
        }
    ...
    public boolean tryHarvestBlock(int par1, int par2, int par3)
    {
        ...
        else
        {
            Block var4 = this.theWorld.func_147439_a(par1, par2, par3);
            int var5 = this.theWorld.getBlockMetadata(par1, par2, par3);
            this.theWorld.playAuxSFXAtEntity(this.thisPlayerMP, 2001, par1, par2, par3, Block.func_149682_b(var4) + (this.theWorld.getBlockMetadata(par1, par2, par3) << 12));
            ...
            else
            {
                ...
                boolean var8 = this.thisPlayerMP.func_146099_a(var4);
                ...
                if (var6 && var8)
                {
                    var4.func_149636_a(this.theWorld, this.thisPlayerMP, par1, par2, par3, var5);
                }
            }
