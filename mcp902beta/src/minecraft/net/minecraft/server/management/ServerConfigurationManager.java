...
public abstract class ServerConfigurationManager
{
    ...
    public void initializeConnectionToPlayer(NetworkManager par1INetworkManager, EntityPlayerMP par2EntityPlayerMP)
    {
        ...
        field_148546_d.info(par2EntityPlayerMP.getCommandSenderName() + "[" + var4 + "] logged in with entity id " + par2EntityPlayerMP.func_145782_y() + " at (" + par2EntityPlayerMP.posX + ", " + par2EntityPlayerMP.posY + ", " + par2EntityPlayerMP.posZ + ")");
        ...
        var7.func_147359_a(new S01PacketJoinGame(par2EntityPlayerMP.func_145782_y(), par2EntityPlayerMP.theItemInWorldManager.getGameType(), var5.getWorldInfo().isHardcoreModeEnabled(), var5.provider.dimensionId, var5.difficultySetting, this.getMaxPlayers(), var5.getWorldInfo().getTerrainType()));
        var7.func_147359_a(new S3FPacketCustomPayload("MC|Brand", this.getServerInstance().getServerModName().getBytes(Charsets.UTF_8)));
        var7.func_147359_a(new S05PacketSpawnPosition(var6.posX, var6.posY, var6.posZ));
        var7.func_147359_a(new S39PacketPlayerAbilities(par2EntityPlayerMP.capabilities));
        var7.func_147359_a(new S09PacketHeldItemChange(par2EntityPlayerMP.inventory.currentItem));
        ...
        var7.func_147364_a(par2EntityPlayerMP.posX, par2EntityPlayerMP.posY, par2EntityPlayerMP.posZ, par2EntityPlayerMP.rotationYaw, par2EntityPlayerMP.rotationPitch);
        ...
        while (var9.hasNext())
        {
            ...
            var7.func_147359_a(new S1DPacketEntityEffect(par2EntityPlayerMP.func_145782_y(), var10));
        }
    ...
    protected void func_96456_a(ServerScoreboard par1ServerScoreboard, EntityPlayerMP par2EntityPlayerMP)
    {
        ...
        while (var4.hasNext())
        {
            ...
            par2EntityPlayerMP.playerNetServerHandler.func_147359_a(new S3EPacketTeams(var5, 0));
        }
        ...
        for (int var9 = 0; var9 < 3; ++var9)
        {
            ...
            if (var10 != null && !var3.contains(var10))
            {
                ...
                while (var7.hasNext())
                {
                    ...
                    par2EntityPlayerMP.playerNetServerHandler.func_147359_a(var8);
                }
    ...
    public void playerLoggedIn(EntityPlayerMP par1EntityPlayerMP)
    {
        ...
        for (int var3 = 0; var3 < this.playerEntityList.size(); ++var3)
        {
            ...
            par1EntityPlayerMP.playerNetServerHandler.func_147359_a(new S38PacketPlayerListItem(var4.getCommandSenderName(), true, var4.ping));
        }
    }
    ...
    public EntityPlayerMP func_148545_a(GameProfile p_148545_1_)
    {
        ...
        while (var5.hasNext())
        {
            ...
            var4.playerNetServerHandler.func_147360_c("You logged in from another location");
        }
    ...
    public EntityPlayerMP respawnPlayer(EntityPlayerMP par1EntityPlayerMP, int par2, boolean par3)
    {
        ...
        EntityPlayerMP var7 = new EntityPlayerMP(this.mcServer, this.mcServer.worldServerForDimension(par1EntityPlayerMP.dimension), par1EntityPlayerMP.func_146103_bH(), (ItemInWorldManager)var6);
        var7.playerNetServerHandler = par1EntityPlayerMP.playerNetServerHandler;
        var7.clonePlayer(par1EntityPlayerMP, par3);
        var7.func_145769_d(par1EntityPlayerMP.func_145782_y());
        ...
        if (var4 != null)
        {
            ...
            {
                var7.playerNetServerHandler.func_147359_a(new S2BPacketChangeGameState(0, 0.0F));
            }
        }
        ...
        var7.playerNetServerHandler.func_147359_a(new S07PacketRespawn(var7.dimension, var7.worldObj.difficultySetting, var7.worldObj.getWorldInfo().getTerrainType(), var7.theItemInWorldManager.getGameType()));
        var9 = var8.getSpawnPoint();
        var7.playerNetServerHandler.func_147364_a(var7.posX, var7.posY, var7.posZ, var7.rotationYaw, var7.rotationPitch);
        var7.playerNetServerHandler.func_147359_a(new S05PacketSpawnPosition(var9.posX, var9.posY, var9.posZ));
        var7.playerNetServerHandler.func_147359_a(new S1FPacketSetExperience(var7.experience, var7.experienceTotal, var7.experienceLevel));
    ...
    public void transferPlayerToDimension(EntityPlayerMP par1EntityPlayerMP, int par2)
    {
        ...
        while (var6.hasNext())
        {
            ...
            par1EntityPlayerMP.playerNetServerHandler.func_147359_a(new S1DPacketEntityEffect(par1EntityPlayerMP.func_145782_y(), var7));
        }
    }
    ...
    public void func_148540_a(Packet p_148540_1_)
    {
        ...
        {
            ((EntityPlayerMP)this.playerEntityList.get(var2)).playerNetServerHandler.func_147359_a(p_148540_1_);
        }
    }
    ...
    public void func_148537_a(Packet p_148537_1_, int p_148537_2_)
    {
        for (int var3 = 0; var3 < this.playerEntityList.size(); ++var3)
        {
            ...
            {
                var4.playerNetServerHandler.func_147359_a(p_148537_1_);
            }
        }
    }
    ...
    public void func_148543_a(EntityPlayer p_148543_1_, double p_148543_2_, double p_148543_4_, double p_148543_6_, double p_148543_8_, int p_148543_10_, Packet p_148543_11_)
    {
        for (int var12 = 0; var12 < this.playerEntityList.size(); ++var12)
        {
            ...
            if (var13 != p_148543_1_ && var13.dimension == p_148543_10_)
            {
                ...
                {
                    var13.playerNetServerHandler.func_147359_a(p_148543_11_);
                }
            }
        }
    }
    ...
    public void removeAllPlayers()
    {
        for (int var1 = 0; var1 < this.playerEntityList.size(); ++var1)
        {
            ((EntityPlayerMP)this.playerEntityList.get(var1)).playerNetServerHandler.func_147360_c("Server closed");
        }
    }
