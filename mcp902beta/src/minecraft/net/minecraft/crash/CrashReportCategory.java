...
public class CrashReportCategory
{
    ...
    {
        final int var6 = Block.func_149682_b(p_147153_4_);
        p_147153_0_.addCrashSectionCallable("Block type", new Callable()
        {
            ...
            public String call()
            {
                try
                {
                    return String.format("ID #%d (%s // %s)", new Object[] {Integer.valueOf(var6), p_147153_4_.func_149739_a(), p_147153_4_.getClass().getCanonicalName()});
                }
