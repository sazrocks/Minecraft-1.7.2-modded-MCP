...
public class ItemDye extends Item
{
        ...
        else
        {
            ...
            else if (par1ItemStack.getItemDamage() == 3)
            {
                ...
                if (var11 == Blocks.field_150364_r && BlockLog.func_150165_c(var12) == 3)
                {
                    ...
                    {
                        int var13 = Blocks.field_150375_by.func_149660_a(par3World, par4, par5, par6, par7, par8, par9, par10, 0);
                        par3World.func_147465_d(par4, par5, par6, Blocks.field_150375_by, var13, 2);
    ...
    public static boolean func_150919_a(ItemStack p_150919_0_, World p_150919_1_, int p_150919_2_, int p_150919_3_, int p_150919_4_)
    {
        ...
        if (var5 instanceof IGrowable)
        {
            ...
            if (var6.func_149851_a(p_150919_1_, p_150919_2_, p_150919_3_, p_150919_4_, p_150919_1_.isRemote))
            {
    ...
    public static void func_150918_a(World p_150918_0_, int p_150918_1_, int p_150918_2_, int p_150918_3_, int p_150918_4_)
    {
        ...
        if (var5.func_149688_o() != Material.field_151579_a)
        {
            ...
            for (int var6 = 0; var6 < p_150918_4_; ++var6)
            {
                ...
                p_150918_0_.spawnParticle("happyVillager", (double)((float)p_150918_1_ + itemRand.nextFloat()), (double)p_150918_2_ + (double)itemRand.nextFloat() * var5.func_149669_A(), (double)((float)p_150918_3_ + itemRand.nextFloat()), var7, var9, var11);
            }
        }
    }
