...
public class ItemBlock extends Item
{
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        if (var11 == Blocks.field_150431_aC && (par3World.getBlockMetadata(par4, par5, par6) & 7) < 1)
        {
            par7 = 1;
        }
        ...
        else if (par3World.func_147472_a(this.field_150939_a, par4, par5, par6, false, par7, par2EntityPlayer, par1ItemStack))
        {
            ...
            int var13 = this.field_150939_a.func_149660_a(par3World, par4, par5, par6, par7, par8, par9, par10, var12);

            if (par3World.func_147465_d(par4, par5, par6, this.field_150939_a, var13, 3))
            {
                if (par3World.func_147439_a(par4, par5, par6) == this.field_150939_a)
                {
                    ...
                    this.field_150939_a.func_149714_e(par3World, par4, par5, par6, var13);
                }
