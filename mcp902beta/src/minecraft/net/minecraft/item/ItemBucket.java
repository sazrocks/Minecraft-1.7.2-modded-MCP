...
public class ItemBucket extends Item
{
    ...
    {
        boolean var4 = this.isFull == Blocks.field_150350_a;
        ...
        else
        {
            if (var5.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
            {
                ...
                if (var4)
                {
                    ...
                    Material var9 = par2World.func_147439_a(var6, var7, var8).func_149688_o();
                    int var10 = par2World.getBlockMetadata(var6, var7, var8);

                    if (var9 == Material.field_151586_h && var10 == 0)
                    {
                        par2World.func_147468_f(var6, var7, var8);
                        return this.func_150910_a(par1ItemStack, par3EntityPlayer, Items.field_151131_as);
                    }

                    if (var9 == Material.field_151587_i && var10 == 0)
                    {
                        par2World.func_147468_f(var6, var7, var8);
                        return this.func_150910_a(par1ItemStack, par3EntityPlayer, Items.field_151129_at);
                    }
                }
                else
                {
    ...
    public boolean tryPlaceContainedLiquid(World par1World, int par2, int par3, int par4)
    {
        ...
        {
            Material var5 = par1World.func_147439_a(par2, par3, par4).func_149688_o();
            boolean var6 = !var5.isSolid();

            if (!par1World.func_147437_c(par2, par3, par4) && !var6)
            {
                return false;
            }
            else
            {
                if (par1World.provider.isHellWorld && this.isFull == Blocks.field_150358_i)
                {
