...
public class ItemReed extends Item
{
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            {
                int var12 = this.field_150935_a.func_149660_a(par3World, par4, par5, par6, par7, par8, par9, par10, 0);

                if (par3World.func_147465_d(par4, par5, par6, this.field_150935_a, var12, 3))
                {
                    if (par3World.func_147439_a(par4, par5, par6) == this.field_150935_a)
                    {
                        ...
                        this.field_150935_a.func_149714_e(par3World, par4, par5, par6, var12);
                    }
