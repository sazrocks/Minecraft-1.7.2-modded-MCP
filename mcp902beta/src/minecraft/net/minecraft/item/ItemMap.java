...
public class ItemMap extends ItemMapBase
{
                                    ...
                                    for (var29 = 0; var29 < var4; ++var29)
                                    {
                                        for (int var30 = 0; var30 < var4; ++var30)
                                        {
                                            ...
                                            if (var31 > 1)
                                            {
                                                ...
                                                if (var31 > 0 && var32.func_149688_o().isLiquid())
                                                {
                                                    int var34 = var31 - 1;
                                                    Block var35;
                                                    ...
                                                    while (var34 > 0 && var35.func_149688_o().isLiquid());
                                                }
                                            }
    ...
    public void onCreated(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        {
            MapData var4 = Items.field_151098_aY.getMapData(par1ItemStack, par2World);
            par1ItemStack.setItemDamage(par2World.getUniqueDataId("map"));
