...
public class RecipesMapExtending extends ShapedRecipes
{
    ...
    public boolean matches(InventoryCrafting par1InventoryCrafting, World par2World)
    {
        ...
        else
        {
            ...
            for (int var4 = 0; var4 < par1InventoryCrafting.getSizeInventory() && var3 == null; ++var4)
            {
                ...
                if (var5 != null && var5.getItem() == Items.field_151098_aY)
                {
                    var3 = var5;
                }
            }
            ...
            {
                MapData var6 = Items.field_151098_aY.getMapData(var3, par2World);
    ...
    public ItemStack getCraftingResult(InventoryCrafting par1InventoryCrafting)
    {
        ...
        for (int var3 = 0; var3 < par1InventoryCrafting.getSizeInventory() && var2 == null; ++var3)
        {
            ...
            if (var4 != null && var4.getItem() == Items.field_151098_aY)
            {
                var2 = var4;
            }
        }
