...
public class RecipesMapCloning implements IRecipe
{
    ...
    public boolean matches(InventoryCrafting par1InventoryCrafting, World par2World)
    {
        ...
        for (int var5 = 0; var5 < par1InventoryCrafting.getSizeInventory(); ++var5)
        {
            ...
            if (var6 != null)
            {
                if (var6.getItem() == Items.field_151098_aY)
                {
                    if (var4 != null)
                    {
                        return false;
                ...
                {
                    if (var6.getItem() != Items.field_151148_bJ)
                    {
                        return false;
                    }
    ...
    public ItemStack getCraftingResult(InventoryCrafting par1InventoryCrafting)
    {
        ...
        for (int var4 = 0; var4 < par1InventoryCrafting.getSizeInventory(); ++var4)
        {
            ...
            if (var5 != null)
            {
                if (var5.getItem() == Items.field_151098_aY)
                {
                    if (var3 != null)
                    {
                        return null;
                ...
                {
                    if (var5.getItem() != Items.field_151148_bJ)
                    {
                        return null;
                    }
        ...
        if (var3 != null && var2 >= 1)
        {
            ItemStack var6 = new ItemStack(Items.field_151098_aY, var2 + 1, var3.getItemDamage());
