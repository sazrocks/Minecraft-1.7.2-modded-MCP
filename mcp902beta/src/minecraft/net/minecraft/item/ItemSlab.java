...
public class ItemSlab extends ItemBlock
{
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            {
                if (par3World.checkNoEntityCollision(this.field_150947_d.func_149668_a(par3World, par4, par5, par6)) && par3World.func_147465_d(par4, par5, par6, this.field_150947_d, var13, 3))
                {
    ...
    private boolean func_150946_a(ItemStack p_150946_1_, EntityPlayer p_150946_2_, World p_150946_3_, int p_150946_4_, int p_150946_5_, int p_150946_6_, int p_150946_7_)
    {
        ...
        {
            if (p_150946_3_.checkNoEntityCollision(this.field_150947_d.func_149668_a(p_150946_3_, p_150946_4_, p_150946_5_, p_150946_6_)) && p_150946_3_.func_147465_d(p_150946_4_, p_150946_5_, p_150946_6_, this.field_150947_d, var10, 3))
            {
