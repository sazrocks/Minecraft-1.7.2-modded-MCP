    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            if (var11 == Blocks.field_150431_aC)
            {
                ...
                if (var13 <= 6 && par3World.checkNoEntityCollision(this.field_150939_a.func_149668_a(par3World, par4, par5, par6)) && par3World.setBlockMetadataWithNotify(par4, par5, par6, var13 + 1 | var12 & -8, 2))
                {
