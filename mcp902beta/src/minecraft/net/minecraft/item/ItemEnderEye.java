...
public class ItemEnderEye extends Item
{
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        if (par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack) && var11 == Blocks.field_150378_br && !BlockEndPortalFrame.func_150020_b(var12))
        {
            ...
            else
            {
                ...
                par3World.func_147453_f(par4, par5, par6, Blocks.field_150378_br);
                ...
                for (var19 = -2; var19 <= 2; ++var19)
                {
                    ...
                    if (par3World.func_147439_a(var29, par5, var21) == Blocks.field_150378_br)
                    {
                ...
                if (var17 && var15 == var26 + 2)
                {
                    for (var19 = var26; var19 <= var15; ++var19)
                    {
                        ...
                        if (par3World.func_147439_a(var29, par5, var21) != Blocks.field_150378_br || !BlockEndPortalFrame.func_150020_b(par3World.getBlockMetadata(var29, par5, var21)))
                        {
                            var17 = false;
                            break;
                        }
                    ...
                    for (var19 = var26 - 1; var19 <= var15 + 1; var19 += 4)
                    {
                        for (var29 = 1; var29 <= 3; ++var29)
                        {
                            ...
                            if (par3World.func_147439_a(var21, par5, var30) != Blocks.field_150378_br || !BlockEndPortalFrame.func_150020_b(par3World.getBlockMetadata(var21, par5, var30)))
                            {
                                var17 = false;
                                break;
                            }
                    ...
                    if (var17)
                    {
                        for (var19 = var26; var19 <= var15; ++var19)
                        {
                            for (var29 = 1; var29 <= 3; ++var29)
                            {
                                ...
                                var21 += Direction.offsetX[var13] * var29;
                                var30 += Direction.offsetZ[var13] * var29;
                                par3World.func_147465_d(var21, par5, var30, Blocks.field_150384_bq, 0, 2);
                            }
                        }
                    }
                }
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (var4 != null && var4.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && par2World.func_147439_a(var4.blockX, var4.blockY, var4.blockZ) == Blocks.field_150378_br)
        {
        ...
        else
        {
            ...
            {
                ChunkPosition var5 = par2World.func_147440_b("Stronghold", (int)par3EntityPlayer.posX, (int)par3EntityPlayer.posY, (int)par3EntityPlayer.posZ);
