...
public final class ItemStack
{
            ...
            if (this.isItemStackDamageable())
            {
                if (this.attemptDamageItem(par1, par2EntityLivingBase.getRNG()))
                {
                    ...
                    if (par2EntityLivingBase instanceof EntityPlayer)
                    {
                        ...
                        var3.addStat(StatList.objectBreakStats[Item.func_150891_b(this.field_151002_e)], 1);
    ...
    public List getTooltip(EntityPlayer par1EntityPlayer, boolean par2)
    {
        ...
        else if (!this.hasDisplayName() && this.field_151002_e == Items.field_151098_aY)
        {
        ...
        if (this.hasTagCompound())
        {
            ...
            if (var13 != null)
            {
                ...
                {
                    short var7 = var13.func_150305_b(var6).getShort("id");
                    short var8 = var13.func_150305_b(var6).getShort("lvl");
    ...
    public void addEnchantment(Enchantment par1Enchantment, int par2)
    {
        ...
        NBTTagList var3 = this.stackTagCompound.func_150295_c("ench", 10);
    ...
    public Multimap getAttributeModifiers()
    {
        ...
        if (this.hasTagCompound() && this.stackTagCompound.func_150297_b("AttributeModifiers", 9))
        {
            ...
            NBTTagList var2 = this.stackTagCompound.func_150295_c("AttributeModifiers", 10);
    ...
    {
        IChatComponent var1 = (new ChatComponentText("[")).func_150258_a(this.getDisplayName()).func_150258_a("]");
        ...
        if (this.field_151002_e != null)
        {
            ...
            var1.func_150256_b().func_150238_a(this.getRarity().rarityColor);
        }
