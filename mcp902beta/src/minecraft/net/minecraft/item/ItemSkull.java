...
public class ItemSkull extends Item
{
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            else if (!Blocks.field_150465_bP.func_149742_c(par3World, par4, par5, par6))
            {
                return false;
            }
            else
            {
                par3World.func_147465_d(par4, par5, par6, Blocks.field_150465_bP, par7, 2);
                int var11 = 0;
                ...
                TileEntity var12 = par3World.func_147438_o(par4, par5, par6);
                ...
                if (var12 != null && var12 instanceof TileEntitySkull)
                {
                    ...
                    ((BlockSkull)Blocks.field_150465_bP).func_149965_a(par3World, par4, par5, par6, (TileEntitySkull)var12);
                }
