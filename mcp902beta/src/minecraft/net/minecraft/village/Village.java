...
public class Village
{
        ...
        else
        {
            ...
            for (int var9 = var7; var9 < var7 + par4; ++var9)
            {
                for (int var10 = par2; var10 < par2 + par5; ++var10)
                {
                    ...
                    {
                        if (this.worldObj.func_147439_a(var9, var10, var11).func_149721_r())
                        {
                            return false;
                        }
                    }
    ...
    public void readVillageDataFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        NBTTagList var2 = par1NBTTagCompound.func_150295_c("Doors", 10);
        ...
        NBTTagList var6 = par1NBTTagCompound.func_150295_c("Players", 10);
