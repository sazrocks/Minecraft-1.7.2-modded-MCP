...
public class CombatTracker
{
    ...
    public void func_94545_a()
    {
        ...
        {
            Block var1 = this.fighter.worldObj.func_147439_a(MathHelper.floor_double(this.fighter.posX), MathHelper.floor_double(this.fighter.boundingBox.minY), MathHelper.floor_double(this.fighter.posZ));
