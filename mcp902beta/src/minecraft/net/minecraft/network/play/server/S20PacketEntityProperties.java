...
public class S20PacketEntityProperties extends Packet
{
    ...
    public S20PacketEntityProperties(int p_i45236_1_, Collection p_i45236_2_)
    {
        ...
        while (var3.hasNext())
        {
            ...
            this.field_149444_b.add(new S20PacketEntityProperties.Snapshot(var4.func_111123_a().getAttributeUnlocalizedName(), var4.getBaseValue(), var4.func_111122_c()));
        }
    }
    ...
    public void func_148840_b(PacketBuffer p_148840_1_) throws IOException
    {
        ...
        while (var2.hasNext())
        {
            ...
            p_148840_1_.func_150785_a(var3.func_151409_a());
