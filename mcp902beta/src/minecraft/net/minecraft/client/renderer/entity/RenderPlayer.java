...
public class RenderPlayer extends RendererLivingEntity
{
    ...
    protected void renderEquippedItems(AbstractClientPlayer par1AbstractClientPlayer, float par2)
    {
        ...
        if (var3 != null)
        {
            ...
            {
                if (RenderBlocks.func_147739_a(Block.func_149634_a(var3.getItem()).func_149645_b()))
                {
                    var4 = 0.625F;
            ...
            else if (var3.getItem() == Items.field_151144_bL)
            {
                var4 = 1.0625F;
                GL11.glScalef(var4, -var4, -var4);
                String var5 = "";
        ...
        if (var25 != null)
        {
            ...
            if (var25.getItem() instanceof ItemBlock && RenderBlocks.func_147739_a(Block.func_149634_a(var25.getItem()).func_149645_b()))
            {
                var7 = 0.5F;
            ...
            else if (var25.getItem() == Items.field_151031_f)
            {
                var7 = 0.625F;
