...
public class RenderWitch extends RenderLiving
{
    ...
    protected void renderEquippedItems(EntityWitch par1EntityWitch, float par2)
    {
        ...
        if (var3 != null)
        {
            ...
            if (var3.getItem() instanceof ItemBlock && RenderBlocks.func_147739_a(Block.func_149634_a(var3.getItem()).func_149645_b()))
            {
                var4 = 0.5F;
            ...
            else if (var3.getItem() == Items.field_151031_f)
            {
                var4 = 0.625F;
