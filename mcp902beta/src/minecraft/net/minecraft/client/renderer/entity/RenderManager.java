...
public class RenderManager
{
    ...
    private RenderManager()
    {
        ...
        this.entityRenderMap.put(EntityArrowAccurate.class, new RenderArrowAccurate());
        this.entityRenderMap.put(EntitySnowball.class, new RenderSnowball(Items.field_151126_ay));
        this.entityRenderMap.put(EntityEnderPearl.class, new RenderSnowball(Items.field_151079_bi));
        this.entityRenderMap.put(EntityEnderEye.class, new RenderSnowball(Items.field_151061_bv));
        this.entityRenderMap.put(EntityEgg.class, new RenderSnowball(Items.field_151110_aK));
        this.entityRenderMap.put(EntityPotion.class, new RenderSnowball(Items.field_151068_bn, 16384));
        this.entityRenderMap.put(EntityExpBottle.class, new RenderSnowball(Items.field_151062_by));
        this.entityRenderMap.put(EntityFireworkRocket.class, new RenderSnowball(Items.field_151152_bP));
    ...
    public void func_147938_a(World p_147938_1_, TextureManager p_147938_2_, FontRenderer p_147938_3_, EntityLivingBase p_147938_4_, Entity p_147938_5_, GameSettings p_147938_6_, float p_147938_7_)
    {
        ...
        {
            Block var8 = p_147938_1_.func_147439_a(MathHelper.floor_double(p_147938_4_.posX), MathHelper.floor_double(p_147938_4_.posY), MathHelper.floor_double(p_147938_4_.posZ));
