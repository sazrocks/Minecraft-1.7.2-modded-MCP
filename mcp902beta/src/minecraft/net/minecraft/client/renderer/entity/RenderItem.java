...
public class RenderItem extends Render
{
    ...
    public void doRender(EntityItem par1EntityItem, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        if (var10.getItem() != null)
        {
            ...
            if (var10.getItemSpriteNumber() == 0 && var10.getItem() instanceof ItemBlock && RenderBlocks.func_147739_a(Block.func_149634_a(var10.getItem()).func_149645_b()))
            {
                Block var22 = Block.func_149634_a(var10.getItem());
                ...
                for (int var26 = 0; var26 < var13; ++var26)
                {
                    ...
                    this.field_147913_i.func_147800_a(var22, var10.getItemDamage(), 1.0F);
                    GL11.glPopMatrix();
                }
    ...
    public void renderItemIntoGUI(FontRenderer par1FontRenderer, TextureManager par2TextureManager, ItemStack par3ItemStack, int par4, int par5)
    {
        ...
        if (par3ItemStack.getItemSpriteNumber() == 0 && RenderBlocks.func_147739_a(Block.func_149634_a(par3ItemStack.getItem()).func_149645_b()))
        {
            ...
            Block var16 = Block.func_149634_a(par3ItemStack.getItem());
            GL11.glPushMatrix();
