...
public class RenderArrowAccurate extends Render
{
     ...
     */
    public void doRender(EntityArrowAccurate par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityArrowAccurate par1EntityArrow)
    {
    ...
    {
        return this.getEntityTexture((EntityArrowAccurate)par1Entity);
    }
    ...
    {
        this.doRender((EntityArrowAccurate)par1Entity, par2, par4, par6, par8, par9);
    }
}
