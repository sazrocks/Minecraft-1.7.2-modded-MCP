...
public abstract class RendererLivingEntity extends Render
{
    ...
    protected void rotateCorpse(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4)
    {
        ...
        {
            String var6 = EnumChatFormatting.func_110646_a(par1EntityLivingBase.getCommandSenderName());
    ...
    protected void renderArrowsStuckInEntity(EntityLivingBase par1EntityLivingBase, float par2)
    {
        ...
        if (var3 > 0)
        {
            ...
            Random var5 = new Random((long)par1EntityLivingBase.func_145782_y());
    ...
    protected void passSpecialRender(EntityLivingBase par1EntityLivingBase, double par2, double par4, double par6)
    {
        ...
        if (this.func_110813_b(par1EntityLivingBase))
        {
            ...
            {
                String var13 = par1EntityLivingBase.func_145748_c_().func_150254_d();
