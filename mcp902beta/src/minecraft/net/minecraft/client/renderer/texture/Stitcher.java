...
public class Stitcher
{
    ...
    {
        Stitcher.Holder var2 = new Stitcher.Holder(par1TextureAtlasSprite, this.field_147971_a);
    ...
    private boolean expandAndAllocateSlot(Stitcher.Holder par1StitchHolder)
    {
        ...
        if (this.forcePowerOf2)
        {
            var5 = MathHelper.func_151236_b(this.currentWidth);
            int var6 = MathHelper.func_151236_b(this.currentHeight);
            int var7 = MathHelper.func_151236_b(this.currentWidth + var2);
            int var8 = MathHelper.func_151236_b(this.currentHeight + var2);
        ...
        if (MathHelper.func_151236_b((var4 ? this.currentHeight : this.currentWidth) + var5) > (var4 ? this.maxHeight : this.maxWidth))
        {
            return false;
        }
        else
