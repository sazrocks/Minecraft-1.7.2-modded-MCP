...
public class RenderItemFrame extends Render
{
    ...
    public void doRender(EntityItemFrame par1EntityItemFrame, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        if (par1EntityItemFrame.getDisplayedItem() != null && par1EntityItemFrame.getDisplayedItem().getItem() == Items.field_151098_aY)
        {
    ...
    private void func_82402_b(EntityItemFrame par1EntityItemFrame)
    {
        ...
        if (var2 != null)
        {
            ...
            if (var4 == Items.field_151098_aY)
            {
                ...
                MapData var7 = Items.field_151098_aY.getMapData(var3.getEntityItem(), par1EntityItemFrame.worldObj);
                GL11.glTranslatef(0.0F, 0.0F, -1.0F);

                if (var7 != null)
                {
                    this.field_147917_g.entityRenderer.func_147701_i().func_148250_a(var7, true);
                }
            }
            else
            {
                if (var4 == Items.field_151111_aL)
                {
                    ...
                    TextureAtlasSprite var14 = ((TextureMap)var12.getTexture(TextureMap.locationItemsTexture)).getAtlasSprite(Items.field_151111_aL.getIconIndex(var3.getEntityItem()).getIconName());
                ...
                if (var4 == Items.field_151111_aL)
                {
                    TextureAtlasSprite var13 = ((TextureMap)Minecraft.getMinecraft().getTextureManager().getTexture(TextureMap.locationItemsTexture)).getAtlasSprite(Items.field_151111_aL.getIconIndex(var3.getEntityItem()).getIconName());
