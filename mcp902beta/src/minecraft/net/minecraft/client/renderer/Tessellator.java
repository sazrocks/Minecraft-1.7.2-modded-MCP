...
public class Tessellator
{
    ...
    public TesselatorVertexState func_147564_a(float p_147564_1_, float p_147564_2_, float p_147564_3_)
    {
        ...
        PriorityQueue var5 = new PriorityQueue(this.field_147569_p, new QuadComparator(this.rawBuffer, p_147564_1_ + (float)this.xOffset, p_147564_2_ + (float)this.yOffset, p_147564_3_ + (float)this.zOffset));
        byte var6 = 32;
        int var7;
        ...
        return new TesselatorVertexState(var4, this.field_147569_p, this.vertexCount, this.hasTexture, this.hasBrightness, this.hasNormals, this.hasColor);
    }
