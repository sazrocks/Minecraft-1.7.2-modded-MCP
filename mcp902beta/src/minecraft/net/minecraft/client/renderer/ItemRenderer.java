...
public class ItemRenderer
{
    ...
    public void renderItem(EntityLivingBase par1EntityLivingBase, ItemStack par2ItemStack, int par3)
    {
        ...
        if (par2ItemStack.getItemSpriteNumber() == 0 && var5 instanceof ItemBlock && RenderBlocks.func_147739_a(var6.func_149645_b()))
        {
            ...
            if (par2ItemStack != null && par2ItemStack.getItem() instanceof ItemCloth)
            {
                ...
                this.field_147720_h.func_147800_a(var6, par2ItemStack.getItemDamage(), 1.0F);
    ...
    public void renderItemInFirstPerson(float par1)
    {
        ...
        if (var8 != null && var8.getItem() == Items.field_151098_aY)
        {
            GL11.glPushMatrix();
            var22 = 0.8F;
            ...
            var30.draw();
            MapData var21 = Items.field_151098_aY.getMapData(var8, this.mc.theWorld);

            if (var21 != null)
            {
                this.mc.entityRenderer.func_147701_i().func_148250_a(var21, false);
            }
    ...
    public void renderOverlays(float par1)
    {
        ...
        if (this.mc.thePlayer.isEntityInsideOpaqueBlock())
        {
            ...
            Block var5 = this.mc.theWorld.func_147439_a(var2, var3, var4);

            if (this.mc.theWorld.func_147439_a(var2, var3, var4).func_149721_r())
            {
                this.renderInsideOfBlock(par1, var5.func_149733_h(2));
            }
            else
            {
                for (int var6 = 0; var6 < 8; ++var6)
                {
                    ...
                    if (this.mc.theWorld.func_147439_a(var10, var11, var12).func_149721_r())
                    {
                        var5 = this.mc.theWorld.func_147439_a(var10, var11, var12);
                    }
                }
            }
