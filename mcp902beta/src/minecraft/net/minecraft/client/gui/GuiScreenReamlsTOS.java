...
public class GuiScreenReamlsTOS extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.field_146292_n.add(this.field_146774_h = new GuiButton(1, var1, this.field_146295_m / 5 + 96 + 22, var2, 20, I18n.getStringParams("mco.terms.buttons.agree", new Object[0])));
        this.field_146292_n.add(new GuiButton(2, var3, this.field_146295_m / 5 + 96 + 22, var2, 20, I18n.getStringParams("mco.terms.buttons.disagree", new Object[0])));
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        int var4 = this.field_146289_q.getStringWidth(I18n.getStringParams("mco.terms.sentence.1", new Object[0]));
        int var5 = 3368635;
        int var6 = 7107012;
        int var7 = this.field_146294_l / 2 - 121 + var4;
        byte var8 = 86;
        int var9 = var7 + this.field_146289_q.getStringWidth("mco.terms.sentence.2") + 1;
        int var10 = 87 + this.field_146289_q.FONT_HEIGHT;

        if (var7 <= par1 && par1 <= var9 && var8 <= par2 && par2 <= var10)
        {
            this.field_146775_i = true;
            this.drawString(this.field_146289_q, " " + I18n.getStringParams("mco.terms.sentence.2", new Object[0]), this.field_146294_l / 2 - 120 + var4, 87, var6);
        }
        else
        {
            this.field_146775_i = false;
            this.drawString(this.field_146289_q, " " + I18n.getStringParams("mco.terms.sentence.2", new Object[0]), this.field_146294_l / 2 - 120 + var4, 87, var5);
        }
