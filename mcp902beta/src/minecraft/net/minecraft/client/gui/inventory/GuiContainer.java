...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        InventoryPlayer var15 = this.field_146297_k.thePlayer.inventory;
    ...
    private void func_146977_a(Slot p_146977_1_)
    {
        ...
        ItemStack var7 = this.field_146297_k.thePlayer.inventory.getItemStack();
        String var8 = null;
        ...
        if (!var6)
        {
            ...
            GL11.glEnable(GL11.GL_DEPTH_TEST);
            field_146296_j.renderItemAndEffectIntoGUI(this.field_146289_q, this.field_146297_k.getTextureManager(), var4, var2, var3);
            field_146296_j.renderItemOverlayIntoGUI(this.field_146289_q, this.field_146297_k.getTextureManager(), var4, var2, var3, var8);
        }
    ...
    {
        ItemStack var1 = this.field_146297_k.thePlayer.inventory.getItemStack();
    ...
    protected void mouseClicked(int par1, int par2, int par3)
    {
        ...
        boolean var4 = par3 == this.field_146297_k.gameSettings.keyBindPickBlock.func_151463_i() + 100;
        ...
        if (par3 == 0 || par3 == 1 || var4)
        {
            ...
            if (this.field_146297_k.gameSettings.touchscreen && var10 && this.field_146297_k.thePlayer.inventory.getItemStack() == null)
            {
            ...
            if (func_146272_n())
            {
                if (var4 != null && var4.inventory != null && this.field_146994_N != null)
                {
                    ...
                    while (var11.hasNext())
                    {
                        ...
                        if (var10 != null && var10.canTakeStack(this.field_146297_k.thePlayer) && var10.getHasStack() && var10.inventory == var4.inventory && Container.func_94527_a(var10, this.field_146994_N, true))
                        {
    ...
    protected boolean func_146983_a(int p_146983_1_)
    {
        if (this.field_146297_k.thePlayer.inventory.getItemStack() == null && this.field_147006_u != null)
        {
            ...
            {
                if (p_146983_1_ == this.field_146297_k.gameSettings.field_151456_ac[var2].func_151463_i())
                {
