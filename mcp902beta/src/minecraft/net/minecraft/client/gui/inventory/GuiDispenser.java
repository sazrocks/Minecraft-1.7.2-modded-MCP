...
public class GuiDispenser extends GuiContainer
{
    ...
    {
        String var3 = this.field_147089_u.func_145818_k_() ? this.field_147089_u.func_145825_b() : I18n.getStringParams(this.field_147089_u.func_145825_b(), new Object[0]);
        this.field_146289_q.drawString(var3, this.field_146999_f / 2 - this.field_146289_q.getStringWidth(var3) / 2, 6, 4210752);
