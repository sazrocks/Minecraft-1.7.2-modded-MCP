...
public class GuiScreenPendingInvitation extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        (new Thread("MCO List Invites #" + field_146732_a.incrementAndGet())
        {
            ...
            public void run()
            {
                Session var1 = GuiScreenPendingInvitation.this.field_146297_k.getSession();
    ...
    class List extends GuiScreenSelectLocation
    {
        ...
        private void func_148382_b(int p_148382_1_, int p_148382_2_, int p_148382_3_, int p_148382_4_, Tessellator p_148382_5_)
        {
            ...
            GuiScreenPendingInvitation.this.drawString(GuiScreenPendingInvitation.this.field_146289_q, var6.field_148774_b, p_148382_2_ + 2, p_148382_3_ + 1, 16777215);
            GuiScreenPendingInvitation.this.drawString(GuiScreenPendingInvitation.this.field_146289_q, var6.field_148775_c, p_148382_2_ + 2, p_148382_3_ + 12, 7105644);
        }
    }
}
