...
public class GuiScreenResetWorld extends ScreenWithCallback
{
    ...
    protected void func_146284_a(GuiButton p_146284_1_)
    {
        if (p_146284_1_.field_146124_l)
        {
            ...
            {
                String var2 = I18n.getStringParams("mco.configure.world.reset.question.line1", new Object[0]);
                String var3 = I18n.getStringParams("mco.configure.world.reset.question.line2", new Object[0]);
    ...
    class ResetWorldTask extends TaskLongRunning
    {
        ...
        public void run()
        {
            Session var1 = GuiScreenResetWorld.this.field_146297_k.getSession();
            McoClient var2 = new McoClient(var1.getSessionID(), var1.getUsername(), "1.7.2", Minecraft.getMinecraft().getProxy());
            String var3 = I18n.getStringParams("mco.reset.world.resetting.screen.title", new Object[0]);
