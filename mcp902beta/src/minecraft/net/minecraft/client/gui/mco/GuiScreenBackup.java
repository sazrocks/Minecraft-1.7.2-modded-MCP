...
public class GuiScreenBackup extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        (new Thread("MCO Backup Requester #" + field_146845_a.incrementAndGet())
        {
            ...
            public void run()
            {
                Session var1 = GuiScreenBackup.this.field_146297_k.getSession();
    ...
    private void func_146827_i()
    {
        if (this.field_146843_s >= 0 && this.field_146843_s < this.field_146847_i.size())
        {
            ...
            String var4 = I18n.getStringParams("mco.configure.world.restore.question.line1", new Object[0]) + " \'" + var2 + "\' (" + var3 + ")";
            String var5 = I18n.getStringParams("mco.configure.world.restore.question.line2", new Object[0]);
    ...
    {
        String var1 = I18n.getStringParams("mco.configure.world.restore.download.question.line1", new Object[0]);
        String var2 = I18n.getStringParams("mco.configure.world.restore.download.question.line2", new Object[0]);
    ...
    class SelectionList extends GuiScreenSelectLocation
    {
        ...
        private void func_148385_b(int p_148385_1_, int p_148385_2_, int p_148385_3_, int p_148385_4_, Tessellator p_148385_5_)
        {
            ...
            GuiScreenBackup.this.drawString(GuiScreenBackup.this.field_146289_q, "Backup (" + GuiScreenBackup.this.func_146829_a(Long.valueOf(MinecraftServer.getSystemTimeMillis() - var6.field_148778_b.getTime())) + ")", p_148385_2_ + 2, p_148385_3_ + 1, 16777215);
            GuiScreenBackup.this.drawString(GuiScreenBackup.this.field_146289_q, this.func_148384_a(var6.field_148778_b), p_148385_2_ + 2, p_148385_3_ + 12, 7105644);
        }
