...
public class GuiSnooper extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        String var1 = I18n.getStringParams("options.snooper.desc", new Object[0]);
        ArrayList var2 = new ArrayList();
        Iterator var3 = this.field_146289_q.listFormattedStringToWidth(var1, this.field_146294_l - 30).iterator();
        ...
        boolean var6 = this.field_146297_k.getIntegratedServer() != null && this.field_146297_k.getIntegratedServer().getPlayerUsageSnooper() != null;
        Iterator var7 = (new TreeMap(this.field_146297_k.getPlayerUsageSnooper().getCurrentStats())).entrySet().iterator();
        Entry var5;
        ...
        while (var7.hasNext())
        {
            ...
            this.field_146609_h.add(this.field_146289_q.trimStringToWidth((String)var5.getValue(), this.field_146294_l - 220));
        }

        if (var6)
        {
            var7 = (new TreeMap(this.field_146297_k.getIntegratedServer().getPlayerUsageSnooper().getCurrentStats())).entrySet().iterator();
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        for (int var7 = 0; var7 < var6; ++var7)
        {
            ...
            this.drawCenteredString(this.field_146289_q, var8, this.field_146294_l / 2, var4, 8421504);
            var4 += this.field_146289_q.FONT_HEIGHT;
        }
