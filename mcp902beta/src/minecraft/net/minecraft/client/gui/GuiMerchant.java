...
public class GuiMerchant extends GuiContainer
{
    ...
    {
        super.updateScreen();
        MerchantRecipeList var1 = this.field_147037_w.getRecipes(this.field_146297_k.thePlayer);
    ...
    protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_)
    {
        ...
        MerchantRecipeList var6 = this.field_147037_w.getRecipes(this.field_146297_k.thePlayer);
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        MerchantRecipeList var4 = this.field_147037_w.getRecipes(this.field_146297_k.thePlayer);
        ...
        if (var4 != null && !var4.isEmpty())
        {
            ...
            field_146296_j.renderItemAndEffectIntoGUI(this.field_146289_q, this.field_146297_k.getTextureManager(), var9, var5 + 36, var6 + 24);
            field_146296_j.renderItemOverlayIntoGUI(this.field_146289_q, this.field_146297_k.getTextureManager(), var9, var5 + 36, var6 + 24);

            if (var10 != null)
            {
                field_146296_j.renderItemAndEffectIntoGUI(this.field_146289_q, this.field_146297_k.getTextureManager(), var10, var5 + 62, var6 + 24);
                field_146296_j.renderItemOverlayIntoGUI(this.field_146289_q, this.field_146297_k.getTextureManager(), var10, var5 + 62, var6 + 24);
            }

            field_146296_j.renderItemAndEffectIntoGUI(this.field_146289_q, this.field_146297_k.getTextureManager(), var11, var5 + 120, var6 + 24);
            field_146296_j.renderItemOverlayIntoGUI(this.field_146289_q, this.field_146297_k.getTextureManager(), var11, var5 + 120, var6 + 24);
