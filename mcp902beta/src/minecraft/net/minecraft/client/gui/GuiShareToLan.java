...
public class GuiShareToLan extends GuiScreen
{
    ...
    protected void func_146284_a(GuiButton p_146284_1_)
    {
        ...
        else if (p_146284_1_.field_146127_k == 101)
        {
            ...
            String var2 = this.field_146297_k.getIntegratedServer().shareToLAN(WorldSettings.GameType.getByName(this.field_146599_h), this.field_146600_i);
            Object var3;
            ...
            this.field_146297_k.ingameGUI.func_146158_b().func_146227_a((IChatComponent)var3);
        }
    }
