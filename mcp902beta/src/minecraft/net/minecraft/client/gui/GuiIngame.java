...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if (this.mc.gameSettings.thirdPersonView == 0 && var9 != null && var9.getItem() == Item.func_150898_a(Blocks.field_150423_aK))
        {
        ...
        if (this.mc.isDemo())
        {
            ...
            {
                var36 = I18n.getStringParams("demo.demoExpired", new Object[0]);
            }
            else
            {
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
            ...
            {
                this.drawString(var8, String.format("shader: %s", new Object[] {this.mc.entityRenderer.func_147706_e().func_148022_b()}), 2, 112, 14737632);
            }
        ...
        if (this.mc.gameSettings.keyBindPlayerList.func_151470_d() && (!this.mc.isIntegratedServerRunning() || this.mc.thePlayer.sendQueue.field_147303_b.size() > 1 || var40 != null))
        {
