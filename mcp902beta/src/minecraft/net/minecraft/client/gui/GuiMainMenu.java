...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.func_130020_g();
        this.field_146292_n.add(new GuiButton(0, this.field_146294_l / 2 - 100, var3 + 72 + 12, 98, 20, I18n.getStringParams("menu.options", new Object[0])));
        this.field_146292_n.add(new GuiButton(4, this.field_146294_l / 2 + 2, var3 + 72 + 12, 98, 20, I18n.getStringParams("menu.quit", new Object[0])));
        ...
        if (this.field_96141_q)
        {
            if (!field_96140_r)
            {
                ...
                (new Thread("MCO Availability Checker #" + field_146973_f.incrementAndGet())
                {
                    ...
                    public void run()
                    {
                        Session var1 = GuiMainMenu.this.field_146297_k.getSession();
    ...
    private void addSingleplayerMultiplayerButtons(int par1, int par2)
    {
        ...
        this.field_146292_n.add(this.minecraftRealmsButton = new GuiButton(14, this.field_146294_l / 2 - 100, par1 + par2 * 2, I18n.getStringParams("menu.online", new Object[0])));
    ...
    public void confirmClicked(boolean par1, int par2)
    {
        if (par1 && par2 == 12)
        {
            ISaveFormat var6 = this.field_146297_k.getSaveLoader();
            var6.flushCache();
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        var8 = var8 * 100.0F / (float)(this.field_146289_q.getStringWidth(this.splashText) + 32);
        ...
        this.drawString(this.field_146289_q, var9, 2, this.field_146295_m - 10, -1);
        String var10 = "Copyright Mojang AB. Do not distribute!";
        this.drawString(this.field_146289_q, var10, this.field_146294_l - this.field_146289_q.getStringWidth(var10) - 2, this.field_146295_m - 10, -1);
