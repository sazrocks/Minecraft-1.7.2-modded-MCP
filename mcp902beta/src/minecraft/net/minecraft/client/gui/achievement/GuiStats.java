...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    public void func_146541_h()
    {
        ...
        GuiButton var1;
        this.field_146292_n.add(var1 = new GuiButton(2, this.field_146294_l / 2 - 80, this.field_146295_m - 52, 80, 20, I18n.getStringParams("stat.blocksButton", new Object[0])));
        GuiButton var2;
        this.field_146292_n.add(var2 = new GuiButton(3, this.field_146294_l / 2, this.field_146295_m - 52, 80, 20, I18n.getStringParams("stat.itemsButton", new Object[0])));
        GuiButton var3;
        this.field_146292_n.add(var3 = new GuiButton(4, this.field_146294_l / 2 + 80, this.field_146295_m - 52, 80, 20, I18n.getStringParams("stat.mobsButton", new Object[0])));
    ...
    abstract class Stats extends GuiSlot
    {
        ...
        protected void func_148209_a(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_)
        {
            ...
            if (p_148209_1_ != null)
            {
                ...
                GuiStats.this.drawString(GuiStats.this.field_146289_q, var5, p_148209_2_ - GuiStats.this.field_146289_q.getStringWidth(var5), p_148209_3_ + 5, p_148209_4_ ? 16777215 : 9474192);
            }
            else
            {
                var5 = "-";
        ...
        protected void func_148142_b(int p_148142_1_, int p_148142_2_)
        {
            if (p_148142_2_ >= this.field_148153_b && p_148142_2_ <= this.field_148154_c)
            {
                ...
                else
                {
                    ...
                    var9 = ("" + I18n.getStringParams(var9, new Object[0])).trim();

                    if (var9.length() > 0)
                    {
                        int var6 = p_148142_1_ + 12;
                        int var7 = p_148142_2_ - 12;
                        int var8 = GuiStats.this.field_146289_q.getStringWidth(var9);
                        GuiStats.this.drawGradientRect(var6 - 3, var7 - 3, var6 + var8 + 3, var7 + 8 + 3, -1073741824, -1073741824);
                        GuiStats.this.field_146289_q.drawStringWithShadow(var9, var6, var7, -1);
                    }
                }
            }
        }
        ...
        protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_)
        {
            if (p_148213_1_ != null)
            {
                ...
                String var5 = ("" + I18n.getStringParams(var4.getUnlocalizedName() + ".name", new Object[0])).trim();

                if (var5.length() > 0)
                {
                    int var6 = p_148213_2_ + 12;
                    int var7 = p_148213_3_ - 12;
                    int var8 = GuiStats.this.field_146289_q.getStringWidth(var5);
                    GuiStats.this.drawGradientRect(var6 - 3, var7 - 3, var6 + var8 + 3, var7 + 8 + 3, -1073741824, -1073741824);
                    GuiStats.this.field_146289_q.drawStringWithShadow(var5, var6, var7, -1);
                }
            }
        }
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        protected void func_148126_a(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_, Tessellator p_148126_5_, int p_148126_6_, int p_148126_7_)
        {
            ...
            String var9 = I18n.getStringParams("entity." + EntityList.getStringFromID(var8.spawnedID) + ".name", new Object[0]);
            ...
            String var12 = I18n.getStringParams("stat.entityKills", new Object[] {Integer.valueOf(var10), var9});
            String var13 = I18n.getStringParams("stat.entityKilledBy", new Object[] {var9, Integer.valueOf(var11)});

            if (var10 == 0)
            {
                var12 = I18n.getStringParams("stat.entityKills.none", new Object[] {var9});
            }

            if (var11 == 0)
            {
                var13 = I18n.getStringParams("stat.entityKilledBy.none", new Object[] {var9});
            }

            GuiStats.this.drawString(GuiStats.this.field_146289_q, var9, p_148126_2_ + 2 - 10, p_148126_3_ + 1, 16777215);
            GuiStats.this.drawString(GuiStats.this.field_146289_q, var12, p_148126_2_ + 2, p_148126_3_ + 1 + GuiStats.this.field_146289_q.FONT_HEIGHT, var10 == 0 ? 6316128 : 9474192);
            GuiStats.this.drawString(GuiStats.this.field_146289_q, var13, p_148126_2_ + 2, p_148126_3_ + 1 + GuiStats.this.field_146289_q.FONT_HEIGHT * 2, var11 == 0 ? 6316128 : 9474192);
        }
    }
    ...
    class StatsGeneral extends GuiSlot
    {
        ...
        protected void func_148126_a(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_, Tessellator p_148126_5_, int p_148126_6_, int p_148126_7_)
        {
            ...
            GuiStats.this.drawString(GuiStats.this.field_146289_q, var8.func_150951_e().func_150260_c(), p_148126_2_ + 2, p_148126_3_ + 1, p_148126_1_ % 2 == 0 ? 16777215 : 9474192);
            String var9 = var8.func_75968_a(GuiStats.this.field_146546_t.writeStat(var8));
            GuiStats.this.drawString(GuiStats.this.field_146289_q, var9, p_148126_2_ + 2 + 213 - GuiStats.this.field_146289_q.getStringWidth(var9), p_148126_3_ + 1, p_148126_1_ % 2 == 0 ? 16777215 : 9474192);
        }
    }
}
