...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    protected void func_146553_h()
    {
        ...
        this.field_146289_q.drawString("Achievements", var1 + 15, var2 + 5, 4210752);
    }
    ...
    protected void func_146552_b(int p_146552_1_, int p_146552_2_, float p_146552_3_)
    {
        ...
        for (var22 = 0; (float)var22 * var20 - (float)var13 < 155.0F; ++var22)
        {
            ...
            {
                var19.setSeed((long)(this.field_146297_k.getSession().func_148255_b().hashCode() + var10 + var24 + (var11 + var22) * 16));
        ...
        for (var42 = 0; var42 < AchievementList.achievementList.size(); ++var42)
        {
            ...
            if (var41 >= -24 && var43 >= -24 && (float)var41 <= 224.0F * this.field_146570_r && (float)var43 <= 155.0F * this.field_146570_r)
            {
                ...
                var36.renderItemAndEffectIntoGUI(this.field_146297_k.fontRenderer, this.field_146297_k.getTextureManager(), var39.theItemStack, var41 + 3, var43 + 3);
        ...
        if (var34 != null)
        {
            ...
            if (!this.field_146556_E.canUnlockAchievement(var34))
            {
                ...
                if (var30 == 3)
                {
                    var44 = I18n.getStringParams("achievement.unknown", new Object[0]);
                    var31 = Math.max(this.field_146289_q.getStringWidth(var44), 120);
                    var32 = (new ChatComponentTranslation("achievement.requires", new Object[] {var34.parentAchievement.func_150951_e()})).func_150260_c();
                    var33 = this.field_146289_q.splitStringWidth(var32, var31);
                    this.drawGradientRect(var41 - 3, var43 - 3, var41 + var31 + 3, var43 + var33 + 12 + 3, -1073741824, -1073741824);
                    this.field_146289_q.drawSplitString(var32, var41, var43 + 12, var31, -9416624);
                }
                else if (var30 < 3)
                {
                    var31 = Math.max(this.field_146289_q.getStringWidth(var44), 120);
            ...
            {
                var31 = Math.max(this.field_146289_q.getStringWidth(var44), 120);
                int var46 = this.field_146289_q.splitStringWidth(var40, var31);
                ...
                this.field_146289_q.drawSplitString(var40, var41, var43 + 12, var31, -6250336);

                if (this.field_146556_E.hasAchievementUnlocked(var34))
                {
                    this.field_146289_q.drawStringWithShadow(I18n.getStringParams("achievement.taken", new Object[0]), var41, var43 + var46 + 4, -7302913);
                }
            }

            if (var44 != null)
            {
                this.field_146289_q.drawStringWithShadow(var44, var41, var43, this.field_146556_E.canUnlockAchievement(var34) ? (var34.getSpecial() ? -128 : -1) : (var34.getSpecial() ? -8355776 : -8355712));
            }
        }
