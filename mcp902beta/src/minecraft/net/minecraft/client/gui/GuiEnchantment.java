...
public class GuiEnchantment extends GuiContainer
{
    ...
    protected void mouseClicked(int par1, int par2, int par3)
    {
        ...
        for (int var6 = 0; var6 < 3; ++var6)
        {
            ...
            if (var7 >= 0 && var8 >= 0 && var7 < 108 && var8 < 19 && this.field_147075_G.enchantItem(this.field_146297_k.thePlayer, var6))
            {
                this.field_146297_k.playerController.sendEnchantPacket(this.field_147075_G.windowId, var6);
            }
        }
    }
    ...
    protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_)
    {
        ...
        GL11.glPushMatrix();
        GL11.glLoadIdentity();
        ScaledResolution var6 = new ScaledResolution(this.field_146297_k.gameSettings, this.field_146297_k.displayWidth, this.field_146297_k.displayHeight);
        ...
        for (int var12 = 0; var12 < 3; ++var12)
        {
            ...
            {
                String var15 = "" + var14;
                FontRenderer var16 = this.field_146297_k.standardGalacticFontRenderer;
                int var17 = 6839882;

                if (this.field_146297_k.thePlayer.experienceLevel < var14 && !this.field_146297_k.thePlayer.capabilities.isCreativeMode)
                {
                    this.drawTexturedModalRect(var4 + 60, var5 + 14 + 19 * var12, 0, 185, 108, 19);
                    var16.drawSplitString(var13, var4 + 62, var5 + 16 + 19 * var12, 104, (var17 & 16711422) >> 1);
                    var16 = this.field_146297_k.fontRenderer;
                    var17 = 4226832;
