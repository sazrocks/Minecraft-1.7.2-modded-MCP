...
public class GuiRepair extends GuiContainer implements ICrafting
{
    ...
    protected void func_146979_b(int p_146979_1_, int p_146979_2_)
    {
        ...
        if (this.field_147092_v.maximumCost > 0)
        {
            int var3 = 8453920;
            boolean var4 = true;
            String var5 = I18n.getStringParams("container.repair.cost", new Object[] {Integer.valueOf(this.field_147092_v.maximumCost)});

            if (this.field_147092_v.maximumCost >= 40 && !this.field_146297_k.thePlayer.capabilities.isCreativeMode)
            {
                var5 = I18n.getStringParams("container.repair.expensive", new Object[0]);
                var3 = 16736352;
            }
            ...
            if (var4)
            {
                ...
                int var7 = this.field_146999_f - 8 - this.field_146289_q.getStringWidth(var5);
                byte var8 = 67;
                ...
                {
                    this.field_146289_q.drawString(var5, var7, var8 + 1, var6);
                    this.field_146289_q.drawString(var5, var7 + 1, var8, var6);
                    this.field_146289_q.drawString(var5, var7 + 1, var8 + 1, var6);
                }

                this.field_146289_q.drawString(var5, var7, var8, var3);
            }
        }
    ...
    private void func_147090_g()
    {
        ...
        this.field_146297_k.thePlayer.sendQueue.func_147297_a(new C17PacketCustomPayload("MC|ItemName", var1.getBytes(Charsets.UTF_8)));
    }
