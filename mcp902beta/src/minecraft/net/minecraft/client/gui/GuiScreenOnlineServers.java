...
public class GuiScreenOnlineServers extends GuiScreen
{
    ...
    public void func_146688_g()
    {
        ...
        String var1 = this.field_146694_D > 0 ? I18n.getStringParams("mco.selectServer.create", new Object[0]) : I18n.getStringParams("mco.selectServer.buy", new Object[0]);
        ...
        if (var2 != null && !var2.field_148809_e.equals(this.field_146297_k.getSession().getUsername()))
        {
    ...
    {
        String var1 = I18n.getStringParams("mco.more.info.question.line1", new Object[0]);
        String var2 = I18n.getStringParams("mco.more.info.question.line2", new Object[0]);
    ...
    private void func_146667_u()
    {
        ...
        if (var1 != null)
        {
            if (this.field_146297_k.getSession().getUsername().equals(var1.field_148809_e))
            {
            ...
            {
                String var4 = I18n.getStringParams("mco.configure.world.leave.question.line1", new Object[0]);
                String var3 = I18n.getStringParams("mco.configure.world.leave.question.line2", new Object[0]);
            ...
            (new Thread("MCO Configure Requester #" + field_146701_a.incrementAndGet())
            {
                ...
                public void run()
                {
                    try
                    {
                        ...
                        if (var1 != null)
                        {
                            Session var2 = GuiScreenOnlineServers.this.field_146297_k.getSession();
    ...
    {
        Session var3 = this.field_146297_k.getSession();
    ...
    private void func_146659_c(int p_146659_1_, int p_146659_2_)
    {
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        GL11.glPushMatrix();
        this.drawTexturedModalRect(this.field_146294_l / 2 + 58, 12, var4 ? 166 : 182, 22, 16, 16);
        GL11.glPopMatrix();
        int var5;
        int var6;
        ...
        if (var3 != 0)
        {
            ...
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            GL11.glPushMatrix();
            this.drawTexturedModalRect(this.field_146294_l / 2 + 58 + 4, 16 + var6, var5, 22, 8, 8);
            GL11.glPopMatrix();
        }
        ...
        if (var4)
        {
            ...
            if (var3 != 0)
            {
                var7 = I18n.getStringParams("mco.invites.pending", new Object[0]);
            }
            else
            {
                var7 = I18n.getStringParams("mco.invites.nopending", new Object[0]);
            }

            int var8 = this.field_146289_q.getStringWidth(var7);
            this.drawGradientRect(var5 - 3, var6 - 3, var5 + var8 + 3, var6 + 8 + 3, -1073741824, -1073741824);
            this.field_146289_q.drawStringWithShadow(var7, var5, var6, -1);
        }
    }
    ...
    protected void func_146658_b(String p_146658_1_, int p_146658_2_, int p_146658_3_)
    {
        if (p_146658_1_ != null)
        {
            ...
            int var6 = this.field_146289_q.getStringWidth(p_146658_1_);
            this.drawGradientRect(var4 - 3, var5 - 3, var4 + var6 + 3, var5 + 8 + 3, -1073741824, -1073741824);
            this.field_146289_q.drawStringWithShadow(p_146658_1_, var4, var5, -1);
        }
    }
    ...
    class OnlineServerList extends GuiScreenSelectLocation
    {
        ...
        protected void func_148352_a(int p_148352_1_, boolean p_148352_2_)
        {
            if (p_148352_1_ < GuiScreenOnlineServers.this.field_146700_C.size())
            {
                ...
                if (!GuiScreenOnlineServers.this.field_146297_k.getSession().getUsername().equals(var3.field_148809_e))
                {
        ...
        private void func_148390_b(int p_148390_1_, int p_148390_2_, int p_148390_3_, int p_148390_4_, Tessellator p_148390_5_)
        {
            ...
            GuiScreenOnlineServers.this.drawString(GuiScreenOnlineServers.this.field_146289_q, var6.func_148801_b(), p_148390_2_ + 2, p_148390_3_ + 1, 16777215);
            short var7 = 207;
            byte var8 = 1;
            ...
            else if (var6.field_148809_e.equals(GuiScreenOnlineServers.this.field_146297_k.getSession().getUsername()) && var6.field_148818_k < 7)
            {
            ...
            GuiScreenOnlineServers.this.drawString(GuiScreenOnlineServers.this.field_146289_q, var6.field_148813_n, p_148390_2_ + 200 - GuiScreenOnlineServers.this.field_146289_q.getStringWidth(var6.field_148813_n), p_148390_3_ + 1, 8421504);
            GuiScreenOnlineServers.this.drawString(GuiScreenOnlineServers.this.field_146289_q, var6.func_148800_a(), p_148390_2_ + 2, p_148390_3_ + 12, 7105644);
            GuiScreenOnlineServers.this.drawString(GuiScreenOnlineServers.this.field_146289_q, var6.field_148809_e, p_148390_2_ + 2, p_148390_3_ + 12 + 11, 5000268);
        }
