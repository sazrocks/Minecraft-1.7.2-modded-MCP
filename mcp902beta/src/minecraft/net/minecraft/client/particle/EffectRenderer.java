...
public class EffectRenderer
{
    ...
    {
        Block var5 = this.worldObj.func_147439_a(par1, par2, par3);

        if (var5.func_149688_o() != Material.field_151579_a)
        {
            float var6 = 0.1F;
            double var7 = (double)par1 + this.rand.nextDouble() * (var5.func_149753_y() - var5.func_149704_x() - (double)(var6 * 2.0F)) + (double)var6 + var5.func_149704_x();
            double var9 = (double)par2 + this.rand.nextDouble() * (var5.func_149669_A() - var5.func_149665_z() - (double)(var6 * 2.0F)) + (double)var6 + var5.func_149665_z();
            double var11 = (double)par3 + this.rand.nextDouble() * (var5.func_149693_C() - var5.func_149706_B() - (double)(var6 * 2.0F)) + (double)var6 + var5.func_149706_B();

            if (par4 == 0)
            {
                var9 = (double)par2 + var5.func_149665_z() - (double)var6;
            }

            if (par4 == 1)
            {
                var9 = (double)par2 + var5.func_149669_A() + (double)var6;
            }

            if (par4 == 2)
            {
                var11 = (double)par3 + var5.func_149706_B() - (double)var6;
            }

            if (par4 == 3)
            {
                var11 = (double)par3 + var5.func_149693_C() + (double)var6;
            }

            if (par4 == 4)
            {
                var7 = (double)par1 + var5.func_149704_x() - (double)var6;
            }

            if (par4 == 5)
            {
                var7 = (double)par1 + var5.func_149753_y() + (double)var6;
            }
