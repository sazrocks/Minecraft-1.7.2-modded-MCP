...
public class ShaderGroup
{
    ...
    public void func_148025_a(ResourceLocation p_148025_1_) throws JsonException
    {
        ...
        try
        {
            IResource var4 = this.field_148033_b.getResource(p_148025_1_);
    ...
    private void func_148019_b(JsonElement p_148019_1_) throws JsonException
    {
        ...
        else
        {
            ...
            if (var9 != null)
            {
                ...
                for (Iterator var11 = var9.iterator(); var11.hasNext(); ++var10)
                {
                    ...
                    try
                    {
                        ...
                        String var23 = JsonUtils.func_151200_h(var13, "name");
                        ...
                        var8.func_148041_a(var23, var16, var16.field_147622_a, var16.field_147620_b);
                    }
                    catch (Exception var18)
                    {
            ...
            JsonArray var19 = JsonUtils.func_151213_a(var2, "uniforms", (JsonArray)null);
