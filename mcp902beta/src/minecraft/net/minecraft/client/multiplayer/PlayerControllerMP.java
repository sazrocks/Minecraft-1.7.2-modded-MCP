...
public class PlayerControllerMP
{
    ...
    public boolean onPlayerDestroyBlock(int par1, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            Block var6 = var5.func_147439_a(par1, par2, par3);
            ...
            {
                var5.playAuxSFX(2001, par1, par2, par3, Block.func_149682_b(var6) + (var5.getBlockMetadata(par1, par2, par3) << 12));
                int var7 = var5.getBlockMetadata(par1, par2, par3);
                boolean var8 = var5.func_147468_f(par1, par2, par3);

                if (var8)
                {
                    var6.func_149664_b(var5, par1, par2, par3, var7);
                }
    ...
    public void clickBlock(int par1, int par2, int par3, int par4)
    {
        if (!this.currentGameType.isAdventure() || this.mc.thePlayer.isCurrentToolAdventureModeExempt(par1, par2, par3))
        {
            ...
            else if (!this.isHittingBlock || !this.sameToolAndBlock(par1, par2, par3))
            {
                ...
                this.netClientHandler.func_147297_a(new C07PacketPlayerDigging(0, par1, par2, par3, par4));
                Block var5 = this.mc.theWorld.func_147439_a(par1, par2, par3);
                boolean var6 = var5.func_149688_o() != Material.field_151579_a;

                if (var6 && this.curBlockDamageMP == 0.0F)
                {
                    var5.func_149699_a(this.mc.theWorld, par1, par2, par3, this.mc.thePlayer);
                }

                if (var6 && var5.func_149737_a(this.mc.thePlayer, this.mc.thePlayer.worldObj, par1, par2, par3) >= 1.0F)
                {
    ...
    public void onPlayerDamageBlock(int par1, int par2, int par3, int par4)
    {
        ...
        else
        {
            if (this.sameToolAndBlock(par1, par2, par3))
            {
                ...
                this.curBlockDamageMP += var5.func_149737_a(this.mc.thePlayer, this.mc.thePlayer.worldObj, par1, par2, par3);

                if (this.stepSoundTickCounter % 4.0F == 0.0F)
                {
                    this.mc.func_147118_V().func_147682_a(new PositionedSoundRecord(new ResourceLocation(var5.field_149762_H.func_150498_e()), (var5.field_149762_H.func_150497_c() + 1.0F) / 8.0F, var5.field_149762_H.func_150494_d() * 0.5F, (float)par1 + 0.5F, (float)par2 + 0.5F, (float)par3 + 0.5F));
                }
    ...
    private boolean sameToolAndBlock(int par1, int par2, int par3)
    {
        ...
        {
            var5 = var4.getItem() == this.field_85183_f.getItem() && ItemStack.areItemStackTagsEqual(var4, this.field_85183_f) && (var4.isItemStackDamageable() || var4.getItemDamage() == this.field_85183_f.getItemDamage());
        }
    ...
    public boolean onPlayerRightClick(EntityPlayer par1EntityPlayer, World par2World, ItemStack par3ItemStack, int par4, int par5, int par6, int par7, Vec3 par8Vec3)
    {
        ...
        if ((!par1EntityPlayer.isSneaking() || par1EntityPlayer.getHeldItem() == null) && par2World.func_147439_a(par4, par5, par6).func_149727_a(par2World, par4, par5, par6, par1EntityPlayer, par7, var9, var10, var11))
        {
            var12 = true;
        }
        ...
        this.netClientHandler.func_147297_a(new C08PacketPlayerBlockPlacement(par4, par5, par6, par7, par1EntityPlayer.inventory.getCurrentItem(), var9, var10, var11));
    ...
    public ItemStack windowClick(int par1, int par2, int par3, int par4, EntityPlayer par5EntityPlayer)
    {
        ...
        this.netClientHandler.func_147297_a(new C0EPacketClickWindow(par1, par2, par3, par4, var7, var6));
        return var7;
    }
