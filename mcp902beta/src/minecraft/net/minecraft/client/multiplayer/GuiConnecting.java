        ...
        (new Thread("Server Connector #" + field_146372_a.incrementAndGet())
        {
            ...
            public void run()
            {
                ...
                catch (UnknownHostException var2)
                {
                    ...
                    GuiConnecting.field_146370_f.error("Couldn\'t connect to server", var2);
                ...
                catch (Exception var3)
                {
                    ...
                    GuiConnecting.field_146370_f.error("Couldn\'t connect to server", var3);
                    GuiConnecting.this.field_146297_k.func_147108_a(new GuiDisconnected(GuiConnecting.this.field_146374_i, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", new Object[] {var3.toString()})));
                }
            }
        }).start();
    }
