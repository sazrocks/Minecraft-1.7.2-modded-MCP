...
public class LanguageManager implements IResourceManagerReloadListener
{
    ...
    public void parseLanguageMetadata(List par1List)
    {
        ...
        while (var2.hasNext())
        {
            ...
            {
                field_147648_b.warn("Unable to parse metadata section of resourcepack: " + var3.getPackName(), var7);
            }
            catch (IOException var8)
            {
                field_147648_b.warn("Unable to parse metadata section of resourcepack: " + var3.getPackName(), var8);
            }
        }
    }
