...
public class WorldManager implements IWorldAccess
{
    ...
    public void func_147587_b(int p_147587_1_, int p_147587_2_, int p_147587_3_, int p_147587_4_, int p_147587_5_)
    {
        ...
        while (var6.hasNext())
        {
            ...
            if (var7 != null && var7.worldObj == this.theWorldServer && var7.func_145782_y() != p_147587_1_)
            {
                ...
                {
                    var7.playerNetServerHandler.func_147359_a(new S25PacketBlockBreakAnim(p_147587_1_, p_147587_2_, p_147587_3_, p_147587_4_, p_147587_5_));
                }
            }
        }
    }
