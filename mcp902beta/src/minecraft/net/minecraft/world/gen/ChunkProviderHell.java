...
public class ChunkProviderHell implements IChunkProvider
{
            ...
            for (int var8 = 0; var8 < 16; ++var8)
            {
                ...
                for (int var15 = 127; var15 >= 0; --var15)
                {
                    ...
                    if (var15 < 127 - this.hellRNG.nextInt(5) && var15 > 0 + this.hellRNG.nextInt(5))
                    {
                        ...
                        {
                            if (var17 == Blocks.field_150424_aL)
                            {
                                if (var12 == -1)
                                {
                                    if (var11 <= 0)
                    ...
                    {
                        p_147418_3_[var16] = Blocks.field_150357_h;
                    }
                }
            }
        }
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        for (var6 = 0; var6 < 8; ++var6)
        {
            ...
            (new WorldGenHellLava(Blocks.field_150356_k, false)).generate(this.worldObj, this.hellRNG, var7, var8, var9);
        }
        ...
        if (this.hellRNG.nextInt(1) == 0)
        {
            ...
            var9 = var5 + this.hellRNG.nextInt(16) + 8;
            (new WorldGenFlowers(Blocks.field_150338_P)).generate(this.worldObj, this.hellRNG, var7, var8, var9);
        }
        ...
        if (this.hellRNG.nextInt(1) == 0)
        {
            ...
            var8 = this.hellRNG.nextInt(128);
            var9 = var5 + this.hellRNG.nextInt(16) + 8;
            (new WorldGenFlowers(Blocks.field_150337_Q)).generate(this.worldObj, this.hellRNG, var7, var8, var9);
        }

        WorldGenMinable var12 = new WorldGenMinable(Blocks.field_150449_bY, 13, Blocks.field_150424_aL);
        int var11;
        ...
        for (var8 = 0; var8 < 16; ++var8)
        {
            ...
            var10 = this.hellRNG.nextInt(108) + 10;
            var11 = var5 + this.hellRNG.nextInt(16);
            (new WorldGenHellLava(Blocks.field_150356_k, true)).generate(this.worldObj, this.hellRNG, var9, var10, var11);
        }
    ...
    public List getPossibleCreatures(EnumCreatureType par1EnumCreatureType, int par2, int par3, int par4)
    {
        if (par1EnumCreatureType == EnumCreatureType.monster)
        {
            ...
            if (this.genNetherBridge.func_142038_b(par2, par3, par4) && this.worldObj.func_147439_a(par2, par3 - 1, par4) == Blocks.field_150385_bj)
            {
                return this.genNetherBridge.getSpawnList();
            }
        }
