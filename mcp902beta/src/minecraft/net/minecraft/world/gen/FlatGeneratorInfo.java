...
public class FlatGeneratorInfo
{
    ...
    private static FlatLayerInfo func_82646_a(String par0Str, int par1)
    {
        ...
        FlatLayerInfo var9 = new FlatLayerInfo(var3, Block.func_149729_e(var4), var5);
        var9.setMinY(par1);
        return var9;
    }
    ...
    public static FlatGeneratorInfo getDefaultFlatGenerator()
    {
        ...
        var0.getFlatLayers().add(new FlatLayerInfo(1, Blocks.field_150357_h));
        var0.getFlatLayers().add(new FlatLayerInfo(2, Blocks.field_150346_d));
        var0.getFlatLayers().add(new FlatLayerInfo(1, Blocks.field_150349_c));
        var0.func_82645_d();
