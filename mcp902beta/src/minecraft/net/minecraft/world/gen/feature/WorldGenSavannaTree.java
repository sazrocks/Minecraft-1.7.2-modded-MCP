...
public class WorldGenSavannaTree extends WorldGenAbstractTree
{
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + var6 + 1 <= 256)
        {
            ...
            else
            {
                ...
                if ((var21 == Blocks.field_150349_c || var21 == Blocks.field_150346_d) && par4 < 256 - var6 - 1)
                {
                    ...
                    for (var15 = 0; var15 < var6; ++var15)
                    {
                        ...
                        Block var17 = par1World.func_147439_a(var23, var16, var13);

                        if (var17.func_149688_o() == Material.field_151579_a || var17.func_149688_o() == Material.field_151584_j)
                        {
                            this.func_150516_a(par1World, var23, var16, var13, Blocks.field_150363_s, 0);
                            var14 = var16;
                        }
                    }
                    ...
                    if (var15 != var22)
                    {
                        ...
                        for (var18 = var16; var18 < var6 && var24 > 0; --var24)
                        {
                            if (var18 >= 1)
                            {
                                ...
                                Block var20 = par1World.func_147439_a(var23, var19, var13);

                                if (var20.func_149688_o() == Material.field_151579_a || var20.func_149688_o() == Material.field_151584_j)
                                {
                                    this.func_150516_a(par1World, var23, var19, var13, Blocks.field_150363_s, 0);
                                    var14 = var19;
                                }
                            }
    ...
    {
        Block var5 = p_150525_1_.func_147439_a(p_150525_2_, p_150525_3_, p_150525_4_);
