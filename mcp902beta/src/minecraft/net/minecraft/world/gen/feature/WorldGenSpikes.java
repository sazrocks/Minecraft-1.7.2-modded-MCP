        ...
        if (par1World.func_147437_c(par3, par4, par5) && par1World.func_147439_a(par3, par4 - 1, par5) == this.field_150520_a)
        {
            ...
            for (var8 = par3 - var7; var8 <= par3 + var7; ++var8)
            {
                for (var9 = par5 - var7; var9 <= par5 + var7; ++var9)
                {
                    ...
                    if (var10 * var10 + var11 * var11 <= var7 * var7 + 1 && par1World.func_147439_a(var8, par4 - 1, var9) != this.field_150520_a)
                    {
                        return false;
                    }
                }
            ...
            for (var8 = par4; var8 < par4 + var6 && var8 < 256; ++var8)
            {
                for (var9 = par3 - var7; var9 <= par3 + var7; ++var9)
                {
                    for (var10 = par5 - var7; var10 <= par5 + var7; ++var10)
                    {
                        ...
                        {
                            par1World.func_147465_d(var9, var8, var10, Blocks.field_150343_Z, 0, 2);
                        }
                    }
                }
            }
            ...
            par1World.func_147465_d(par3, par4 + var6, par5, Blocks.field_150357_h, 0, 2);
            return true;
        }
        else
        {
