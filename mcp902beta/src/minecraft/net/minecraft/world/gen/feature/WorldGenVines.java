    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        for (int var7 = par5; par4 < 128; ++par4)
        {
            if (par1World.func_147437_c(par3, par4, par5))
            {
                ...
                {
                    if (Blocks.field_150395_bd.func_149707_d(par1World, par3, par4, par5, var8))
                    {
                        par1World.func_147465_d(par3, par4, par5, Blocks.field_150395_bd, 1 << Direction.facingToDirection[Facing.oppositeSide[var8]], 2);
                        break;
                    }
                }
            }
