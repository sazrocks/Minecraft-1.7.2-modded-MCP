        ...
        if (par4 >= 1 && par4 + var7 + 1 < 256)
        {
            ...
            for (int var9 = par4; var9 <= par4 + 1 + var7; ++var9)
            {
                ...
                for (var11 = par3 - var10; var11 <= par3 + var10 && var8; ++var11)
                {
                    for (var12 = par5 - var10; var12 <= par5 + var10 && var8; ++var12)
                    {
                        if (var9 >= 0 && var9 < 256)
                        {
                            Block var13 = par1World.func_147439_a(var11, var9, var12);
            ...
            else
            {
                ...
                else
                {
                    ...
                    for (var11 = var17; var11 <= par4 + var7; ++var11)
                    {
                        ...
                        for (int var18 = par3 - var12; var18 <= par3 + var12; ++var18)
                        {
                            for (int var14 = par5 - var12; var14 <= par5 + var12; ++var14)
                            {
                                ...
                                if ((var15 != 0 || par4 >= par4 + var7 - 1) && !par1World.func_147439_a(var18, var11, var14).func_149730_j())
                                {
                                    this.func_150516_a(par1World, var18, var11, var14, Block.func_149729_e(Block.func_149682_b(Blocks.field_150420_aW) + var6), var15);
                                }
                            }
                        }
                    }
                    ...
                    {
                        Block var19 = par1World.func_147439_a(par3, par4 + var11, par5);

                        if (!var19.func_149730_j())
                        {
                            this.func_150516_a(par1World, par3, par4 + var11, par5, Block.func_149729_e(Block.func_149682_b(Blocks.field_150420_aW) + var6), 10);
                        }
                    }
