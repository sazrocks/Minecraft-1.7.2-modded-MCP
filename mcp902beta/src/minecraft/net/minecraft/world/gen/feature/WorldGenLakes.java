        ...
        else
        {
            ...
            for (var8 = 0; var8 < 16; ++var8)
            {
                for (var32 = 0; var32 < 16; ++var32)
                {
                    for (var10 = 0; var10 < 8; ++var10)
                    {
                        ...
                        if (var33)
                        {
                            Material var12 = par1World.func_147439_a(par3 + var8, par4 + var10, par5 + var32).func_149688_o();
                            ...
                            if (var10 < 4 && !var12.isSolid() && par1World.func_147439_a(par3 + var8, par4 + var10, par5 + var32) != this.field_150556_a)
                            {
                                return false;
                            }
                        }
            ...
            for (var8 = 0; var8 < 16; ++var8)
            {
                for (var32 = 0; var32 < 16; ++var32)
                {
                    for (var10 = 0; var10 < 8; ++var10)
                    {
                        ...
                        {
                            par1World.func_147465_d(par3 + var8, par4 + var10, par5 + var32, var10 >= 4 ? Blocks.field_150350_a : this.field_150556_a, 0, 2);
                        }
                    }
                }
            }
            ...
            for (var8 = 0; var8 < 16; ++var8)
            {
                for (var32 = 0; var32 < 16; ++var32)
                {
                    ...
                    {
                        if (var6[(var8 * 16 + var32) * 8 + var10] && par1World.func_147439_a(par3 + var8, par4 + var10 - 1, par5 + var32) == Blocks.field_150346_d && par1World.getSavedLightValue(EnumSkyBlock.Sky, par3 + var8, par4 + var10, par5 + var32) > 0)
                        {
                            BiomeGenBase var34 = par1World.getBiomeGenForCoords(par3 + var8, par5 + var32);

                            if (var34.topBlock == Blocks.field_150391_bh)
                            {
                                par1World.func_147465_d(par3 + var8, par4 + var10 - 1, par5 + var32, Blocks.field_150391_bh, 0, 2);
                            }
                            else
                            {
                                par1World.func_147465_d(par3 + var8, par4 + var10 - 1, par5 + var32, Blocks.field_150349_c, 0, 2);
                            }
                        }
                    }
                }
                ...
                for (var8 = 0; var8 < 16; ++var8)
                {
                    for (var32 = 0; var32 < 16; ++var32)
                    {
                        for (var10 = 0; var10 < 8; ++var10)
                        {
                            ...
                            if (var33 && (var10 < 4 || par2Random.nextInt(2) != 0) && par1World.func_147439_a(par3 + var8, par4 + var10, par5 + var32).func_149688_o().isSolid())
                            {
                                par1World.func_147465_d(par3 + var8, par4 + var10, par5 + var32, Blocks.field_150348_b, 0, 2);
                            }
                        }
                    }
                }
            ...
            if (this.field_150556_a.func_149688_o() == Material.field_151586_h)
            {
                for (var8 = 0; var8 < 16; ++var8)
                {
                    for (var32 = 0; var32 < 16; ++var32)
                    {
                        ...
                        {
                            par1World.func_147465_d(par3 + var8, par4 + var35, par5 + var32, Blocks.field_150432_aD, 0, 2);
                        }
                    }
                }
            }
