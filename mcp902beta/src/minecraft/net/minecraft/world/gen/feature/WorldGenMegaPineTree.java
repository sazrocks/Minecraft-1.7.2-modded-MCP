...
public class WorldGenMegaPineTree extends WorldGenHugeTrees
{
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        else
        {
            ...
            {
                Block var8 = par1World.func_147439_a(par3, par4 + var7, par5);

                if (var8.func_149688_o() == Material.field_151579_a || var8.func_149688_o() == Material.field_151584_j)
                {
                    this.func_150516_a(par1World, par3, par4 + var7, par5, Blocks.field_150364_r, this.woodMetadata);
                }

                if (var7 < var6 - 1)
                {
                    var8 = par1World.func_147439_a(par3 + 1, par4 + var7, par5);

                    if (var8.func_149688_o() == Material.field_151579_a || var8.func_149688_o() == Material.field_151584_j)
                    {
                        this.func_150516_a(par1World, par3 + 1, par4 + var7, par5, Blocks.field_150364_r, this.woodMetadata);
                    }

                    var8 = par1World.func_147439_a(par3 + 1, par4 + var7, par5 + 1);

                    if (var8.func_149688_o() == Material.field_151579_a || var8.func_149688_o() == Material.field_151584_j)
                    {
                        this.func_150516_a(par1World, par3 + 1, par4 + var7, par5 + 1, Blocks.field_150364_r, this.woodMetadata);
                    }

                    var8 = par1World.func_147439_a(par3, par4 + var7, par5 + 1);

                    if (var8.func_149688_o() == Material.field_151579_a || var8.func_149688_o() == Material.field_151584_j)
                    {
                        this.func_150516_a(par1World, par3, par4 + var7, par5 + 1, Blocks.field_150364_r, this.woodMetadata);
                    }
                }
            }
    ...
    private void func_150540_a(World p_150540_1_, int p_150540_2_, int p_150540_3_, int p_150540_4_)
    {
        ...
        {
            Block var6 = p_150540_1_.func_147439_a(p_150540_2_, var5, p_150540_4_);

            if (var6 == Blocks.field_150349_c || var6 == Blocks.field_150346_d)
            {
                this.func_150516_a(p_150540_1_, p_150540_2_, var5, p_150540_4_, Blocks.field_150346_d, 2);
                break;
            }

            if (var6.func_149688_o() != Material.field_151579_a && var5 < p_150540_3_)
            {
                break;
            }
        }
