...
public class WorldGenCanopyTree extends WorldGenAbstractTree
{
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + var6 + 1 <= 256)
        {
            ...
            {
                Block var20 = par1World.func_147439_a(par3, par4 - 1, par5);

                if ((var20 == Blocks.field_150349_c || var20 == Blocks.field_150346_d) && par4 < 256 - var6 - 1)
                {
                    this.func_150515_a(par1World, par3, par4 - 1, par5, Blocks.field_150346_d);
                    this.func_150515_a(par1World, par3 + 1, par4 - 1, par5, Blocks.field_150346_d);
                    this.func_150515_a(par1World, par3 + 1, par4 - 1, par5 + 1, Blocks.field_150346_d);
                    this.func_150515_a(par1World, par3, par4 - 1, par5 + 1, Blocks.field_150346_d);
                    ...
                    for (var15 = 0; var15 < var6; ++var15)
                    {
                        ...
                        Block var17 = par1World.func_147439_a(var22, var16, var13);

                        if (var17.func_149688_o() == Material.field_151579_a || var17.func_149688_o() == Material.field_151584_j)
                        {
                            this.func_150516_a(par1World, var22, var16, var13, Blocks.field_150363_s, 1);
                            this.func_150516_a(par1World, var22 + 1, var16, var13, Blocks.field_150363_s, 1);
                            this.func_150516_a(par1World, var22, var16, var13 + 1, Blocks.field_150363_s, 1);
                            this.func_150516_a(par1World, var22 + 1, var16, var13 + 1, Blocks.field_150363_s, 1);
                            var14 = var16;
                        }
                    }
                    ...
                    for (var15 = -1; var15 <= 2; ++var15)
                    {
                        for (var16 = -1; var16 <= 2; ++var16)
                        {
                            if ((var15 < 0 || var15 > 1 || var16 < 0 || var16 > 1) && par2Random.nextInt(3) <= 0)
                            {
                                ...
                                {
                                    this.func_150516_a(par1World, par3 + var15, var14 - var18 - 1, par5 + var16, Blocks.field_150363_s, 1);
                                }
