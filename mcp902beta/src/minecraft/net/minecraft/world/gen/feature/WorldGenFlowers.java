...
public class WorldGenFlowers extends WorldGenerator
{
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        for (int var6 = 0; var6 < 64; ++var6)
        {
            ...
            if (par1World.func_147437_c(var7, var8, var9) && (!par1World.provider.hasNoSky || var8 < 255) && this.field_150552_a.func_149718_j(par1World, var7, var8, var9))
            {
                par1World.func_147465_d(var7, var8, var9, this.field_150552_a, this.field_150551_b, 2);
            }
        }
