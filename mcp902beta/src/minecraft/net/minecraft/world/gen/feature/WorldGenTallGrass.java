...
public class WorldGenTallGrass extends WorldGenerator
{
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        for (int var7 = 0; var7 < 128; ++var7)
        {
            ...
            if (par1World.func_147437_c(var8, var9, var10) && this.field_150522_a.func_149718_j(par1World, var8, var9, var10))
            {
                par1World.func_147465_d(var8, var9, var10, this.field_150522_a, this.tallGrassMetadata, 2);
            }
        }
