...
public class ChunkProviderGenerate implements IChunkProvider
{
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        if (var6 != BiomeGenBase.desert && var6 != BiomeGenBase.desertHills && !var11 && this.rand.nextInt(4) == 0)
        {
            ...
            (new WorldGenLakes(Blocks.field_150355_j)).generate(this.worldObj, this.rand, var12, var13, var14);
        }
        ...
        if (!var11 && this.rand.nextInt(8) == 0)
        {
            ...
            {
                (new WorldGenLakes(Blocks.field_150353_l)).generate(this.worldObj, this.rand, var12, var13, var14);
            }
        }
        ...
        for (var12 = 0; var12 < 16; ++var12)
        {
            for (var13 = 0; var13 < 16; ++var13)
            {
                ...
                {
                    this.worldObj.func_147465_d(var12 + var4, var14 - 1, var13 + var5, Blocks.field_150432_aD, 0, 2);
                }

                if (this.worldObj.func_147478_e(var12 + var4, var14, var13 + var5, true))
                {
                    this.worldObj.func_147465_d(var12 + var4, var14, var13 + var5, Blocks.field_150431_aC, 0, 2);
                }
            }
        }
