...
public class StructureVillagePieces
{
    ...
    public static class Well extends StructureVillagePieces.Village
    {
        ...
        public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            this.func_151549_a(par1World, par3StructureBoundingBox, 1, 0, 1, 4, 12, 4, Blocks.field_150347_e, Blocks.field_150358_i, false);
            ...
            for (int var4 = 0; var4 <= 5; ++var4)
            {
                for (int var5 = 0; var5 <= 5; ++var5)
                {
                    ...
                    {
                        this.func_151550_a(par1World, Blocks.field_150351_n, 0, var5, 11, var4, par3StructureBoundingBox);
        ...
        public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            for (var4 = 0; var4 < 9; ++var4)
            {
                for (int var5 = 0; var5 < 13; ++var5)
                {
                    ...
                    this.func_151554_b(par1World, Blocks.field_150346_d, 0, var5, -1, var4, par3StructureBoundingBox);
                }
            }
    ...
    public static class House4Garden extends StructureVillagePieces.Village
    {
        ...
        public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            if (this.isRoofAccessible)
            {
                ...
                this.func_151550_a(par1World, Blocks.field_150468_ap, var4, 3, 1, 3, par3StructureBoundingBox);
                this.func_151550_a(par1World, Blocks.field_150468_ap, var4, 3, 2, 3, par3StructureBoundingBox);
                this.func_151550_a(par1World, Blocks.field_150468_ap, var4, 3, 3, 3, par3StructureBoundingBox);
                this.func_151550_a(par1World, Blocks.field_150468_ap, var4, 3, 4, 3, par3StructureBoundingBox);
            }
            ...
            for (var4 = 0; var4 < 5; ++var4)
            {
                for (int var5 = 0; var5 < 5; ++var5)
                {
                    ...
                    this.func_151554_b(par1World, Blocks.field_150347_e, 0, var5, -1, var4, par3StructureBoundingBox);
                }
            }
    ...
    public static class Church extends StructureVillagePieces.Village
    {
        ...
        public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            {
                this.func_151550_a(par1World, Blocks.field_150468_ap, var4, 3, var5, 3, par3StructureBoundingBox);
            }
            ...
            this.placeDoorAtCurrentPosition(par1World, par3StructureBoundingBox, par2Random, 2, 1, 0, this.func_151555_a(Blocks.field_150466_ao, 1));
            ...
            for (var5 = 0; var5 < 9; ++var5)
            {
                for (int var6 = 0; var6 < 5; ++var6)
                {
                    ...
                    this.func_151554_b(par1World, Blocks.field_150347_e, 0, var6, -1, var5, par3StructureBoundingBox);
                }
            }
    ...
    public static class Hall extends StructureVillagePieces.Village
    {
        ...
        public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            for (var6 = -1; var6 <= 2; ++var6)
            {
                ...
                {
                    this.func_151550_a(par1World, Blocks.field_150476_ad, var4, var7, 4 + var6, var6, par3StructureBoundingBox);
                    this.func_151550_a(par1World, Blocks.field_150476_ad, var5, var7, 4 + var6, 5 - var6, par3StructureBoundingBox);
                }
            }
            ...
            this.func_151549_a(par1World, par3StructureBoundingBox, 5, 0, 1, 7, 0, 3, Blocks.field_150334_T, Blocks.field_150334_T, false);
            this.func_151550_a(par1World, Blocks.field_150334_T, 0, 6, 1, 1, par3StructureBoundingBox);
            this.func_151550_a(par1World, Blocks.field_150334_T, 0, 6, 1, 2, par3StructureBoundingBox);
            this.func_151550_a(par1World, Blocks.field_150350_a, 0, 2, 1, 0, par3StructureBoundingBox);
            this.func_151550_a(par1World, Blocks.field_150350_a, 0, 2, 2, 0, par3StructureBoundingBox);
            this.func_151550_a(par1World, Blocks.field_150478_aa, 0, 2, 3, 1, par3StructureBoundingBox);
            this.placeDoorAtCurrentPosition(par1World, par3StructureBoundingBox, par2Random, 2, 1, 0, this.func_151555_a(Blocks.field_150466_ao, 1));
            ...
            this.placeDoorAtCurrentPosition(par1World, par3StructureBoundingBox, par2Random, 6, 1, 5, this.func_151555_a(Blocks.field_150466_ao, 1));
            ...
            for (var6 = 0; var6 < 5; ++var6)
            {
                for (var7 = 0; var7 < 9; ++var7)
                {
                    ...
                    this.func_151554_b(par1World, Blocks.field_150347_e, 0, var7, -1, var6, par3StructureBoundingBox);
                }
            }
    ...
    public static class House2 extends StructureVillagePieces.Village
    {
        ...
        public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            this.func_151549_a(par1World, par3StructureBoundingBox, 0, 5, 0, 9, 5, 6, Blocks.field_150333_U, Blocks.field_150333_U, false);
            ...
            this.func_151550_a(par1World, Blocks.field_150356_k, 0, 7, 1, 5, par3StructureBoundingBox);
            this.func_151550_a(par1World, Blocks.field_150356_k, 0, 8, 1, 5, par3StructureBoundingBox);
            ...
            this.func_151550_a(par1World, Blocks.field_150334_T, 0, 8, 1, 1, par3StructureBoundingBox);
            this.func_151550_a(par1World, Blocks.field_150410_aZ, 0, 0, 2, 2, par3StructureBoundingBox);
            ...
            {
                if (this.func_151548_a(par1World, var4, 0, -1, par3StructureBoundingBox).func_149688_o() == Material.field_151579_a && this.func_151548_a(par1World, var4, -1, -1, par3StructureBoundingBox).func_149688_o() != Material.field_151579_a)
                {
                    this.func_151550_a(par1World, Blocks.field_150446_ar, this.func_151555_a(Blocks.field_150446_ar, 3), var4, 0, -1, par3StructureBoundingBox);
                }
            }
    ...
    public static class House3 extends StructureVillagePieces.Village
    {
        ...
        public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            {
                this.func_151550_a(par1World, Blocks.field_150344_f, 0, var7, 2 + var7, 7 - var7, par3StructureBoundingBox);

                for (var8 = 8 - var7; var8 <= 10; ++var8)
                {
                    this.func_151550_a(par1World, Blocks.field_150476_ad, var6, var7, 2 + var7, var8, par3StructureBoundingBox);
                }
            }
            ...
            this.func_151550_a(par1World, Blocks.field_150476_ad, var7, 6, 6, 4, par3StructureBoundingBox);
            int var9;
            ...
            for (var8 = 6; var8 <= 8; ++var8)
            {
                ...
                {
                    this.func_151550_a(par1World, Blocks.field_150476_ad, var7, var8, 12 - var8, var9, par3StructureBoundingBox);
                }
            }
            ...
            for (var8 = 0; var8 < 5; ++var8)
            {
                for (var9 = 0; var9 < 9; ++var9)
                {
                    ...
                    this.func_151554_b(par1World, Blocks.field_150347_e, 0, var9, -1, var8, par3StructureBoundingBox);
                }
            }
    ...
    public static class House1 extends StructureVillagePieces.Village
    {
        ...
        public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            for (var6 = -1; var6 <= 2; ++var6)
            {
                for (var7 = 0; var7 <= 8; ++var7)
                {
                    this.func_151550_a(par1World, Blocks.field_150476_ad, var4, var7, 6 + var6, var6, par3StructureBoundingBox);
                    this.func_151550_a(par1World, Blocks.field_150476_ad, var5, var7, 6 + var6, 5 - var6, par3StructureBoundingBox);
                }
            }
            ...
            this.func_151550_a(par1World, Blocks.field_150476_ad, var6, 6, 1, 4, par3StructureBoundingBox);
            this.func_151550_a(par1World, Blocks.field_150476_ad, var6, 5, 1, 4, par3StructureBoundingBox);
            this.func_151550_a(par1World, Blocks.field_150476_ad, var6, 4, 1, 4, par3StructureBoundingBox);
            this.func_151550_a(par1World, Blocks.field_150476_ad, var6, 3, 1, 4, par3StructureBoundingBox);
            ...
            this.placeDoorAtCurrentPosition(par1World, par3StructureBoundingBox, par2Random, 1, 1, 0, this.func_151555_a(Blocks.field_150466_ao, 1));
            ...
            for (var7 = 0; var7 < 6; ++var7)
            {
                for (int var8 = 0; var8 < 9; ++var8)
                {
                    ...
                    this.func_151554_b(par1World, Blocks.field_150347_e, 0, var8, -1, var7, par3StructureBoundingBox);
                }
            }
            ...
            for (int var5 = this.boundingBox.minX; var5 <= this.boundingBox.maxX; ++var5)
            {
                for (int var6 = this.boundingBox.minZ; var6 <= this.boundingBox.maxZ; ++var6)
                {
                    if (par3StructureBoundingBox.isVecInside(var5, 64, var6))
                    {
                        ...
                        par1World.func_147465_d(var5, var7, var6, var4, 0, 2);
                    }
                }
            }
