...
public class StructureMineshaftPieces
{
    ...
    public static class Cross extends StructureComponent
    {
        ...
        public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            else
            {
                if (this.isMultipleFloors)
                {
                    this.func_151549_a(par1World, par3StructureBoundingBox, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ, this.boundingBox.maxX - 1, this.boundingBox.minY + 3 - 1, this.boundingBox.maxZ, Blocks.field_150350_a, Blocks.field_150350_a, false);
                    this.func_151549_a(par1World, par3StructureBoundingBox, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ + 1, this.boundingBox.maxX, this.boundingBox.minY + 3 - 1, this.boundingBox.maxZ - 1, Blocks.field_150350_a, Blocks.field_150350_a, false);
                    this.func_151549_a(par1World, par3StructureBoundingBox, this.boundingBox.minX + 1, this.boundingBox.maxY - 2, this.boundingBox.minZ, this.boundingBox.maxX - 1, this.boundingBox.maxY, this.boundingBox.maxZ, Blocks.field_150350_a, Blocks.field_150350_a, false);
                    this.func_151549_a(par1World, par3StructureBoundingBox, this.boundingBox.minX, this.boundingBox.maxY - 2, this.boundingBox.minZ + 1, this.boundingBox.maxX, this.boundingBox.maxY, this.boundingBox.maxZ - 1, Blocks.field_150350_a, Blocks.field_150350_a, false);
                    this.func_151549_a(par1World, par3StructureBoundingBox, this.boundingBox.minX + 1, this.boundingBox.minY + 3, this.boundingBox.minZ + 1, this.boundingBox.maxX - 1, this.boundingBox.minY + 3, this.boundingBox.maxZ - 1, Blocks.field_150350_a, Blocks.field_150350_a, false);
                }
                else
                {
                    this.func_151549_a(par1World, par3StructureBoundingBox, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ, this.boundingBox.maxX - 1, this.boundingBox.maxY, this.boundingBox.maxZ, Blocks.field_150350_a, Blocks.field_150350_a, false);
                    this.func_151549_a(par1World, par3StructureBoundingBox, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ + 1, this.boundingBox.maxX, this.boundingBox.maxY, this.boundingBox.maxZ - 1, Blocks.field_150350_a, Blocks.field_150350_a, false);
                }

                this.func_151549_a(par1World, par3StructureBoundingBox, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, this.boundingBox.minX + 1, this.boundingBox.maxY, this.boundingBox.minZ + 1, Blocks.field_150344_f, Blocks.field_150350_a, false);
                this.func_151549_a(par1World, par3StructureBoundingBox, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 1, this.boundingBox.minX + 1, this.boundingBox.maxY, this.boundingBox.maxZ - 1, Blocks.field_150344_f, Blocks.field_150350_a, false);
                this.func_151549_a(par1World, par3StructureBoundingBox, this.boundingBox.maxX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, this.boundingBox.maxX - 1, this.boundingBox.maxY, this.boundingBox.minZ + 1, Blocks.field_150344_f, Blocks.field_150350_a, false);
                this.func_151549_a(par1World, par3StructureBoundingBox, this.boundingBox.maxX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 1, this.boundingBox.maxX - 1, this.boundingBox.maxY, this.boundingBox.maxZ - 1, Blocks.field_150344_f, Blocks.field_150350_a, false);

                for (int var4 = this.boundingBox.minX; var4 <= this.boundingBox.maxX; ++var4)
                {
                    for (int var5 = this.boundingBox.minZ; var5 <= this.boundingBox.maxZ; ++var5)
                    {
                        if (this.func_151548_a(par1World, var4, this.boundingBox.minY - 1, var5, par3StructureBoundingBox).func_149688_o() == Material.field_151579_a)
                        {
                            this.func_151550_a(par1World, Blocks.field_150344_f, 0, var4, this.boundingBox.minY - 1, var5, par3StructureBoundingBox);
                        }
                    }
                }
    ...
    public static class Room extends StructureComponent
    {
        ...
        public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            {
                this.func_151549_a(par1World, par3StructureBoundingBox, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ, this.boundingBox.maxX, this.boundingBox.minY, this.boundingBox.maxZ, Blocks.field_150346_d, Blocks.field_150350_a, true);
                this.func_151549_a(par1World, par3StructureBoundingBox, this.boundingBox.minX, this.boundingBox.minY + 1, this.boundingBox.minZ, this.boundingBox.maxX, Math.min(this.boundingBox.minY + 3, this.boundingBox.maxY), this.boundingBox.maxZ, Blocks.field_150350_a, Blocks.field_150350_a, false);
                Iterator var4 = this.roomsLinkedToTheRoom.iterator();

                while (var4.hasNext())
                {
                    StructureBoundingBox var5 = (StructureBoundingBox)var4.next();
                    this.func_151549_a(par1World, par3StructureBoundingBox, var5.minX, var5.maxY - 2, var5.minZ, var5.maxX, var5.maxY, var5.maxZ, Blocks.field_150350_a, Blocks.field_150350_a, false);
                }

                this.func_151547_a(par1World, par3StructureBoundingBox, this.boundingBox.minX, this.boundingBox.minY + 4, this.boundingBox.minZ, this.boundingBox.maxX, this.boundingBox.maxY, this.boundingBox.maxZ, Blocks.field_150350_a, false);
                return true;
            }
        }
        ...
        protected void func_143011_b(NBTTagCompound par1NBTTagCompound)
        {
            NBTTagList var2 = par1NBTTagCompound.func_150295_c("Entrances", 11);
    ...
    public static class Stairs extends StructureComponent
    {
        ...
        public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            else
            {
                ...
                {
                    this.func_151549_a(par1World, par3StructureBoundingBox, 0, 5 - var4 - (var4 < 4 ? 1 : 0), 2 + var4, 2, 7 - var4, 2 + var4, Blocks.field_150350_a, Blocks.field_150350_a, false);
                }
    ...
    public static class Corridor extends StructureComponent
    {
        ...
        protected boolean generateStructureChestContents(World par1World, StructureBoundingBox par2StructureBoundingBox, Random par3Random, int par4, int par5, int par6, WeightedRandomChestContent[] par7ArrayOfWeightedRandomChestContent, int par8)
        {
            ...
            if (par2StructureBoundingBox.isVecInside(var9, var10, var11) && par1World.func_147439_a(var9, var10, var11).func_149688_o() == Material.field_151579_a)
            {
                int var12 = par3Random.nextBoolean() ? 1 : 0;
                par1World.func_147465_d(var9, var10, var11, Blocks.field_150448_aq, this.func_151555_a(Blocks.field_150448_aq, var12), 2);
        ...
        public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            else
            {
                ...
                this.func_151549_a(par1World, par3StructureBoundingBox, 0, 0, 0, 2, 1, var8, Blocks.field_150350_a, Blocks.field_150350_a, false);
                this.func_151551_a(par1World, par3StructureBoundingBox, par2Random, 0.8F, 0, 2, 0, 2, 2, var8, Blocks.field_150350_a, Blocks.field_150350_a, false);

                if (this.hasSpiders)
                {
                    this.func_151551_a(par1World, par3StructureBoundingBox, par2Random, 0.6F, 0, 0, 0, 2, 1, var8, Blocks.field_150321_G, Blocks.field_150350_a, false);
                }
                ...
                {
                    var10 = 2 + var9 * 5;
                    this.func_151549_a(par1World, par3StructureBoundingBox, 0, 0, var10, 0, 1, var10, Blocks.field_150422_aJ, Blocks.field_150350_a, false);
                    this.func_151549_a(par1World, par3StructureBoundingBox, 2, 0, var10, 2, 1, var10, Blocks.field_150422_aJ, Blocks.field_150350_a, false);

                    if (par2Random.nextInt(4) == 0)
                    {
                        this.func_151549_a(par1World, par3StructureBoundingBox, 0, 2, var10, 0, 2, var10, Blocks.field_150344_f, Blocks.field_150350_a, false);
                        this.func_151549_a(par1World, par3StructureBoundingBox, 2, 2, var10, 2, 2, var10, Blocks.field_150344_f, Blocks.field_150350_a, false);
                    }
                    else
                    {
                        this.func_151549_a(par1World, par3StructureBoundingBox, 0, 2, var10, 2, 2, var10, Blocks.field_150344_f, Blocks.field_150350_a, false);
                    }

                    this.func_151552_a(par1World, par3StructureBoundingBox, par2Random, 0.1F, 0, 2, var10 - 1, Blocks.field_150321_G, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox, par2Random, 0.1F, 2, 2, var10 - 1, Blocks.field_150321_G, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox, par2Random, 0.1F, 0, 2, var10 + 1, Blocks.field_150321_G, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox, par2Random, 0.1F, 2, 2, var10 + 1, Blocks.field_150321_G, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox, par2Random, 0.05F, 0, 2, var10 - 2, Blocks.field_150321_G, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox, par2Random, 0.05F, 2, 2, var10 - 2, Blocks.field_150321_G, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox, par2Random, 0.05F, 0, 2, var10 + 2, Blocks.field_150321_G, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox, par2Random, 0.05F, 2, 2, var10 + 2, Blocks.field_150321_G, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox, par2Random, 0.05F, 1, 2, var10 - 1, Blocks.field_150478_aa, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox, par2Random, 0.05F, 1, 2, var10 + 1, Blocks.field_150478_aa, 0);

                    if (par2Random.nextInt(100) == 0)
                    {
                        this.generateStructureChestContents(par1World, par3StructureBoundingBox, par2Random, 2, 0, var10 - 1, WeightedRandomChestContent.func_92080_a(StructureMineshaftPieces.mineshaftChestContents, new WeightedRandomChestContent[] {Items.field_151134_bR.func_92114_b(par2Random)}), 3 + par2Random.nextInt(4));
                    }

                    if (par2Random.nextInt(100) == 0)
                    {
                        this.generateStructureChestContents(par1World, par3StructureBoundingBox, par2Random, 0, 0, var10 + 1, WeightedRandomChestContent.func_92080_a(StructureMineshaftPieces.mineshaftChestContents, new WeightedRandomChestContent[] {Items.field_151134_bR.func_92114_b(par2Random)}), 3 + par2Random.nextInt(4));
                    }
                    ...
                    if (this.hasSpiders && !this.spawnerPlaced)
                    {
                        ...
                        if (par3StructureBoundingBox.isVecInside(var13, var11, var12))
                        {
                            ...
                            par1World.func_147465_d(var13, var11, var12, Blocks.field_150474_ac, 0, 2);
                            TileEntityMobSpawner var14 = (TileEntityMobSpawner)par1World.func_147438_o(var13, var11, var12);
                ...
                for (var9 = 0; var9 <= 2; ++var9)
                {
                    for (var10 = 0; var10 <= var8; ++var10)
                    {
                        ...
                        {
                            byte var18 = -1;
                            this.func_151550_a(par1World, Blocks.field_150344_f, 0, var9, var18, var10, par3StructureBoundingBox);
                        }
                    }
                }
                ...
                if (this.hasRails)
                {
                    for (var9 = 0; var9 <= var8; ++var9)
                    {
                        ...
                        {
                            this.func_151552_a(par1World, par3StructureBoundingBox, par2Random, 0.7F, 1, 0, var9, Blocks.field_150448_aq, this.func_151555_a(Blocks.field_150448_aq, 0));
                        }
                    }
                }
