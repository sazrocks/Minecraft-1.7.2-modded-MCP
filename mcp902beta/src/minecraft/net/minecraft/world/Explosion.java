                ...
                for (var5 = 0; var5 < this.field_77289_h; ++var5)
                {
                    if (var3 == 0 || var3 == this.field_77289_h - 1 || var4 == 0 || var4 == this.field_77289_h - 1 || var5 == 0 || var5 == this.field_77289_h - 1)
                    {
                        ...
                        for (float var21 = 0.3F; var14 > 0.0F; var14 -= var21 * 0.75F)
                        {
                            ...
                            Block var25 = this.worldObj.func_147439_a(var22, var23, var24);

                            if (var25.func_149688_o() != Material.field_151579_a)
                            {
                                float var26 = this.exploder != null ? this.exploder.func_145772_a(this, this.worldObj, var22, var23, var24, var25) : var25.func_149638_a(this.exploder);
    ...
    public void doExplosionB(boolean par1)
    {
        ...
        if (this.isSmoking)
        {
            ...
            while (var2.hasNext())
            {
                ...
                var7 = this.worldObj.func_147439_a(var4, var5, var6);
                ...
                if (var7.func_149688_o() != Material.field_151579_a)
                {
                    ...
                    {
                        var7.func_149690_a(this.worldObj, var4, var5, var6, this.worldObj.getBlockMetadata(var4, var5, var6), 1.0F / this.explosionSize, 0);
                    }

                    this.worldObj.func_147465_d(var4, var5, var6, Blocks.field_150350_a, 0, 3);
                    var7.func_149723_a(this.worldObj, var4, var5, var6, this);
                }
            }
        }
        ...
        if (this.isFlaming)
        {
            ...
            while (var2.hasNext())
            {
                ...
                var6 = var3.field_151328_c;
                var7 = this.worldObj.func_147439_a(var4, var5, var6);
                Block var24 = this.worldObj.func_147439_a(var4, var5 - 1, var6);

                if (var7.func_149688_o() == Material.field_151579_a && var24.func_149730_j() && this.explosionRNG.nextInt(3) == 0)
                {
                    this.worldObj.func_147449_b(var4, var5, var6, Blocks.field_150480_ab);
                }
            }
        }
    }
