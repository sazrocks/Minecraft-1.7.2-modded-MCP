...
public class BiomeDecorator
{
    ...
    public BiomeDecorator()
    {
        ...
        this.gravelAsSandGen = new WorldGenSand(Blocks.field_150351_n, 6);
        this.dirtGen = new WorldGenMinable(Blocks.field_150346_d, 32);
        this.gravelGen = new WorldGenMinable(Blocks.field_150351_n, 32);
        ...
        this.redstoneGen = new WorldGenMinable(Blocks.field_150450_ax, 7);
    ...
    protected void func_150513_a(BiomeGenBase p_150513_1_)
    {
        ...
        for (var3 = 0; var3 < this.deadBushPerChunk; ++var3)
        {
            ...
            var5 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
            var6 = this.randomGenerator.nextInt(this.currentWorld.getHeightValue(var4, var5) * 2);
            (new WorldGenDeadBush(Blocks.field_150330_I)).generate(this.currentWorld, this.randomGenerator, var4, var6, var5);
        }
        ...
        for (var3 = 0; var3 < this.waterlilyPerChunk; ++var3)
        {
            ...
            for (var6 = this.randomGenerator.nextInt(this.currentWorld.getHeightValue(var4, var5) * 2); var6 > 0 && this.currentWorld.func_147437_c(var4, var6 - 1, var5); --var6)
            {
                ;
            }
        ...
        if (this.generateLakes)
        {
            for (var3 = 0; var3 < 50; ++var3)
            {
                ...
                (new WorldGenLiquids(Blocks.field_150358_i)).generate(this.currentWorld, this.randomGenerator, var4, var5, var6);
            }
            ...
            for (var3 = 0; var3 < 20; ++var3)
            {
                ...
                var6 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
                (new WorldGenLiquids(Blocks.field_150356_k)).generate(this.currentWorld, this.randomGenerator, var4, var5, var6);
            }
        }
    }
