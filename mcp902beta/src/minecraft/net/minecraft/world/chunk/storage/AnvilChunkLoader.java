...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO
{
    ...
    protected Chunk checkedReadChunkFromNBT(World par1World, int par2, int par3, NBTTagCompound par4NBTTagCompound)
    {
        ...
        else
        {
            ...
            {
                field_151505_a.error("Chunk file at " + par2 + "," + par3 + " is in the wrong location; relocating. (Expected " + par2 + ", " + par3 + ", got " + var5.xPosition + ", " + var5.zPosition + ")");
    ...
    private void writeChunkToNBT(Chunk par1Chunk, World par2World, NBTTagCompound par3NBTTagCompound)
    {
        ...
        var18 = par1Chunk.field_150816_i.values().iterator();

        while (var18.hasNext())
        {
            TileEntity var21 = (TileEntity)var18.next();
            var11 = new NBTTagCompound();
            var21.func_145841_b(var11);
        ...
        if (var19 != null)
        {
            ...
            while (var13.hasNext())
            {
                ...
                var15.setInteger("i", Block.func_149682_b(var14.func_151351_a()));
    ...
    private Chunk readChunkFromNBT(World par1World, NBTTagCompound par2NBTTagCompound)
    {
        ...
        var5.field_150814_l = par2NBTTagCompound.getBoolean("LightPopulated");
        var5.inhabitedTime = par2NBTTagCompound.getLong("InhabitedTime");
        NBTTagList var6 = par2NBTTagCompound.func_150295_c("Sections", 10);
        byte var7 = 16;
        ...
        NBTTagList var17 = par2NBTTagCompound.func_150295_c("Entities", 10);
        ...
        NBTTagList var19 = par2NBTTagCompound.func_150295_c("TileEntities", 10);
        ...
        {
            NBTTagList var23 = par2NBTTagCompound.func_150295_c("TileTicks", 10);

            if (var23 != null)
            {
                for (int var25 = 0; var25 < var23.tagCount(); ++var25)
                {
                    NBTTagCompound var27 = var23.func_150305_b(var25);
                    par1World.func_147446_b(var27.getInteger("x"), var27.getInteger("y"), var27.getInteger("z"), Block.func_149729_e(var27.getInteger("i")), var27.getInteger("t"), var27.getInteger("p"));
                }
            }
        }
