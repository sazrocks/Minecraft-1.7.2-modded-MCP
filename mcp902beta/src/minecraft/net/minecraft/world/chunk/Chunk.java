...
public class Chunk
{
    ...
    private void updateSkylightNeighborHeight(int par1, int par2, int par3, int par4)
    {
        if (par4 > par3 && this.worldObj.doChunksNearChunkExist(par1, 0, par2, 16))
        {
            ...
            {
                this.worldObj.func_147463_c(EnumSkyBlock.Sky, par1, var5, par2);
            }
    ...
    public boolean func_150807_a(int p_150807_1_, int p_150807_2_, int p_150807_3_, Block p_150807_4_, int p_150807_5_)
    {
        ...
        else
        {
            ...
            {
                var8.func_149725_f(this.worldObj, var12, p_150807_2_, var13, var9);
            }
            ...
            if (!this.worldObj.isRemote)
            {
                var8.func_149749_a(this.worldObj, var12, p_150807_2_, var13, var8, var9);
            }
            else if (var8 instanceof ITileEntityProvider && var8 != p_150807_4_)
            {
                this.worldObj.func_147475_p(var12, p_150807_2_, var13);
            }
            ...
            else
            {
                ...
                if (!this.worldObj.isRemote)
                {
                    p_150807_4_.func_149726_b(this.worldObj, var12, p_150807_2_, var13);
                }
                ...
                if (p_150807_4_ instanceof ITileEntityProvider)
                {
                    ...
                    if (var16 == null)
                    {
                        var16 = ((ITileEntityProvider)p_150807_4_).func_149915_a(this.worldObj, p_150807_5_);
                        this.worldObj.func_147455_a(var12, p_150807_2_, var13, var16);
                    }
    ...
    public TileEntity func_150806_e(int p_150806_1_, int p_150806_2_, int p_150806_3_)
    {
        ...
        if (var5 == null)
        {
            ...
            var5 = ((ITileEntityProvider)var6).func_149915_a(this.worldObj, this.getBlockMetadata(p_150806_1_, p_150806_2_, p_150806_3_));
            this.worldObj.func_147455_a(this.xPosition * 16 + p_150806_1_, p_150806_2_, this.zPosition * 16 + p_150806_3_, var5);
        }
    ...
    public void enqueueRelightChecks()
    {
        for (int var1 = 0; var1 < 8; ++var1)
        {
            ...
            for (int var7 = 0; var7 < 16; ++var7)
            {
                ...
                if (this.storageArrays[var2] == null && (var7 == 0 || var7 == 15 || var3 == 0 || var3 == 15 || var4 == 0 || var4 == 15) || this.storageArrays[var2] != null && this.storageArrays[var2].func_150819_a(var3, var7, var4).func_149688_o() == Material.field_151579_a)
                {
                    if (this.worldObj.func_147439_a(var5, var8 - 1, var6).func_149750_m() > 0)
                    {
                    ...
                    if (this.worldObj.func_147439_a(var5 - 1, var8, var6).func_149750_m() > 0)
                    {
                    ...
                    if (this.worldObj.func_147439_a(var5, var8, var6 - 1).func_149750_m() > 0)
                    {
