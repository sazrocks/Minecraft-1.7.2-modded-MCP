...
public class Teleporter
{
            ...
            for (int var14 = -2; var14 <= 2; ++var14)
            {
                for (int var15 = -2; var15 <= 2; ++var15)
                {
                    for (int var16 = -1; var16 < 3; ++var16)
                    {
                        ...
                        this.worldServerInstance.func_147449_b(var17, var18, var19, var20 ? Blocks.field_150343_Z : Blocks.field_150350_a);
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            for (var48 = var15 - var9; var48 <= var15 + var9; ++var48)
            {
                ...
                for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23)
                {
                    ...
                    {
                        if (this.worldServerInstance.func_147439_a(var48, var26, var23) == Blocks.field_150427_aO)
                        {
                            while (this.worldServerInstance.func_147439_a(var48, var26 - 1, var23) == Blocks.field_150427_aO)
                            {
                                --var26;
                            }
        ...
        if (var10 >= 0.0D)
        {
            ...
            if (this.worldServerInstance.func_147439_a(var12 - 1, var13, var14) == Blocks.field_150427_aO)
            {
                var50 = 2;
            }
            ...
            if (this.worldServerInstance.func_147439_a(var12, var13, var14 - 1) == Blocks.field_150427_aO)
            {
                var50 = 3;
            }
            ...
            if (var50 > -1)
            {
                ...
                boolean var36 = !this.worldServerInstance.func_147437_c(var12 + var32 + var34, var13, var14 + var33 + var35) || !this.worldServerInstance.func_147437_c(var12 + var32 + var34, var13 + 1, var14 + var33 + var35);
                boolean var37 = !this.worldServerInstance.func_147437_c(var12 + var32, var13, var14 + var33) || !this.worldServerInstance.func_147437_c(var12 + var32, var13 + 1, var14 + var33);
                ...
                if (var36 && var37)
                {
                    ...
                    var27 -= (double)var35;
                    var36 = !this.worldServerInstance.func_147437_c(var48 + var32 + var34, var13, var22 + var33 + var35) || !this.worldServerInstance.func_147437_c(var48 + var32 + var34, var13 + 1, var22 + var33 + var35);
                    var37 = !this.worldServerInstance.func_147437_c(var48 + var32, var13, var22 + var33) || !this.worldServerInstance.func_147437_c(var48 + var32, var13 + 1, var22 + var33);
                }
    ...
    public boolean makePortal(Entity par1Entity)
    {
        ...
        for (var13 = var5 - var2; var13 <= var5 + var2; ++var13)
        {
            ...
            for (var16 = var7 - var2; var16 <= var7 + var2; ++var16)
            {
                ...
                {
                    if (this.worldServerInstance.func_147437_c(var13, var19, var16))
                    {
                        while (var19 > 0 && this.worldServerInstance.func_147437_c(var13, var19 - 1, var16))
                        {
                            --var19;
                        }
                            ...
                            for (var23 = 0; var23 < 3; ++var23)
                            {
                                for (var24 = 0; var24 < 4; ++var24)
                                {
                                    for (var25 = -1; var25 < 4; ++var25)
                                    {
                                        ...
                                        if (var25 < 0 && !this.worldServerInstance.func_147439_a(var26, var27, var28).func_149688_o().isSolid() || var25 >= 0 && !this.worldServerInstance.func_147437_c(var26, var27, var28))
                                        {
                                            continue label274;
                                        }
                                    }
                            ...
                            for (var20 = var12; var20 < var12 + 2; ++var20)
                            {
                                ...
                                for (var23 = 0; var23 < 4; ++var23)
                                {
                                    for (var24 = -1; var24 < 4; ++var24)
                                    {
                                        ...
                                        if (var24 < 0 && !this.worldServerInstance.func_147439_a(var25, var26, var27).func_149688_o().isSolid() || var24 >= 0 && !this.worldServerInstance.func_147437_c(var25, var26, var27))
                                        {
                                            continue label222;
                                        }
                                    }
            ...
            for (var19 = -1; var19 <= 1; ++var19)
            {
                for (var20 = 1; var20 < 3; ++var20)
                {
                    for (var21 = -1; var21 < 3; ++var21)
                    {
                        ...
                        var33 = var21 < 0;
                        this.worldServerInstance.func_147449_b(var22, var23, var24, var33 ? Blocks.field_150343_Z : Blocks.field_150350_a);
                    }
                }
            }
        }
        ...
        for (var19 = 0; var19 < 4; ++var19)
        {
            for (var20 = 0; var20 < 4; ++var20)
            {
                for (var21 = -1; var21 < 4; ++var21)
                {
                    ...
                    this.worldServerInstance.func_147465_d(var22, var23, var24, (Block)(var33 ? Blocks.field_150343_Z : Blocks.field_150427_aO), 0, 2);
                }
            }
            ...
            for (var20 = 0; var20 < 4; ++var20)
            {
                for (var21 = -1; var21 < 4; ++var21)
                {
                    ...
                    var23 = var15 + var21;
                    var24 = var16 + (var20 - 1) * var18;
                    this.worldServerInstance.func_147459_d(var22, var23, var24, this.worldServerInstance.func_147439_a(var22, var23, var24));
                }
            }
        }
