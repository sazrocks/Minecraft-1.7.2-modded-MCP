...
public class TileEntityEnderChest extends TileEntity
{
    ...
    public void func_145845_h()
    {
        ...
        if (this.field_145973_j > 0 && this.field_145972_a == 0.0F)
        {
            ...
            this.field_145850_b.playSoundEffect(var2, (double)this.field_145848_d + 0.5D, var4, "random.chestopen", 0.5F, this.field_145850_b.rand.nextFloat() * 0.1F + 0.9F);
        }
        ...
        if (this.field_145973_j == 0 && this.field_145972_a > 0.0F || this.field_145973_j > 0 && this.field_145972_a < 1.0F)
        {
            ...
            if (this.field_145972_a < var3 && var8 >= var3)
            {
                ...
                this.field_145850_b.playSoundEffect(var4, (double)this.field_145848_d + 0.5D, var6, "random.chestclosed", 0.5F, this.field_145850_b.rand.nextFloat() * 0.1F + 0.9F);
            }
