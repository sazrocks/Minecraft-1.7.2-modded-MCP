...
public class TileEntityBeacon extends TileEntity implements IInventory
{
    ...
    private void func_146000_x()
    {
        if (this.field_146015_k && this.field_146012_l > 0 && !this.field_145850_b.isRemote && this.field_146013_m > 0)
        {
            ...
            var4.maxY = (double)this.field_145850_b.getHeight();
            List var5 = this.field_145850_b.getEntitiesWithinAABB(EntityPlayer.class, var4);
    ...
    private void func_146003_y()
    {
        ...
        if (!this.field_145850_b.isRemote && this.field_146012_l == 4 && var1 < this.field_146012_l)
        {
            Iterator var8 = this.field_145850_b.getEntitiesWithinAABB(EntityPlayer.class, AxisAlignedBB.getAABBPool().getAABB((double)this.field_145851_c, (double)this.field_145848_d, (double)this.field_145849_e, (double)this.field_145851_c, (double)(this.field_145848_d - 4), (double)this.field_145849_e).expand(10.0D, 5.0D, 10.0D)).iterator();
    ...
    public float func_146002_i()
    {
        ...
        {
            int var1 = (int)(this.field_145850_b.getTotalWorldTime() - this.field_146016_i);
    ...
    {
        return par2ItemStack.getItem() == Items.field_151166_bC || par2ItemStack.getItem() == Items.field_151045_i || par2ItemStack.getItem() == Items.field_151043_k || par2ItemStack.getItem() == Items.field_151042_j;
    }
}
