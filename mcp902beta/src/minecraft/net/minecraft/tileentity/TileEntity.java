...
public class TileEntity
{
    ...
    public static TileEntity func_145827_c(NBTTagCompound p_145827_0_)
    {
        ...
        try
        {
            Class var2 = (Class)field_145855_i.get(p_145827_0_.getString("id"));
    ...
    public void func_145828_a(CrashReportCategory p_145828_1_)
    {
        ...
        p_145828_1_.addCrashSectionCallable("Actual block data value", new Callable()
        {
            ...
            public String call()
            {
                int var1 = TileEntity.this.field_145850_b.getBlockMetadata(TileEntity.this.field_145851_c, TileEntity.this.field_145848_d, TileEntity.this.field_145849_e);
