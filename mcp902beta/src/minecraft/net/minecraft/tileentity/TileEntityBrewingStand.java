...
public class TileEntityBrewingStand extends TileEntity implements ISidedInventory
{
    ...
    public void func_145845_h()
    {
        ...
        if (var1 != this.field_145943_l)
        {
            ...
            this.field_145850_b.setBlockMetadataWithNotify(this.field_145851_c, this.field_145848_d, this.field_145849_e, var1, 2);
        }
    ...
    private boolean func_145934_k()
    {
        if (this.field_145945_j[3] != null && this.field_145945_j[3].stackSize > 0)
        {
            ...
            if (!var1.getItem().func_150892_m(var1))
            {
                return false;
            }
            else
            {
                ...
                {
                    if (this.field_145945_j[var3] != null && this.field_145945_j[var3].getItem() == Items.field_151068_bn)
                    {
                        ...
                        List var6 = Items.field_151068_bn.getEffects(var4);
                        List var7 = Items.field_151068_bn.getEffects(var5);
    ...
    private void func_145940_l()
    {
        if (this.func_145934_k())
        {
            ...
            {
                if (this.field_145945_j[var2] != null && this.field_145945_j[var2].getItem() == Items.field_151068_bn)
                {
                    int var3 = this.field_145945_j[var2].getItemDamage();
                    int var4 = this.func_145936_c(var3, var1);
                    List var5 = Items.field_151068_bn.getEffects(var3);
                    List var6 = Items.field_151068_bn.getEffects(var4);
    ...
    {
        return par1 == 3 ? par2ItemStack.getItem().func_150892_m(par2ItemStack) : par2ItemStack.getItem() == Items.field_151068_bn || par2ItemStack.getItem() == Items.field_151069_bo;
    }
