...
public class TileEntityHopper extends TileEntity implements IHopper
{
        ...
        else
        {
            for (int var2 = 0; var2 < this.getSizeInventory(); ++var2)
            {
                if (this.getStackInSlot(var2) != null)
                {
                    ...
                    ItemStack var4 = func_145889_a(var1, this.decrStackSize(var2, 1), Facing.oppositeSide[BlockHopper.func_149918_b(this.func_145832_p())]);
    ...
    public static boolean func_145891_a(IHopper p_145891_0_)
    {
        ...
        {
            EntityItem var6 = func_145897_a(p_145891_0_.func_145831_w(), p_145891_0_.getXPos(), p_145891_0_.getYPos() + 1.0D, p_145891_0_.getZPos());
    ...
    private IInventory func_145895_l()
    {
        ...
        return func_145893_b(this.func_145831_w(), (double)(this.field_145851_c + Facing.offsetsXForSide[var1]), (double)(this.field_145848_d + Facing.offsetsYForSide[var1]), (double)(this.field_145849_e + Facing.offsetsZForSide[var1]));
    }
