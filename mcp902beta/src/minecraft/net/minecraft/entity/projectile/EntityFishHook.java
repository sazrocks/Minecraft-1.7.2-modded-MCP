    ...
    public void onUpdate()
    {
        ...
        else
        {
            if (!this.worldObj.isRemote)
            {
                ...
                if (this.field_146042_b.isDead || !this.field_146042_b.isEntityAlive() || var1 == null || var1.getItem() != Items.field_151112_aM || this.getDistanceSqToEntity(this.field_146042_b) > 1024.0D)
                {
                    this.setDead();
            ...
            MovingObjectPosition var3 = this.worldObj.clip(var26, var2);
            ...
            if (!this.field_146051_au)
            {
                ...
                for (int var34 = 0; var34 < var32; ++var34)
                {
                    ...
                    if (this.worldObj.isAABBInMaterial(var18, Material.field_151586_h))
                    {
                        var33 += 1.0D / (double)var32;
                    }
                }

                if (!this.worldObj.isRemote && var33 > 0.0D)
                {
                    ...
                    else
                    {
                        ...
                        else if (this.field_146040_ay > 0)
                        {
                            ...
                            {
                                var37 = MathHelper.func_151240_a(this.rand, 0.0F, 360.0F) * 0.017453292F;
                                var17 = MathHelper.func_151240_a(this.rand, 25.0F, 60.0F);
