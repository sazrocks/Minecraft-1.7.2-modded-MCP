...
public class EntityPotion extends EntityThrowable
{
    ...
    {
        this(par1World, par2EntityLivingBase, new ItemStack(Items.field_151068_bn, 1, par3));
    }
    ...
    {
        this(par1World, par2, par4, par6, new ItemStack(Items.field_151068_bn, 1, par8));
    }
    ...
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
    {
        ...
        {
            List var2 = Items.field_151068_bn.getEffects(this.potionDamage);
