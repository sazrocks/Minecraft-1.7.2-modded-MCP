...
public class EntityArrowAccurate extends Entity implements IProjectile
{
    ...
    public EntityArrowAccurate(World par1World)
    {
        super(par1World);
    ...
    public EntityArrowAccurate(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityArrowAccurate(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityArrowAccurate(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
    ...
    public void setThrowableHeading(double par1, double par3, double par5, float par7, float par8)
    {
        ...
        par3 /= (double)var9;
        par5 /= (double)var9;
        par1 += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.007499999832361937D * (double)par8 * 1.0;
        par3 += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.007499999832361937D * (double)par8 * 1.0;
        par5 += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.007499999832361937D * (double)par8 * 1.0;
        par1 *= (double)par7;
        par3 *= (double)par7;
        par5 *= (double)par7;
        this.motionX = par1;
    ...
    public void onUpdate()
    {
        ...
        Block var16 = this.worldObj.func_147439_a(this.field_145791_d, this.field_145792_e, this.field_145789_f);

        if (var16.func_149688_o() != Material.field_151579_a)
        {
            var16.func_149719_a(this.worldObj, this.field_145791_d, this.field_145792_e, this.field_145789_f);
            AxisAlignedBB var2 = var16.func_149668_a(this.worldObj, this.field_145791_d, this.field_145792_e, this.field_145789_f);
        ...
        if (this.inGround)
        {
            ...
            //this.worldObj.createExplosion(this, this.posX, this.posY, this.posZ, (float)2.0, true);
            
            this.worldObj.newExplosion((Entity)null, this.posX, this.posY, this.posZ, (float)2.0, true, true);
            this.setDead();
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Items.field_151032_g, 1)))
            {
                var2 = false;
            }
