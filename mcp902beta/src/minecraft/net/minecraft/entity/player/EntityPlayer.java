...
public abstract class EntityPlayer extends EntityLivingBase implements ICommandSender
{
    ...
    protected void updateItemUse(ItemStack par1ItemStack, int par2)
    {
        ...
        if (par1ItemStack.getItemUseAction() == EnumAction.eat)
        {
            for (int var3 = 0; var3 < par2; ++var3)
            {
                ...
                String var6 = "iconcrack_" + Item.func_150891_b(par1ItemStack.getItem());
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            NBTTagList var3 = par1NBTTagCompound.func_150295_c("EnderItems", 10);
    ...
    public void wakeUpPlayer(boolean par1, boolean par2, boolean par3)
    {
        ...
        if (var4 != null && this.worldObj.func_147439_a(var4.posX, var4.posY, var4.posZ) == Blocks.field_150324_C)
        {
    ...
    {
        return this.worldObj.func_147439_a(this.playerLocation.posX, this.playerLocation.posY, this.playerLocation.posZ) == Blocks.field_150324_C;
    }
    ...
    public static ChunkCoordinates verifyRespawnCoordinates(World par0World, ChunkCoordinates par1ChunkCoordinates, boolean par2)
    {
        ...
        if (par0World.func_147439_a(par1ChunkCoordinates.posX, par1ChunkCoordinates.posY, par1ChunkCoordinates.posZ) == Blocks.field_150324_C)
        {
        ...
        {
            Material var4 = par0World.func_147439_a(par1ChunkCoordinates.posX, par1ChunkCoordinates.posY, par1ChunkCoordinates.posZ).func_149688_o();
            Material var5 = par0World.func_147439_a(par1ChunkCoordinates.posX, par1ChunkCoordinates.posY + 1, par1ChunkCoordinates.posZ).func_149688_o();
    ...
    public IIcon getItemIcon(ItemStack par1ItemStack, int par2)
    {
        ...
        if (par1ItemStack.getItem() == Items.field_151112_aM && this.fishEntity != null)
        {
        ...
        else
        {
            ...
            if (this.itemInUse != null && par1ItemStack.getItem() == Items.field_151031_f)
            {
                int var4 = par1ItemStack.getMaxItemUseDuration() - this.itemInUseCount;

                if (var4 >= 18)
                {
                    return Items.field_151031_f.getItemIconForUseDuration(2);
                }

                if (var4 > 13)
                {
                    return Items.field_151031_f.getItemIconForUseDuration(1);
                }

                if (var4 > 0)
                {
                    return Items.field_151031_f.getItemIconForUseDuration(0);
                }
            }
        }
    ...
    public boolean isCurrentToolAdventureModeExempt(int par1, int par2, int par3)
    {
        ...
        else
        {
            ...
            {
                if (var4.func_149688_o().isAdventureModeExempt())
                {
                    return true;
                }
    ...
    public IChatComponent func_145748_c_()
    {
        ...
        var1.func_150256_b().func_150241_a(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/msg " + this.getCommandSenderName() + " "));
        return var1;
    }
