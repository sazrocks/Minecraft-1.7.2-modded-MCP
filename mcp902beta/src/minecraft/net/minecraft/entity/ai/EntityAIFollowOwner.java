                    ...
                    if (!this.thePet.getLeashed())
                    {
                        if (this.thePet.getDistanceSqToEntity(this.theOwner) >= 144.0D)
                        {
                            ...
                            for (int var4 = 0; var4 <= 4; ++var4)
                            {
                                ...
                                {
                                    if ((var4 < 1 || var5 < 1 || var4 > 3 || var5 > 3) && World.func_147466_a(this.theWorld, var1 + var4, var3 - 1, var2 + var5) && !this.theWorld.func_147439_a(var1 + var4, var3, var2 + var5).func_149721_r() && !this.theWorld.func_147439_a(var1 + var4, var3 + 1, var2 + var5).func_149721_r())
                                    {
