...
public class EntityAIEatGrass extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            return this.field_151501_c.func_147439_a(var1, var2, var3) == Blocks.field_150329_H && this.field_151501_c.getBlockMetadata(var1, var2, var3) == 1 ? true : this.field_151501_c.func_147439_a(var1, var2 - 1, var3) == Blocks.field_150349_c;
        }
    }
    ...
    public void updateTask()
    {
        ...
        if (this.field_151502_a == 4)
        {
            ...
            else if (this.field_151501_c.func_147439_a(var1, var2 - 1, var3) == Blocks.field_150349_c)
            {
                if (this.field_151501_c.getGameRules().getGameRuleBooleanValue("mobGriefing"))
                {
                    this.field_151501_c.playAuxSFX(2001, var1, var2 - 1, var3, Block.func_149682_b(Blocks.field_150349_c));
