...
public class EntityAIOcelotSit extends EntityAIBase
{
    ...
    private boolean func_151485_f()
    {
        ...
        for (int var4 = (int)this.field_151493_a.posX - 8; (double)var4 < this.field_151493_a.posX + 8.0D; ++var4)
        {
            ...
            {
                if (this.func_151486_a(this.field_151493_a.worldObj, var4, var1, var5) && this.field_151493_a.worldObj.func_147437_c(var4, var1 + 1, var5))
                {
    ...
    {
        Block var5 = p_151486_1_.func_147439_a(p_151486_2_, p_151486_3_, p_151486_4_);
        int var6 = p_151486_1_.getBlockMetadata(p_151486_2_, p_151486_3_, p_151486_4_);

        if (var5 == Blocks.field_150486_ae)
        {
            TileEntityChest var7 = (TileEntityChest)p_151486_1_.func_147438_o(p_151486_2_, p_151486_3_, p_151486_4_);
