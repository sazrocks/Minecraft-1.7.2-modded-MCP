...
public class EntityAIControlledByPlayer extends EntityAIBase
{
    ...
    public void updateTask()
    {
        ...
        {
            var8 = this.thisEntity.worldObj.func_147439_a(MathHelper.floor_float((float)var4), MathHelper.floor_float((float)var5) - 1, MathHelper.floor_float((float)var6)).field_149765_K * 0.91F;
        }
        ...
        {
            Block var20 = this.thisEntity.worldObj.func_147439_a(var4, var5, var6);
            boolean var21 = !this.func_151498_a(var20) && (var20.func_149688_o() != Material.field_151579_a || !this.func_151498_a(this.thisEntity.worldObj.func_147439_a(var4, var5 - 1, var6)));
        ...
        if (!var1.capabilities.isCreativeMode && this.currentSpeed >= this.maxSpeed * 0.5F && this.thisEntity.getRNG().nextFloat() < 0.006F && !this.speedBoosted)
        {
            ...
            if (var22 != null && var22.getItem() == Items.field_151146_bM)
            {
                var22.damageItem(1, var1);

                if (var22.stackSize == 0)
                {
                    ItemStack var23 = new ItemStack(Items.field_151112_aM);
