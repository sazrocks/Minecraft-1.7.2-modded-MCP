...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob
{
    ...
    private boolean destroyBlocksInAABB(AxisAlignedBB par1AxisAlignedBB)
    {
        ...
        for (int var10 = var2; var10 <= var5; ++var10)
        {
            for (int var11 = var3; var11 <= var6; ++var11)
            {
                ...
                {
                    Block var13 = this.worldObj.func_147439_a(var10, var11, var12);

                    if (var13.func_149688_o() != Material.field_151579_a)
                    {
                        if (var13 != Blocks.field_150343_Z && var13 != Blocks.field_150377_bs && var13 != Blocks.field_150357_h && this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing"))
                        {
                            var9 = this.worldObj.func_147468_f(var10, var11, var12) || var9;
                        }
                        else
                        {
                            var8 = true;
    ...
    private void createEnderPortal(int par1, int par2)
    {
                ...
                for (int var7 = par2 - var4; var7 <= par2 + var4; ++var7)
                {
                    ...
                    if (var12 <= ((double)var4 - 0.5D) * ((double)var4 - 0.5D))
                    {
                        if (var5 < var3)
                        {
                            ...
                            {
                                this.worldObj.func_147449_b(var6, var5, var7, Blocks.field_150357_h);
                            }
                        }
                        else if (var5 > var3)
                        {
                            this.worldObj.func_147449_b(var6, var5, var7, Blocks.field_150350_a);
                        }
                        ...
                        {
                            this.worldObj.func_147449_b(var6, var5, var7, Blocks.field_150384_bq);
                        }
                    }
                }
            }
        ...
        this.worldObj.func_147449_b(par1, var3 + 0, par2, Blocks.field_150357_h);
        this.worldObj.func_147449_b(par1, var3 + 1, par2, Blocks.field_150357_h);
        this.worldObj.func_147449_b(par1, var3 + 2, par2, Blocks.field_150357_h);
        this.worldObj.func_147449_b(par1 - 1, var3 + 2, par2, Blocks.field_150478_aa);
        this.worldObj.func_147449_b(par1 + 1, var3 + 2, par2, Blocks.field_150478_aa);
        this.worldObj.func_147449_b(par1, var3 + 2, par2 - 1, Blocks.field_150478_aa);
        this.worldObj.func_147449_b(par1, var3 + 2, par2 + 1, Blocks.field_150478_aa);
        this.worldObj.func_147449_b(par1, var3 + 3, par2, Blocks.field_150357_h);
        this.worldObj.func_147449_b(par1, var3 + 4, par2, Blocks.field_150380_bt);
