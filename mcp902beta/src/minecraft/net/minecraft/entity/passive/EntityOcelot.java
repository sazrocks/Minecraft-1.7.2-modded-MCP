...
public class EntityOcelot extends EntityTameable
{
    ...
    public EntityOcelot(World par1World)
    {
        ...
        this.tasks.addTask(3, this.aiTempt = new EntityAITempt(this, 0.6D, Items.field_151115_aP, true));
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        else if (this.aiTempt.isRunning() && var2 != null && var2.getItem() == Items.field_151115_aP && par1EntityPlayer.getDistanceSqToEntity(this) < 9.0D)
        {
    ...
    {
        return par1ItemStack != null && par1ItemStack.getItem() == Items.field_151115_aP;
    }
    ...
    public boolean getCanSpawnHere()
    {
        ...
        else
        {
            if (this.worldObj.checkNoEntityCollision(this.boundingBox) && this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox).isEmpty() && !this.worldObj.isAnyLiquid(this.boundingBox))
            {
                ...
                Block var4 = this.worldObj.func_147439_a(var1, var2 - 1, var3);
