...
public class EntityPig extends EntityAnimal
{
    ...
    public EntityPig(World par1World)
    {
        ...
        this.tasks.addTask(4, new EntityAITempt(this, 1.2D, Items.field_151146_bM, false));
        this.tasks.addTask(4, new EntityAITempt(this, 1.2D, Items.field_151172_bF, false));
    ...
    public boolean canBeSteered()
    {
        ...
        return var1 != null && var1.getItem() == Items.field_151146_bM;
    }
    ...
    {
        return this.isBurning() ? Items.field_151157_am : Items.field_151147_al;
    }
    ...
    public void onStruckByLightning(EntityLightningBolt par1EntityLightningBolt)
    {
        if (!this.worldObj.isRemote)
        {
            ...
            var2.setCurrentItemOrArmor(0, new ItemStack(Items.field_151010_B));
    ...
    {
        return par1ItemStack != null && par1ItemStack.getItem() == Items.field_151172_bF;
    }
