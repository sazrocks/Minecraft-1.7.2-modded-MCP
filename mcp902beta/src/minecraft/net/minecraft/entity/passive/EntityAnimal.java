...
public abstract class EntityAnimal extends EntityAgeable implements IAnimals
{
    ...
    {
        return this.worldObj.func_147439_a(par1, par2 - 1, par3) == Blocks.field_150349_c ? 10.0F : this.worldObj.getLightBrightness(par1, par2, par3) - 0.5F;
    }
    ...
    public boolean getCanSpawnHere()
    {
        ...
        return this.worldObj.func_147439_a(var1, var2 - 1, var3) == Blocks.field_150349_c && this.worldObj.getFullBlockLightValue(var1, var2, var3) > 8 && super.getCanSpawnHere();
    }
    ...
    {
        return par1ItemStack.getItem() == Items.field_151015_O;
    }
