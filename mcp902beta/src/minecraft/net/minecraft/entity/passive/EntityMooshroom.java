...
public class EntityMooshroom extends EntityCow
{
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (var2 != null && var2.getItem() == Items.field_151054_z && this.getGrowingAge() >= 0)
        {
            if (var2.stackSize == 1)
            {
                par1EntityPlayer.inventory.setInventorySlotContents(par1EntityPlayer.inventory.currentItem, new ItemStack(Items.field_151009_A));
                return true;
            }

            if (par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Items.field_151009_A)) && !par1EntityPlayer.capabilities.isCreativeMode)
            {
        ...
        if (var2 != null && var2.getItem() == Items.field_151097_aZ && this.getGrowingAge() >= 0)
        {
            this.setDead();
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                {
                    this.worldObj.spawnEntityInWorld(new EntityItem(this.worldObj, this.posX, this.posY + (double)this.height, this.posZ, new ItemStack(Blocks.field_150337_Q)));
                }
