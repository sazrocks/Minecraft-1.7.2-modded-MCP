...
public class EntityHorse extends EntityAnimal implements IInvBasic
{
    ...
    protected void fall(float par1)
    {
        ...
        if (var2 > 0)
        {
            ...
            Block var3 = this.worldObj.func_147439_a(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY - 0.2D - (double)this.prevRotationYaw), MathHelper.floor_double(this.posZ));
    ...
    protected Item func_146068_u()
    {
        ...
        return var2 == 4 ? Items.field_151103_aS : (var2 == 3 ? (var1 ? Item.func_150899_d(0) : Items.field_151078_bh) : Items.field_151116_aA);
    }
    ...
    protected void func_145780_a(int p_145780_1_, int p_145780_2_, int p_145780_3_, Block p_145780_4_)
    {
        ...
        if (this.worldObj.func_147439_a(p_145780_1_, p_145780_2_ + 1, p_145780_3_) == Blocks.field_150431_aC)
        {
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (var2 != null && var2.getItem() == Items.field_151063_bx)
        {
        ...
        else
        {
            if (var2 != null)
            {
                ...
                if (this.func_110259_cr())
                {
                    ...
                    if (var2.getItem() == Items.field_151138_bX)
                    {
                        var4 = 1;
                    }
                    else if (var2.getItem() == Items.field_151136_bY)
                    {
                        var4 = 2;
                    }
                    else if (var2.getItem() == Items.field_151125_bZ)
                    {
                        var4 = 3;
                    }
                ...
                if (!var3 && !this.func_110256_cu())
                {
                    ...
                    if (var2.getItem() == Items.field_151015_O)
                    {
                        var7 = 2.0F;
                        var5 = 60;
                        var6 = 3;
                    }
                    else if (var2.getItem() == Items.field_151102_aT)
                    {
                        var7 = 1.0F;
                        var5 = 30;
                        var6 = 3;
                    }
                    else if (var2.getItem() == Items.field_151025_P)
                    {
                        var7 = 7.0F;
                        var5 = 180;
                        var6 = 3;
                    }
                    else if (Block.func_149634_a(var2.getItem()) == Blocks.field_150407_cf)
                    {
                        var7 = 20.0F;
                        var5 = 180;
                    }
                    else if (var2.getItem() == Items.field_151034_e)
                    {
                        var7 = 3.0F;
                        var5 = 60;
                        var6 = 3;
                    }
                    else if (var2.getItem() == Items.field_151150_bK)
                    {
                        var7 = 4.0F;
                        var5 = 60;
                        var6 = 5;
                    ...
                    else if (var2.getItem() == Items.field_151153_ao)
                    {
                        var7 = 10.0F;
                        var5 = 240;
                        var6 = 10;
                ...
                if (!var3 && this.func_110229_cs() && !this.isChested() && var2.getItem() == Item.func_150898_a(Blocks.field_150486_ae))
                {
                ...
                if (!var3 && this.func_110253_bW() && !this.isHorseSaddled() && var2.getItem() == Items.field_151141_av)
                {
                    this.openGUI(par1EntityPlayer);
                    return true;
                }
    ...
    public void onLivingUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (!this.isEatingHaystack() && this.riddenByEntity == null && this.rand.nextInt(300) == 0 && this.worldObj.func_147439_a(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY) - 1, MathHelper.floor_double(this.posZ)) == Blocks.field_150349_c)
            {
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (this.isChested())
        {
            NBTTagList var3 = par1NBTTagCompound.func_150295_c("Items", 10);
            this.func_110226_cD();
        ...
        if (par1NBTTagCompound.func_150297_b("SaddleItem", 10))
        {
            ...
            if (var7 != null && var7.getItem() == Items.field_151141_av)
            {
        ...
        {
            this.horseChest.setInventorySlotContents(0, new ItemStack(Items.field_151141_av));
        }
