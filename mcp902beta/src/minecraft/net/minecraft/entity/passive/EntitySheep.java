...
public class EntitySheep extends EntityAnimal
{
    ...
    public EntitySheep(World par1World)
    {
        ...
        this.tasks.addTask(3, new EntityAITempt(this, 1.1D, Items.field_151015_O, false));
        this.tasks.addTask(4, new EntityAIFollowParent(this, 1.1D));
        this.tasks.addTask(5, this.field_146087_bs);
        this.tasks.addTask(6, new EntityAIWander(this, 1.0D));
        this.tasks.addTask(7, new EntityAIWatchClosest(this, EntityPlayer.class, 6.0F));
        this.tasks.addTask(8, new EntityAILookIdle(this));
        this.field_90016_e.setInventorySlotContents(0, new ItemStack(Items.field_151100_aR, 1, 0));
        this.field_90016_e.setInventorySlotContents(1, new ItemStack(Items.field_151100_aR, 1, 0));
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        if (!this.getSheared())
        {
            this.entityDropItem(new ItemStack(Item.func_150898_a(Blocks.field_150325_L), 1, this.getFleeceColor()), 0.0F);
        }
    }
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (var2 != null && var2.getItem() == Items.field_151097_aZ && !this.getSheared() && !this.isChild())
        {
            if (!this.worldObj.isRemote)
            {
                ...
                {
                    EntityItem var5 = this.entityDropItem(new ItemStack(Item.func_150898_a(Blocks.field_150325_L), 1, this.getFleeceColor()), 1.0F);
    ...
    private int func_90014_a(EntityAnimal par1EntityAnimal, EntityAnimal par2EntityAnimal)
    {
        ...
        if (var5 != null && var5.getItem() == Items.field_151100_aR)
        {
