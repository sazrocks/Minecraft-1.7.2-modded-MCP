...
public abstract class EntityLiving extends EntityLivingBase
{
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            var2 = par1NBTTagCompound.func_150295_c("Equipment", 10);

            for (var3 = 0; var3 < this.equipment.length; ++var3)
            {
                this.equipment[var3] = ItemStack.loadItemStackFromNBT(var2.func_150305_b(var3));
            }
        }

        if (par1NBTTagCompound.func_150297_b("DropChances", 9))
        {
            var2 = par1NBTTagCompound.func_150295_c("DropChances", 5);
                ...
                if (!var3.isDead && var3.getEntityItem() != null)
                {
                    ...
                    if (var5 > -1)
                    {
                        ...
                        if (var6)
                        {
                            ...
                            if (var4.getItem() == Items.field_151045_i && var3.func_145800_j() != null)
                            {
    ...
    public int getMaxSafePointTries()
    {
        ...
        else
        {
            ...
            var1 -= (3 - this.worldObj.difficultySetting.func_151525_a()) * 4;
    ...
    {
        if (par0ItemStack.getItem() != Item.func_150898_a(Blocks.field_150423_aK) && par0ItemStack.getItem() != Items.field_151144_bL)
        {
    ...
    public final boolean interactFirst(EntityPlayer par1EntityPlayer)
    {
        ...
        else
        {
            ...
            if (var2 != null && var2.getItem() == Items.field_151058_ca && this.allowLeashing())
            {
