...
public class EntityItem extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (this.onGround)
            {
                var2 = this.worldObj.func_147439_a(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.boundingBox.minY) - 1, MathHelper.floor_double(this.posZ)).field_149765_K * 0.98F;
            }
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2)
    {
        ...
        else if (this.getEntityItem() != null && this.getEntityItem().getItem() == Items.field_151156_bN && par1DamageSource.isExplosion())
        {
            return false;
        }
        else
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.field_145804_b == 0 && (this.field_145802_g == null || 6000 - this.age <= 200 || this.field_145802_g.equals(par1EntityPlayer.getCommandSenderName())) && par1EntityPlayer.inventory.addItemStackToInventory(var2))
            {
                if (var2.getItem() == Item.func_150898_a(Blocks.field_150364_r))
                {
                    par1EntityPlayer.triggerAchievement(AchievementList.mineWood);
                }

                if (var2.getItem() == Item.func_150898_a(Blocks.field_150363_s))
                {
                    par1EntityPlayer.triggerAchievement(AchievementList.mineWood);
                }

                if (var2.getItem() == Items.field_151116_aA)
                {
                    par1EntityPlayer.triggerAchievement(AchievementList.killCow);
                }

                if (var2.getItem() == Items.field_151045_i)
                {
                    par1EntityPlayer.triggerAchievement(AchievementList.diamonds);
                }

                if (var2.getItem() == Items.field_151072_bj)
                {
                    par1EntityPlayer.triggerAchievement(AchievementList.blazeRod);
                }

                if (var2.getItem() == Items.field_151045_i && this.func_145800_j() != null)
                {
