    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                {
                    if (this.worldObj.func_147439_a(var1, var2, var3) != this.field_145811_e)
                    {
                        this.setDead();
                        return;
                    }

                    this.worldObj.func_147468_f(var1, var2, var3);
                }
                ...
                if (this.onGround)
                {
                    ...
                    if (this.worldObj.func_147439_a(var1, var2, var3) != Blocks.field_150326_M)
                    {
                        this.setDead();

                        if (!this.field_145808_f && this.worldObj.func_147472_a(this.field_145811_e, var1, var2, var3, true, 1, (Entity)null, (ItemStack)null) && !BlockFalling.func_149831_e(this.worldObj, var1, var2 - 1, var3) && this.worldObj.func_147465_d(var1, var2, var3, this.field_145811_e, this.field_145814_a, 3))
                        {
                            ...
                            {
                                TileEntity var4 = this.worldObj.func_147438_o(var1, var2, var3);
                ...
                else if (this.field_145812_b > 100 && !this.worldObj.isRemote && (var2 < 1 || var2 > 256) || this.field_145812_b > 600)
                {
