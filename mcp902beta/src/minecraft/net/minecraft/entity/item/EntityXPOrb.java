...
public class EntityXPOrb extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if (this.onGround)
        {
            var13 = this.worldObj.func_147439_a(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.boundingBox.minY) - 1, MathHelper.floor_double(this.posZ)).field_149765_K * 0.98F;
        }
