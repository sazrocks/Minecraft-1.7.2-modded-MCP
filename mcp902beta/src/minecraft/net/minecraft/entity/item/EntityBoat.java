...
public class EntityBoat extends Entity
{
        ...
        else
        {
            ...
            for (var22 = 0; var22 < 4; ++var22)
            {
                ...
                for (int var25 = 0; var25 < 2; ++var25)
                {
                    ...
                    Block var27 = this.worldObj.func_147439_a(var23, var12, var10);

                    if (var27 == Blocks.field_150431_aC)
                    {
                        this.worldObj.func_147468_f(var23, var12, var10);
    ...
    protected void updateFallState(double par1, boolean par3)
    {
        ...
        else if (this.worldObj.func_147439_a(var4, var5 - 1, var6).func_149688_o() != Material.field_151586_h && par1 < 0.0D)
        {
