...
public abstract class EntityLivingBase extends Entity
{
    ...
    protected void updateFallState(double par1, boolean par3)
    {
        ...
        if (par3 && this.fallDistance > 0.0F)
        {
            ...
            {
                int var8 = this.worldObj.func_147439_a(var4, var5 - 1, var6).func_149645_b();

                if (var8 == 11 || var8 == 32 || var8 == 21)
                {
                    var7 = this.worldObj.func_147439_a(var4, var5 - 1, var6);
                }
            }
            ...
            var7.func_149746_a(this.worldObj, var4, var5, var6, this, this.fallDistance);
        }
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            NBTTagList var2 = par1NBTTagCompound.func_150295_c("ActiveEffects", 10);
    ...
    public void renderBrokenItemStack(ItemStack par1ItemStack)
    {
        ...
        for (int var2 = 0; var2 < 5; ++var2)
        {
            ...
            this.worldObj.spawnParticle("iconcrack_" + Item.func_150891_b(par1ItemStack.getItem()), var4.xCoord, var4.yCoord, var4.zCoord, var3.xCoord, var3.yCoord + 0.05D, var3.zCoord);
        }
    }
    ...
    public boolean isOnLadder()
    {
        ...
        Block var4 = this.worldObj.func_147439_a(var1, var2, var3);
    ...
    protected void fall(float par1)
    {
        ...
        if (var4 > 0)
        {
            ...
            Block var8 = this.worldObj.func_147439_a(var5, var6, var7);
        ...
        for (int var10 = -var9; var10 <= var9; ++var10)
        {
            for (int var11 = -var9; var11 < var9; ++var11)
            {
                if (var10 != 0 || var11 != 0)
                {
                    ...
                    {
                        if (World.func_147466_a(this.worldObj, var12, (int)this.posY, var13))
                        {
                            this.setPositionAndUpdate(this.posX + (double)var10, this.posY + 1.0D, this.posZ + (double)var11);
                            return;
                        }

                        if (World.func_147466_a(this.worldObj, var12, (int)this.posY - 1, var13) || this.worldObj.func_147439_a(var12, (int)this.posY - 1, var13).func_149688_o() == Material.field_151586_h)
                        {
    ...
    public void moveEntityWithHeading(float par1, float par2)
    {
        ...
        else
        {
            ...
            if (this.onGround)
            {
                var3 = this.worldObj.func_147439_a(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.boundingBox.minY) - 1, MathHelper.floor_double(this.posZ)).field_149765_K * 0.91F;
            }
    ...
    public void onUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            for (int var2 = 0; var2 < 5; ++var2)
            {
                ...
                {
                    ((WorldServer)this.worldObj).getEntityTracker().func_151247_a(this, new S04PacketEntityEquipment(this.func_145782_y(), var2, var4));
    ...
    public void onItemPickup(Entity par1Entity, int par2)
    {
        if (!par1Entity.isDead && !this.worldObj.isRemote)
        {
            ...
            {
                var3.func_151247_a(par1Entity, new S0DPacketCollectItem(par1Entity.func_145782_y(), this.func_145782_y()));
            }
