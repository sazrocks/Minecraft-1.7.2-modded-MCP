...
public abstract class Entity
{
    ...
    public void onEntityUpdate()
    {
        ...
        if (this.isSprinting() && !this.isInWater())
        {
            ...
            Block var4 = this.worldObj.func_147439_a(var5, var2, var6);

            if (var4.func_149688_o() != Material.field_151579_a)
            {
                this.worldObj.spawnParticle("blockcrack_" + Block.func_149682_b(var4) + "_" + this.worldObj.getBlockMetadata(var5, var2, var6), this.posX + ((double)this.rand.nextFloat() - 0.5D) * (double)this.width, this.boundingBox.minY + 0.1D, this.posZ + ((double)this.rand.nextFloat() - 0.5D) * (double)this.width, -this.motionX * 4.0D, 1.5D, -this.motionZ * 4.0D);
            }
        }
    ...
    public void moveEntity(double par1, double par3, double par5)
    {
        ...
        else
        {
            ...
            if (this.canTriggerWalking() && !var20 && this.ridingEntity == null)
            {
                ...
                Block var32 = this.worldObj.func_147439_a(var39, var30, var31);
                int var33 = this.worldObj.func_147439_a(var39, var30 - 1, var31).func_149645_b();

                if (var33 == 11 || var33 == 32 || var33 == 21)
                {
                    var32 = this.worldObj.func_147439_a(var39, var30 - 1, var31);
                }
                ...
                if (this.distanceWalkedOnStepModified > (float)this.nextStepDistance && var32.func_149688_o() != Material.field_151579_a)
                {
                    ...
                    if (this.isInWater())
                    {
                        ...
                        this.playSound(this.func_145776_H(), var34, 1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.4F);
                    }

                    this.func_145780_a(var39, var30, var31, var32);
                    var32.func_149724_b(this.worldObj, var39, var30, var31, this);
                }
            }
            ...
            for (int var7 = var1; var7 <= var4; ++var7)
            {
                for (int var8 = var2; var8 <= var5; ++var8)
                {
                    for (int var9 = var3; var9 <= var6; ++var9)
                    {
                        ...
                        try
                        {
                            var10.func_149670_a(this.worldObj, var7, var8, var9, this);
                        }
    ...
    public boolean handleWaterMovement()
    {
        if (this.worldObj.handleMaterialAcceleration(this.boundingBox.expand(0.0D, -0.4000000059604645D, 0.0D).contract(0.001D, 0.001D, 0.001D), Material.field_151586_h, this))
        {
            if (!this.inWater && !this.firstUpdate)
            {
                ...
                this.playSound(this.func_145777_O(), var1, 1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.4F);
    ...
    public boolean isInsideOfMaterial(Material par1Material)
    {
        ...
        int var6 = MathHelper.floor_double(this.posZ);
        Block var7 = this.worldObj.func_147439_a(var4, var5, var6);

        if (var7.func_149688_o() == par1Material)
        {
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        try
        {
            NBTTagList var2 = par1NBTTagCompound.func_150295_c("Pos", 6);
            NBTTagList var6 = par1NBTTagCompound.func_150295_c("Motion", 6);
            NBTTagList var7 = par1NBTTagCompound.func_150295_c("Rotation", 5);
    ...
    public boolean isEntityInsideOpaqueBlock()
    {
        for (int var1 = 0; var1 < 8; ++var1)
        {
            ...
            if (this.worldObj.func_147439_a(var5, var6, var7).func_149721_r())
            {
                return true;
            }
        }
