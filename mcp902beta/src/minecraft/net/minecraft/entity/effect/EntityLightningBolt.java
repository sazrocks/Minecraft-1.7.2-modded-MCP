...
public class EntityLightningBolt extends EntityWeatherEffect
{
    ...
    public EntityLightningBolt(World par1World, double par2, double par4, double par6)
    {
        ...
        if (!par1World.isRemote && par1World.getGameRules().getGameRuleBooleanValue("doFireTick") && (par1World.difficultySetting == EnumDifficulty.NORMAL || par1World.difficultySetting == EnumDifficulty.HARD) && par1World.doChunksNearChunkExist(MathHelper.floor_double(par2), MathHelper.floor_double(par4), MathHelper.floor_double(par6), 10))
        {
            ...
            if (par1World.func_147439_a(var8, var9, var10).func_149688_o() == Material.field_151579_a && Blocks.field_150480_ab.func_149742_c(par1World, var8, var9, var10))
            {
                par1World.func_147449_b(var8, var9, var10, Blocks.field_150480_ab);
            }
            ...
            for (var8 = 0; var8 < 4; ++var8)
            {
                ...
                if (par1World.func_147439_a(var9, var10, var11).func_149688_o() == Material.field_151579_a && Blocks.field_150480_ab.func_149742_c(par1World, var9, var10, var11))
                {
                    par1World.func_147449_b(var9, var10, var11, Blocks.field_150480_ab);
                }
            }
        }
    }
        ...
        if (this.lightningState < 0)
        {
            ...
            else if (this.lightningState < -this.rand.nextInt(10))
            {
                ...
                if (!this.worldObj.isRemote && this.worldObj.getGameRules().getGameRuleBooleanValue("doFireTick") && this.worldObj.doChunksNearChunkExist(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ), 10))
                {
                    ...
                    if (this.worldObj.func_147439_a(var1, var2, var3).func_149688_o() == Material.field_151579_a && Blocks.field_150480_ab.func_149742_c(this.worldObj, var1, var2, var3))
                    {
                        this.worldObj.func_147449_b(var1, var2, var3, Blocks.field_150480_ab);
                    }
                }
            }
        }
