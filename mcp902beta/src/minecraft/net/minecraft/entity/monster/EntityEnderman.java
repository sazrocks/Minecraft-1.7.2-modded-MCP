...
public class EntityEnderman extends EntityMob
{
    ...
    private boolean shouldAttackPlayer(EntityPlayer par1EntityPlayer)
    {
        ...
        if (var2 != null && var2.getItem() == Item.func_150898_a(Blocks.field_150423_aK))
        {
            return false;
        }
        else
        ...
        if (!this.worldObj.isRemote && this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing"))
        {
            ...
            if (this.func_146080_bZ().func_149688_o() == Material.field_151579_a)
            {
                if (this.rand.nextInt(20) == 0)
                {
                    ...
                    var4 = this.worldObj.func_147439_a(var6, var2, var3);

                    if (carriableBlocks[Block.func_149682_b(var4)])
                    {
                        this.func_146081_a(var4);
                        this.setCarryingData(this.worldObj.getBlockMetadata(var6, var2, var3));
                        this.worldObj.func_147449_b(var6, var2, var3, Blocks.field_150350_a);
                    }
                }
            }
            else if (this.rand.nextInt(2000) == 0)
            {
                ...
                var4 = this.worldObj.func_147439_a(var6, var2, var3);
                Block var5 = this.worldObj.func_147439_a(var6, var2 - 1, var3);

                if (var4.func_149688_o() == Material.field_151579_a && var5.func_149688_o() != Material.field_151579_a && var5.func_149686_d())
                {
                    this.worldObj.func_147465_d(var6, var2, var3, this.func_146080_bZ(), this.getCarryingData(), 3);
    ...
    protected boolean teleportTo(double par1, double par3, double par5)
    {
        ...
        if (this.worldObj.blockExists(var14, var15, var16))
        {
            ...
            while (!var17 && var15 > 0)
            {
                Block var18 = this.worldObj.func_147439_a(var14, var15 - 1, var16);

                if (var18.func_149688_o().blocksMovement())
                {
                    var17 = true;
                }
                else
