...
public class EntitySnowman extends EntityGolem implements IRangedAttackMob
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.worldObj.getBiomeGenForCoords(var1, var3).func_150564_a(var1, var2, var3) > 1.0F)
        {
        ...
        for (int var4 = 0; var4 < 4; ++var4)
        {
            ...
            if (this.worldObj.func_147439_a(var1, var2, var3).func_149688_o() == Material.field_151579_a && this.worldObj.getBiomeGenForCoords(var1, var3).func_150564_a(var1, var2, var3) < 0.8F && Blocks.field_150431_aC.func_149742_c(this.worldObj, var1, var2, var3))
            {
                this.worldObj.func_147449_b(var1, var2, var3, Blocks.field_150431_aC);
            }
        }
    }
