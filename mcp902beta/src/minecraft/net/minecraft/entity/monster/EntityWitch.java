        ...
        if (!this.worldObj.isRemote)
        {
            if (this.getAggressive())
            {
                if (this.witchAttackTimer-- <= 0)
                {
                    ...
                    if (var1 != null && var1.getItem() == Items.field_151068_bn)
                    {
                        List var2 = Items.field_151068_bn.getEffects(var1);
            ...
            else
            {
                ...
                if (var5 > -1)
                {
                    this.setCurrentItemOrArmor(0, new ItemStack(Items.field_151068_bn, 1, var5));
