...
public class EntityZombie extends EntityMob
{
        ...
        else
        {
            ...
            if (var3 != null && this.worldObj.difficultySetting == EnumDifficulty.HARD && (double)this.rand.nextFloat() < this.getEntityAttribute(field_110186_bp).getAttributeValue())
            {
                ...
                for (int var8 = 0; var8 < 50; ++var8)
                {
                    ...
                    if (World.func_147466_a(this.worldObj, var9, var10 - 1, var11) && this.worldObj.getBlockLightValue(var9, var10, var11) < 10)
                    {
    ...
    public boolean attackEntityAsMob(Entity par1Entity)
    {
        ...
        if (var2)
        {
            int var3 = this.worldObj.difficultySetting.func_151525_a();
    ...
    protected void addRandomArmor()
    {
        ...
        if (this.rand.nextFloat() < (this.worldObj.difficultySetting == EnumDifficulty.HARD ? 0.05F : 0.01F))
        {
            ...
            if (var1 == 0)
            {
                this.setCurrentItemOrArmor(0, new ItemStack(Items.field_151040_l));
            }
            else
            {
                this.setCurrentItemOrArmor(0, new ItemStack(Items.field_151037_a));
            }
        }
    }
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData par1EntityLivingData)
    {
        ...
        if (this.getCurrentItemOrArmor(4) == null)
        {
            ...
            if (var6.get(2) + 1 == 10 && var6.get(5) == 31 && this.rand.nextFloat() < 0.25F)
            {
                this.setCurrentItemOrArmor(4, new ItemStack(this.rand.nextFloat() < 0.1F ? Blocks.field_150428_aP : Blocks.field_150423_aK));
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (var2 != null && var2.getItem() == Items.field_151153_ao && var2.getItemDamage() == 0 && this.isVillager() && this.isPotionActive(Potion.weakness))
        {
        ...
        if (this.rand.nextFloat() < 0.01F)
        {
            ...
            for (int var3 = (int)this.posX - 4; var3 < (int)this.posX + 4 && var2 < 14; ++var3)
            {
                for (int var4 = (int)this.posY - 4; var4 < (int)this.posY + 4 && var2 < 14; ++var4)
                {
                    ...
                    {
                        Block var6 = this.worldObj.func_147439_a(var3, var4, var5);
